        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Gallery Masonry Grid</h3>
            ...
            <div class="content-body"><!-- Description -->
                <section id="description" class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="card-text">
                                <p>Masonry is a JavaScript grid layout library. It works by placing elements in optimal position based on available vertical space, sort of like a
                                    mason fitting stones in a wall. You’ve probably seen it in use all over the Internet.</p>
                ...
                <section id="image-grid" class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="card-text">
                                <p>Masonry Image gallery grid with photo-swipe integration. Auto arrange images based on device screen size.</p>
                            </div>
                        </div>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-10.jpg')}}"
                                       itemprop="contentUrl" data-size="600x441">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-10.jpg')}}" 
                                             itemprop="thumbnail"
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-8.jpg')}}"
                                       itemprop="contentUrl" data-size="600x446">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-8.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-21.jpg')}}" 
                                       itemprop="contentUrl" data-size="600x798">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-21.jpg')}}" 
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-14.jpg')}}"
                                       itemprop="contentUrl" data-size="600x401">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-14.jpg')}}" 
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-1.jpg')}}"
                                       itemprop="contentUrl" data-size="600x404">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-1.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-2.jpg')}}"
                                       itemprop="contentUrl" data-size="600x400">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-2.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-3.jpg')}}" 
                                       itemprop="contentUrl" data-size="600x452">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-3.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-4.jpg')}}"
                                       itemprop="contentUrl" data-size="600x453">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-4.jpg')}}" 
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-5.jpg')}}"
                                       itemprop="contentUrl" data-size="600x450">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-5.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-6.jpg')}}"
                                       itemprop="contentUrl" data-size="600x447">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-6.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-22.jpg')}}" 
                                       itemprop="contentUrl" data-size="600x868">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-22.jpg')}}" 
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                            ...
                            <div class="grid-item">
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-7.jpg')}}"
                                       itemprop="contentUrl" data-size="600x453">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-7.jpg')}}" 
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                            ...
                            <div class="grid-item">
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-9.jpg')}}"
                                       itemprop="contentUrl" data-size="600x450">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-9.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                            ...
                            <div class="grid-item">
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-11.jpg')}}" 
                                       itemprop="contentUrl" data-size="600x446">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-11.jpg')}}"
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                                ...
                                <figure class="card" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{asset('admin-assets/images/portfolio/width-600/portfolio-26.jpg')}}"
                                       itemprop="contentUrl" data-size="600x856">
                                        <img class="img-thumbnail" src="{{asset('admin-assets/images/portfolio/width-600/portfolio-26.jpg')}}" 
                                             itemprop="thumbnail"
                                             alt="Image description"/>
                                    </a>
                                </figure>
                        ...
                        <div class="card-body">
                            <div class="masonry-grid">
                                ...
                                <div class="grid-item">
                                    <div class="card">
                                        <div class="card-img-top embed-responsive embed-responsive-item embed-responsive-16by9">
                                            <iframe class="img-thumbnail" src="https://player.vimeo.com/video/118589137?title=0&byline=0" width="640" height="360"></iframe>
                                        </div>
                                    </div>
                                </div>
                                <div class="grid-item">
                                    <div class="card">
                                        <div class="card-img-top embed-responsive embed-responsive-item embed-responsive-16by9">
                                            <iframe class="img-thumbnail" src="https://player.vimeo.com/video/173541384?color=ff9933&title=0&byline=0" width="640"
                                                    height="360"></iframe>
                                        </div>
                                    </div>
                                </div>
                                <div class="grid-item">
                                    <div class="card">
                                        <div class="card-img-top embed-responsive embed-responsive-item embed-responsive-16by9">
                                            <iframe class="img-thumbnail" src="https://player.vimeo.com/video/161753790?color=ff9933&title=0&byline=0" width="640"
                                                    height="360"></iframe>
                                        </div>
                                    </div>
                                </div>

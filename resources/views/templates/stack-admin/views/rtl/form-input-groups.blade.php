...
@section('header')
    @if(in_array(App::getLocale(),config('base.rtl_locales')))
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css-rtl/plugins/forms/form-inputs-groups.min.css')}}">
        <!-- END: Page CSS-->
    ...
    @else
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css/plugins/forms/form-inputs-groups.min.css')}}">
        <!-- END: Page CSS-->
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Input Groups</h3>
            ...
            <div class="content-body"><!-- input groups start -->
                ...
                <section class="sizing-input-group" id="input-group-sizing">
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Extra Small Input group</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>Add <code>.input-group-xs</code> class to <code>.input-group</code> for Xsmall addon.</p>
                                        <fieldset>
                                            <div class="input-group input-group-xs">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">$</span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="Extra Small Addon" aria-label="Amount">
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                                        ...
                                        <fieldset>
                                            <div class="input-group">
                                                <div class="input-group-prepend" id="button-addon3">
                                                    <button class="btn btn-primary" type="button"><i class="ft-mic"></i></button>
                                                </div>
                                        ...
                                        <fieldset>
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append" id="button-addon4">
                                                    <button class="btn btn-primary" type="button"><i class="fa fa-skyatlas"></i></button>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                ...
                <section class="bootstrap-touchspin-spinners" id="touchspin">
                    ...
                    <div class="row match-height touchspin-spinners-wrapper">
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-header">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <fieldset>
                                            <div class="input-group touchspin-with-icon">
                                                <input type="text" class="touchspin-stop-mousewheel" data-bts-postfix="<i class='ft-phone-call'></i>" value="50"/>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <fieldset>
                                            <div class="input-group">
                                                <input type="text" class="touchspin" value="50.00" data-bts-button-down-txt="<i class='fa fa-angle-down'></i>"
                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Touchspin With Dropdown</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>Use <code>data-bts-prefix &amp; data-bts-postfix</code> attribute to set Prefix and Postfix to touchspin input with button.</p>
                                        <fieldset>
                                            <div class="input-group">
                                                <input type="text" class="touchspin" value="50.00" data-bts-prefix="Pre" data-bts-postfix="Post"/>
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-primary border-left-primary border-left-darken-3 dropdown-toggle" data-toggle="dropdown"
                    ...
                    <div class="row match-height">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <fieldset>
                                            <div class="input-group">
                                                <input type="text" class="touchspin" value="55" data-bts-postfix="<i class='ft-settings'></i>"/>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>Add <code>.input-group-sm</code> class to input-group.</p>
                                        <fieldset>
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="touchspin" value="60"/>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
...
@section('footer')
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/js/scripts/forms/input-groups.min.js')}}"></script>
    <!-- END: Page JS-->

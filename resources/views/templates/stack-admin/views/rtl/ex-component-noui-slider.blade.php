...
@section('vendor-css')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/vendors/css/extensions/nouislider.min.css')}}">
    <!-- END: Vendor CSS-->
...
@section('header')
    @if(in_array(App::getLocale(),config('base.rtl_locales')))
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css-rtl/plugins/extensions/noui-slider.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css-rtl/core/colors/palette-noui.css')}}">
        <!-- END: Page CSS-->
    ...
    @else
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css/plugins/extensions/noui-slider.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css/core/colors/palette-noui.css')}}">
        <!-- END: Page CSS-->
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">noUiSlider</h3>
            ...
            <div class="content-body"><!-- Horizontal Sliders -->
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p>When a non-linear slider has been configured, the <code>snap</code> option can be set to <code>true</code> to force the slider to
                                                jump between the specified values.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="slider-behavior">
                    <div class="row">
                        <div class="col-12 mt-3 mb-1">
                            ...
                            <p>noUiSlider offers several ways to handle user interaction. The range can be set to drag, and handles can move to taps. All these effects are
                                optional, and can be enable by adding their keyword to the behavior option. This option accepts a <code>"-"</code> separated list of
                ...
                <section id="slider-scales-pips">
                    <div class="row">
                        <div class="col-12 mt-3 mb-1">
                            ...
                            <p>This feature allows you to generate points along the slider. Five options can be set: <code>mode</code> to determine where to place pips, <code>values</code>
                                as additional options for <code>mode</code>, <code>stepped</code> to round pip values to the slider stepping, <code>density</code> to pre-scale the
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <p>The <code>range</code> mode uses the slider range to determine where the pips should be. A pip is generated for every percentage
                                            specified.</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <p>In <code>positions</code> mode, pips are generated at percentage-based positions on the slider. Optionally, the <code>stepped</code>
                                            option can be set to <code>true</code> to match the pips to the slider steps.</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <p>Like <code>range</code>, the <code>steps</code> mode uses the slider range. In <code>steps</code> mode, a pip is generated for every
                                            step. The <code>filter</code> option can be used to filter the generated pips. The <code>filter</code> function must return
                                            <code>0</code> (no value), <code>1</code> (large value) or <code>2</code> (small value).</p>
                ...
                <section id="vsliders">
                    <div class="row">
                        <div class="col-12 mt-3 mb-1">
                            ...
                            <p><strong>Set dimensions!</strong> Vertical sliders don't assume a default <code>height</code>, so you'll need to set one. You can use any unit you
                                want, including <code>%</code> or <code>px</code>.</p>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <fieldset>
                                            <div class="form-group text-center">
                                                <div id="slider-direction-bottom-top-1" class="mr-2"></div>
                                                <div id="slider-direction-bottom-top-2" class="ml-3 mr-2 slider-info"></div>
                                                <div id="slider-direction-bottom-top-3" class="ml-3 slider-success"></div>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
...
@section('vendor-js')
    ...
    <script src="{{asset('admin-assets/vendors/js/extensions/wNumb.js')}}"></script>
    <script src="{{asset('admin-assets/vendors/js/extensions/nouislider.min.js')}}"></script>
    <!-- END: Page Vendor JS-->

@endsection
@section('footer')
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/js/scripts/extensions/noui-slider.min.js')}}"></script>
    <!-- END: Page JS-->

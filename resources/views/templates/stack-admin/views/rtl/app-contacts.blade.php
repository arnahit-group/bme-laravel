                    ...
                    <section class="row all-contacts">
                        <div class="col-12">
                                ...
                                <div class="card-head">
                                    <div class="card-header">
                                        ...
                                        <div class="heading-elements mt-0">
                                            <button class="btn btn-primary btn-sm " data-toggle="modal" data-target="#AddContactModal"><i
							...
							<span aria-labelledby="btnSearchDrop1" class="dropdown-menu mt-1 dropdown-menu-right">
								<a href="app-contacts.html#" class="dropdown-item"><i class="ft-upload"></i> Import</a>
								<a href="app-contacts.html#" class="dropdown-item"><i class="ft-download"></i> Export</a>
								<a href="app-contacts.html#" class="dropdown-item"><i class="ft-shuffle"></i> Find Duplicate</a>
							</span>
						</span>
                                        ...
                                        <div class="table-responsive">
											...
											<span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
												<a data-toggle="modal" data-target="#EditContactModal" class="dropdown-item edit"><i class="ft-edit-2"></i>
													Edit</a>
												<a href="app-contacts.html#" class="dropdown-item delete"><i class="ft-trash-2"></i> Delete</a>
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle primary"></i> Projects</a>
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle info"></i> Team</a>
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle warning"></i> Clients</a>
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
											</span>
										</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="danger delete mr-1"><i class="fa fa-trash-o"></i></a>
                                                            <span class="dropdown">
											<a id="btnSearchDrop3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"
                                               class="dropdown-toggle dropdown-menu-right secondary"><i
                                                        class="fa fa-ellipsis-v"></i></a>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-away rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-8.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
											...
											<span aria-labelledby="btnSearchDrop8" class="dropdown-menu mt-1 dropdown-menu-right">
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-off rounded-circle"><img
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-9.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-away rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-18.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-off rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-17.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-4.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-13.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-16.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
												...
												<a href="app-contacts.html#" class="dropdown-item"><i class="ft-plus-circle success"></i> Friends</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                <div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img
                                                                                src="{{asset('admin-assets/images/portrait/small/avatar-s-22.png')}}"
                                                                                alt="avatar"><i></i></span></div>
                                                                <div class="media-body media-middle">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body border-top-blue-grey border-top-lighten-5">
                                <div class="list-group">
                                    <a href="app-contacts.html#" class="list-group-item active">All Contacts</a>
                                    <a href="app-contacts.html#" class="list-group-item list-group-item-action">Recently contacted</a>
                                    <a href="app-contacts.html#" class="list-group-item list-group-item-action">Favorite contacts</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span class="badge badge-primary badge-pill float-right">14</span> <a href="app-contacts.html#"> Project</a>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="badge badge-info badge-pill float-right">22</span> <a href="app-contacts.html#"> Team</a>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="badge badge-warning badge-pill float-right">10</span> <a href="app-contacts.html#"> Clients</a>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="badge badge-success badge-pill float-right">5</span> <a href="app-contacts.html#"> Friends</a>
                                    </li>
                                </ul>
                            </div>
                            <!--/ Groups-->

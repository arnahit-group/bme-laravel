                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card profile-with-cover">
                                <div class="card-img-top img-fluid bg-cover height-300" style="background: url('{{asset('admin-assets/images/carousel/22.jpg')}}') 50%;"></div>
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <ul class="navbar-nav mr-auto">
                                                <li class="nav-item active">
                                                    <a class="nav-link" href="user-profile.html#"><i class="fa fa-line-chart"></i> Timeline <span
                                                                class="sr-only">(current)</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="user-profile.html#"><i class="ft-user"></i> Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="user-profile.html#"><i class="fa fa-briefcase"></i> Projects</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="user-profile.html#"><i class="fa fa-heart-o"></i> Favourites</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="user-profile.html#"><i class="fa fa-bell-o"></i> Notifications</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </nav>
                    ...
                    <section id="timeline" class="timeline-center timeline-wrapper">
                        ...
                        <ul class="timeline">
                            ...
                            <li class="timeline-group">
                                <a href="user-profile.html#" class="btn btn-primary"><i class="fa fa-calendar-o"></i> Today</a>
                            </li>
                        </ul>
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                            <li class="timeline-item">
                                ...
                                <div class="timeline-card card border-grey border-lighten-2">
                                    <div class="card-header">
                                        <h4 class="card-title"><a href="user-profile.html#">Portfolio project work</a></h4>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <ul class="list-inline">
                                                    <li class="pr-1"><a href="user-profile.html#" class=""><span class="fa fa-thumbs-o-up"></span> Like</a></li>
                                                    <li class="pr-1"><a href="user-profile.html#" class=""><span class="fa fa-commenting-o"></span> Comment</a></li>
                                                    <li><a href="user-profile.html#" class=""><span class="fa fa-share-alt"></span> Share</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="text-bold-600 mb-0"><a href="user-profile.html#">Jason Ansley</a></p>
                                                        <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo.</p>
                                                        <ul class="list-inline">
                                                            <li class="pr-1"><a href="user-profile.html#" class=""><span class="fa fa-thumbs-o-up"></span> Like</a></li>
                                                            <li class="pr-1"><a href="user-profile.html#" class=""><span class="fa fa-commenting-o"></span> Reply</a></li>
                                                        </ul>
                                                        <div class="media">
                                                            <div class="media-left mr-1">
                                                                <a href="user-profile.html#">
                                                            ...
                                                            <div class="media-body">
                                                                <p class="text-bold-600 mb-0"><a href="user-profile.html#">Janice Johnston</a></p>
                            ...
                            <li class="timeline-item mt-3">
                                ...
                                <div class="timeline-card card border-grey border-lighten-2">
                                    <div class="card-header">
                                        <h4 class="card-title"><a href="user-profile.html#">Sofia Orav</a></h4>
                                        <p class="card-subtitle text-muted mb-0 pt-1">
                            ...
                            <li class="timeline-item block">
                                <div class="timeline-badge">
                                    <a title="" data-context="inverse" data-container="body" class="border-silc" href="user-profile.html#"
                        ...
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                            <li class="timeline-group">
                                <a href="user-profile.html#" class="btn btn-primary"><i class="fa fa-calendar-o"></i> 2016</a>
                            </li>
                        </ul>
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                                ...
                                <div class="timeline-card card text-white">
                                    ...
                                    <div class="card-img-overlay bg-overlay">
                                        ...
                                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little
                                            bit longer.</p>
                                        <p class="card-text">Eu pid nunc urna integer, sed, cras tortor scelerisque penatibus facilisis a pulvinar, rhoncus sagittis ut nunc elit!
                                            Sociis in et? Rhoncus, vel dignissim in scelerisque. Dolor lacus pulvinar adipiscing adipiscing montes!</p>
                                    </div>
                                </div>
                            </li>
                            <li class="timeline-item mt-3">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group icheck-task">
                                                    ...
                                                    <li class="list-group-item">
                                                        <input type="checkbox" id="input-4" disabled checked> Porta ac consectetur ac
                                                    </li>
                                                    <li class="list-group-item">
                            ...
                            <li class="timeline-item">
                                ...
                                <div class="timeline-card card border-grey border-lighten-2">
                                    <div class="card-header">
                                        <h4 class="card-title"><a href="user-profile.html#">Non-ribbon Chord Chart</a></h4>
                                        <p class="card-subtitle text-muted mb-0 pt-1">
                        ...
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                            <li class="timeline-group">
                                <a href="user-profile.html#" class="btn btn-primary"><i class="fa fa-calendar-o"></i> 2015</a>
                            </li>
                        </ul>
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                                ...
                                <div class="timeline-card card border-grey border-lighten-2">
                                    <div class="card-header">
                                        <div class="text-center">
                                            ...
                                            <p>Eu pid nunc urna integer, sed, cras tortor scelerisque penatibus facilisis a pulvinar, rhoncus sagittis ut nunc elit! Sociis in
                                                et?</p>
                                        </div>
                                    </div>
                                    <!-- Image grid -->
                                ...
                                <div class="timeline-card card border-grey border-lighten-2">
                                    <div class="card-header">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="card-title"><a href="user-profile.html#">Application API Support</a></h4>
                                                <p class="card-subtitle text-muted mb-0 pt-1">
                                        ...
                                        <div class="card-footer px-0 py-0">
                                            <div class="card-body">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="text-bold-600 mb-0"><a href="user-profile.html#">Crystal Lawson</a></p>
                                                        <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo.</p>
                                                        <div class="media">
                                                            <div class="media-left mr-1">
                                                                <a href="user-profile.html#">
                                                            ...
                                                            <div class="media-body">
                                                                <p class="text-bold-600 mb-0"><a href="user-profile.html#">Rafila Găitan</a></p>
                                                                <p>Gravida nulla. Nulla vel metus scelerisque ante sollicitudin.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <li class="timeline-item mt-3">
                                ...
                                <div class="timeline-card card border-grey border-lighten-2">
                                    <div class="card-header">
                                        <h4 class="card-title"><a href="user-profile.html#">Quote of the day</a></h4>
                                        <p class="card-subtitle text-muted mb-0 pt-1">
                        ...
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                            <li class="timeline-group">
                                <a href="user-profile.html#" class="btn btn-primary"><i class="fa fa-calendar-o"></i> 2014</a>
                            </li>
                        </ul>
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                        ...
                        <ul class="timeline">
                            <li class="timeline-line"></li>
                            <li class="timeline-group">
                                <a href="user-profile.html#" class="btn btn-primary"><i class="fa fa-calendar-o"></i> Founded in 2012</a>
                            </li>
                        </ul>
                    </section>
                </div>

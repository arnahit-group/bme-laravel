        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Blue Grey Color Page</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="color-palette-blue-grey.html#">Color System</a>
                                </li>
                                <li class="breadcrumb-item active">Blue Grey Palette
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right">
                                            <p class="card-title">
                                                <small class="float-right">#607D8B</small>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Lighten 1</strong>
                                            <small class="text-muted float-right">#78909C</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Lighten 2</strong>
                                            <small class="text-muted float-right">#90A4AE</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Lighten 3</strong>
                                            <small class="text-muted float-right">#B0BEC5</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Lighten 4</strong>
                                            <small class="text-muted float-right">#CFD8DC</small>
                                        </p>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Darken 1</strong>
                                            <small class="text-muted float-right">#546E7A</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Darken 2</strong>
                                            <small class="text-muted float-right">#455A64</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Darken 3</strong>
                                            <small class="text-muted float-right">#37474F</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Darken 4</strong>
                                            <small class="text-muted float-right">#263238</small>
                                        </p>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <p>Blue Grey color palette contains 13 colors: 1 main blue-grey color and 4 lighten colors, 4 darken colors and 4 Accent colors. All colors
                                            ...
                                            configurable.</p>
                                        <p class="mt-1"><strong>Please note:</strong> You can use .bg-blue-grey and .btn-blue-grey as main colors, but if you want to use lighten,
                                            darken or accent colors, use bg-* bg-lighten-NUMBER for lighten color, bg-* bg-darken-NUMBER for darken color and bg-* bg-accent-NUMBER
                                            for accent colors.</p>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <table class="table table-bordeblue-grey">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>For <code>lighten</code> blue-grey background color, this two classes needed. Here *: 1,2,3,4 lighten blue-grey
                                                                color options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.bg-blue-grey</code><br><code>.bg-darken-*</code></td>
                                                            <td>For <code>darken</code> blue-grey background color, this two classes needed. Here *: 1,2,3,4 darken blue-grey color
                                                                options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.bg-blue-grey</code><br><code>.bg-accent-*</code></td>
                                                            <td>For <code>accent</code> blue-grey background color, this two classes needed. Here *: 1,2,3,4 accent blue-grey color
                                                                options.
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    ...
                                                    <table class="table table-bordeblue-grey">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>For lighten blue-grey background color, this two classes needed. Here *: 1,2,3,4 lighten blue-grey color
                                                                    options.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>For lighten blue-grey <code>bottom</code> border. Use this classes if you need to highlight only bottom border.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td><code>.border-right-blue-grey</code><br><code>.border-right-lighten-*</code></td>
                                                                <td>For lighten blue-grey <code>right</code> border. Use this classes if you need to highlight only right border.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>For darken blue-grey background color, this two classes needed. Here *: 1,2,3,4 darken blue-grey color
                                                                    options.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>For darken blue-grey <code>bottom</code> border. Use this classes if you need to highlight only bottom border.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td><code>.border-right-blue-grey</code><br><code>.border-right-darken-*</code></td>
                                                                <td>For darken blue-grey <code>right</code> border. Use this classes if you need to highlight only right border.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>For accent blue-grey background color, this two classes needed. Here *: 1,2,3,4 accent blue-grey color
                                                                    options.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>For accent blue-grey <code>bottom</code> border. Use this classes if you need to highlight only bottom border.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td><code>.border-right-blue-grey</code><br><code>.border-right-accent-*</code></td>
                                                                <td>For Accent blue-grey <code>right</code> border. Use this classes if you need to highlight only right border.
                                                                </td>
                                                            </tr>
                                                            <tr>
                            ...
                            <div class="card p-1">
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right">
                                            <p class="card-title mb-0 blue-grey">
                                                <small class="float-right">#607D8B</small>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Lighten 2</strong>
                                            <small class="text-muted float-right blue-grey lighten-2">#90A4AE</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Lighten 3</strong>
                                            <small class="text-muted float-right blue-grey lighten-3">#B0BEC5</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Lighten 4</strong>
                                            <small class="text-muted float-right blue-grey lighten-4">#CFD8DC</small>
                                        </p>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Darken 2</strong>
                                            <small class="text-muted float-right blue-grey darken-2">#455A64</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Darken 3</strong>
                                            <small class="text-muted float-right blue-grey darken-3">#37474F</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Blue Grey Darken 4</strong>
                                            <small class="text-muted float-right blue-grey darken-4">#263238</small>
                                        </p>
                                                ...
                                                <table class="table table-bordeblue-grey">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>For <code>lighten</code> blue-grey text color, this two classes needed. Here *: 1,2,3,4 for lighten blue-grey color
                                                                options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.blue-grey</code><br><code>.darken-*</code></td>
                                                            <td>For <code>darken</code> blue-grey text color, this two classes needed. Here *: 1,2,3,4 for darken blue-grey color
                                                                options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.blue-grey</code><br><code>.accent-*</code></td>
                                                            <td>For <code>accent</code> blue-grey text color, this two classes needed. Here *: 1,2,3,4 for accent blue-grey color
                                                                options.
                                                            </td>
                                                        </tr>
                                                    </tbody>

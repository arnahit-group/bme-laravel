        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">gmaps - Services</h3>
            ...
            <div class="content-body"><!-- gmaps services section start -->
...
@section('footer')
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/js/scripts/charts/gmaps/services.min.js')}}"></script>
    <!-- END: Page JS-->

        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Advance Weather Cards</h3>
            ...
            <div class="content-body"><!-- Weather cards section start -->
                <section id="weather-cards">
                        ...
                        <div class="col-xl-4 col-md-12 col-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    ...
                                    <div class="card-body bg-blue-grey bg-lighten-2">
                                        <ul class="list-inline text-right">
                                            <li><a data-action="reload"><i class="ft-rotate-cw font-medium-4 grey"></i></a></li>
                                        </ul>
                                        <div class="animated-weather-icons text-center">
                                            <svg version="1.1" id="cloudHailAlt1" class="climacon climacon_cloudHailAlt climacon-blue-grey climacon-darken-2 height-200"
                                                 viewBox="15 15 70 70">
                            ...
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    ...
                                    <div class="card-body bg-amber bg-lighten-4">
                                        ...
                                        <div class="animated-weather-icons text-center">
                                            <svg version="1.1" id="wind1" class="climacon climacon_wind climacon-amber climacon-darken-2 height-200" viewBox="15 15 70 70">
                        ...
                        <div class="col-xl-4 col-md-12 col-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    ...
                                    <div class="card-body bg-blue bg-lighten-4">
                                        <ul class="list-inline text-right">
                                            <li><a data-action="reload"><i class="ft-rotate-cw font-medium-4 blue"></i></a></li>
                                        </ul>
                                        <div class="animated-weather-icons text-center">
                                            <svg version="1.1" id="cloudDrizzleAlt1" class="climacon climacon_cloudDrizzleAlt climacon-blue climacon-darken-2 height-200"
                                                 viewBox="15 15 70 70">
                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="weather-img position-relative">
                                        ...
                                        <img class="card-img-top img-fluid height-300" src="{{asset('admin-assets/images/backgrounds/mountain.png" alt="Card image cap')}}">
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="weather-img position-relative">
                                        ...
                                        <img class="card-img-top img-fluid height-300" src="{{asset('admin-assets/images/backgrounds/ice.png" alt="Card image cap')}}">
                                    </div>
                                    <div class="card-body text-center">
                                        <div class="row">
                                            <div class="col-2">
                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="card-body bg-blue-grey bg-lighten-2">
                                        ...
                                        <div class="weather-details text-center">
                                            ...
                                            <span class="font-large-1 block blue-grey darken-4">-5&deg;</span>
                                            <span class="font-medium-4 text-bold-500 blue-grey darken-4">London, UK</span>
                                        </div>
                                    </div>
                                    <div class="card-footer py-2 border-0">
                                        <div class="row">
                                            <div class="col-4 text-center display-table-cell">
                                                <i class="me-wind font-large-1 lighten-3 align-middle"></i> <span class="align-middle">12MPH</span>
                                            </div>
                                            <div class="col-4 text-center display-table-cell">
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    <div class="card-body bg-amber bg-lighten-4">
                                        <div class="animated-weather-icons text-center float-left">
                                            <svg version="1.1" id="wind2" class="climacon climacon_wind climacon-amber climacon-darken-2 height-100" viewBox="15 15 70 70">
                                                <g class="climacon_iconWrap climacon_iconWrap-wind">
                                                    <g class="climacon_wrapperComponent climacon_componentWrap-wind">
                                                        <path
                                                                class="climacon_component climacon_component-stroke climacon_component-wind climacon_component-wind_curl"
                                        ...
                                        <div class="weather-details text-center">
                                            ...
                                            <span class="font-large-1 block amber darken-4">32&deg;</span>
                                            <span class="font-medium-4 text-bold-500 amber darken-4">Beijing, China</span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    <div class="card-body bg-blue-grey bg-lighten-4">
                                        <div class="animated-weather-icons text-center float-left">
                                            <svg version="1.1" id="cloudSunFill" class="climacon climacon_cloudSunFill climacon-blue-grey climacon-darken-2 height-100"
                                                 viewBox="15 15 70 70">
                                                <g class="climacon_iconWrap climacon_cloudSunFill-iconWrap">
                                                    <g class="climacon_componentWrap climacon_componentWrap-sun climacon_componentWrap-sun_cloud">
                                                        ...
                                                        <g class="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
                                                            <circle class="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" cx="58.033" cy="41.612"
                                                                    r="11.999"></circle>
                                                            <circle class="climacon_component climacon_component-fill climacon_component-fill_sunBody" fill="#FFFFFF" cx="58.033"
                                                                    cy="41.612" r="7.999"></circle>
                                                        </g>
                                                    </g>
                                                    <g class="climacon_wrapperComponent climacon_wrapperComponent-cloud">
                                                        <path class="climacon_component climacon_component-stroke climacon_component-stroke_cloud"
                                                              d="M44.033,65.641c-8.836,0-15.999-7.162-15.999-15.998c0-8.835,7.163-15.998,15.999-15.998c6.006,0,11.233,3.312,13.969,8.203c0.664-0.113,1.338-0.205,2.033-0.205c6.627,0,11.998,5.373,11.998,12c0,6.625-5.371,11.998-11.998,11.998C57.26,65.641,47.23,65.641,44.033,65.641z"></path>
                                                        <path class="climacon_component climacon_component-fill climacon_component-fill_cloud" fill="#FFFFFF"
                                                              d="M60.035,61.641c4.418,0,8-3.582,8-7.998c0-4.418-3.582-8-8-8c-1.6,0-3.082,0.481-4.334,1.291c-1.23-5.316-5.976-9.29-11.668-9.29c-6.627,0-11.999,5.372-11.999,11.999c0,6.627,5.372,11.998,11.999,11.998C47.65,61.641,57.016,61.641,60.035,61.641z"></path>
                                                    </g>
                                                </g>
                                            </svg>
                                        </div>
                                        <div class="weather-details text-center">
                                            ...
                                            <span class="font-large-1 block blue-grey darken-4">13&deg;</span>
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    <div class="card-body bg-blue bg-lighten-4">
                                        <div class="animated-weather-icons text-center float-left">
                                            <svg version="1.1" id="cloudDrizzleAlt2" class="climacon climacon_cloudDrizzleAlt climacon-blue climacon-darken-2 height-100"
                                                 viewBox="15 15 70 70">
                                                <g class="climacon_iconWrap climacon_iconWrap-cloudDrizzleAlt">
                                                    <g class="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
                                                        <path class="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left"
                                        ...
                                        <div class="weather-details text-center">
                                            ...
                                            <span class="font-large-1 block blue darken-4">8&deg;</span>
                        ...
                        <div class="col-xl-4 col-md-12 col-sm-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    <div class="card-body bg-blue-grey bg-lighten-2">
                                        <div class="animated-weather-icons text-center float-left">
                                            <svg version="1.1" id="cloudHailAlt3" class="climacon climacon_cloudHailAlt climacon-blue-grey climacon-darken-2 height-150"
                                                 viewBox="15 15 70 70">
                                                <g class="climacon_iconWrap climacon_iconWrap-cloudHailAlt">
                                                    <g class="climacon_wrapperComponent climacon_wrapperComponent-hailAlt">
                                                        <g class="climacon_component climacon_component-stroke climacon_component-stroke_hailAlt climacon_component-stroke_hailAlt-left">
                                        ...
                                        <div class="weather-details text-center">
                                            <span class="block blue-grey darken-3">Snow</span>
                                            <span class="font-large-3 block blue-grey darken-4">-5&deg;</span>
                                            <span class="font-medium-4 text-bold-500 blue-grey darken-4">London, UK</span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-4 col-md-12 col-sm-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    <div class="card-body bg-amber bg-lighten-4">
                                        <div class="animated-weather-icons text-center float-left">
                                            <svg version="1.1" id="wind3" class="climacon climacon_wind climacon-amber climacon-darken-2 height-150" viewBox="15 15 70 70">
                                                <g class="climacon_iconWrap climacon_iconWrap-wind">
                                                    <g class="climacon_wrapperComponent climacon_componentWrap-wind">
                                                        <path
                                                                class="climacon_component climacon_component-stroke climacon_component-wind climacon_component-wind_curl"
                        ...
                        <div class="col-xl-4 col-md-12 col-sm-12">
                            <div class="card border-0 box-shadow-0">
                                <div class="card-content">
                                    <div class="card-body bg-blue bg-lighten-4">
                                        <div class="animated-weather-icons text-center float-left">
                                            <svg version="1.1" id="cloudDrizzleAlt3" class="climacon climacon_cloudDrizzleAlt climacon-blue climacon-darken-2 height-150"
                                                 viewBox="15 15 70 70">
                                                <g class="climacon_iconWrap climacon_iconWrap-cloudDrizzleAlt">
                                                    <g class="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
                                                        <path class="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left"
                                        ...
                                        <div class="weather-details text-center">
                                            <span class="block blue darken-2">Rain</span>
                                            <span class="font-large-3 block blue darken-4">8&deg;</span>
                                            <span class="font-medium-4 text-bold-500 blue darken-4">Berlin, Germany</span>
                                        </div>
                                    </div>
                                    <div class="card-footer p-0 border-0">

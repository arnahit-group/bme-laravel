                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="chart-stats text-center">
                                    <a href="index.html#" class="btn btn-sm btn-primary mr-1">Statistics <i class="ft-bar-chart"></i></a> <span class="text-muted">for the last year.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row match-height">
                                        ...
                                        <section class="cd-horizontal-timeline">
                                            <div class="timeline">
                                                <div class="events-wrapper">
                                                    <div class="events">
                                                        <ol>
                                                            <li><a href="index.html#0" data-date="16/01/2015" class="selected">16 Jan</a></li>
                                                            <li><a href="index.html#0" data-date="28/02/2015">28 Feb</a></li>
                                                            <li><a href="index.html#0" data-date="20/04/2015">20 Mar</a></li>
                                                            <li><a href="index.html#0" data-date="20/05/2015">20 May</a></li>
                                                            <li><a href="index.html#0" data-date="09/07/2015">09 Jul</a></li>
                                                            <li><a href="index.html#0" data-date="30/08/2015">30 Aug</a></li>
                                                            <li><a href="index.html#0" data-date="15/09/2015">15 Sep</a></li>
                                                        </ol>
                                            ...
                                            <div class="events-content">
                                                <ol>
                                                    <li class="selected" data-date="16/01/2015">
                                                        ...
                                                        <p class="lead mt-2">
                                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum praesentium officia, fugit recusandae ipsa, quia
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <img class="img-fluid" src="{{asset('admin-assets/images/carousel/06.jpg')}}" alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <a href="index.html#" class="card-link">Card link</a>
                                    <a href="index.html#" class="card-link">Another link</a>
                                </div>
                            </div>
                            <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                                <span class="float-left">3 hours ago</span>
                                <span class="float-right">
                    <a href="index.html#" class="card-link">Read More <i class="fa fa-angle-right"></i></a>
                  </span>
                            </div>
                        </div>
                    </div>

        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Success Color Page</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="color-palette-success.html#">Color System</a>
                                </li>
                                <li class="breadcrumb-item active">Success Palette
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right">
                                            <p class="card-title">
                                                <small class="float-right">#16D39A</small>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 1</strong>
                                            <small class="text-muted float-right">#39DAA9</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 2</strong>
                                            <small class="text-muted float-right">#5CE0B8</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 3</strong>
                                            <small class="text-muted float-right">#8BE9CD</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 4</strong>
                                            <small class="text-muted float-right">#B9F2E1</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 1</strong>
                                            <small class="text-muted float-right">#13CE92</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 2</strong>
                                            <small class="text-muted float-right">#10C888</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 3</strong>
                                            <small class="text-muted float-right">#0CC27E</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 4</strong>
                                            <small class="text-muted float-right">#06B76C</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 1</strong>
                                            <small class="text-muted float-right">#E1FFF1</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 2</strong>
                                            <small class="text-muted float-right">#AEFFD9</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 3</strong>
                                            <small class="text-muted float-right">#7BFFC1</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 4</strong>
                                            <small class="text-muted float-right">#62FFB5</small>
                                        </p>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <p>Success color palette contains 13 colors: 1 main success color and 4 lighten colors, 4 darken colors and 4 Accent colors. All colors
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>For <code>lighten</code> success background color, this two classes needed. Here *: 1,2,3,4 lighten success color
                                                                options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.bg-success</code><br><code>.bg-darken-*</code></td>
                                                            <td>For <code>darken</code> success background color, this two classes needed. Here *: 1,2,3,4 darken success color
                                                                options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.bg-success</code><br><code>.bg-accent-*</code></td>
                                                            <td>For <code>accent</code> success background color, this two classes needed. Here *: 1,2,3,4 accent success color
                                                                options.
                                                            </td>
                                                        </tr>
                                                    </tbody>
                            ...
                            <div class="card p-1">
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right">
                                            <p class="card-title mb-0 success">
                                                <small class="float-right">#16D39A</small>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 1</strong>
                                            <small class="text-muted float-right success">#39DAA9</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 2</strong>
                                            <small class="text-muted float-right success lighten-2">#5CE0B8</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 3</strong>
                                            <small class="text-muted float-right success lighten-3">#8BE9CD</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Lighten 4</strong>
                                            <small class="text-muted float-right success lighten-4">#B9F2E1</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 1</strong>
                                            <small class="text-muted float-right success darken-1">#13CE92</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 2</strong>
                                            <small class="text-muted float-right success darken-2">#10C888</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 3</strong>
                                            <small class="text-muted float-right success darken-3">#0CC27E</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Darken 4</strong>
                                            <small class="text-muted float-right success darken-4">#06B76C</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 1</strong>
                                            <small class="text-muted float-right success accent-1">#E1FFF1</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 2</strong>
                                            <small class="text-muted float-right success accent-2">#AEFFD9</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 3</strong>
                                            <small class="text-muted float-right success accent-3">#7BFFC1</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Success Accent 4</strong>
                                            <small class="text-muted float-right success accent-4">#62FFB5</small>
                                        </p>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>For <code>lighten</code> success text color, this two classes needed. Here *: 1,2,3,4 for lighten success color
                                                                options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.success</code><br><code>.darken-*</code></td>
                                                            <td>For <code>darken</code> success text color, this two classes needed. Here *: 1,2,3,4 for darken success color
                                                                options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.success</code><br><code>.accent-*</code></td>
                                                            <td>For <code>accent</code> success text color, this two classes needed. Here *: 1,2,3,4 for accent success color
                                                                options.
                                                            </td>
                                                        </tr>
                                                    </tbody>

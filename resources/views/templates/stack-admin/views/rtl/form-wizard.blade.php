...
@section('header')
    @if(in_array(App::getLocale(),config('base.rtl_locales')))
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css-rtl/plugins/forms/wizard.min.css')}}">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="form-wizard.html#">Page</a>
                                </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="form-wizard.html#" class="number-tab-steps wizard-circle">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="form-wizard.html#" class="icons-tab-steps wizard-circle">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="form-wizard.html#" class="steps-validation wizard-circle">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="form-wizard.html#" class="vertical-tab-steps wizard-circle">
...
@section('vendor-js')
    ...
    <script src="{{asset('admin-assets/vendors/js/extensions/jquery.steps.min.js')}}"></script>

        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Echarts - Bar &amp; Column Chart</h3>
            ...
            <div class="content-body"><!-- Basic Column Chart -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
...
@section('footer')
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/basic-bar.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/basic-column.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/change-waterfall.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/column-multi-level-control.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/irregular-bar.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/stacked-bar.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/stacked-clustered-column.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/stacked-column.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/stacked-floating-bar.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/bar-column/thermometer.min.js')}}"></script>
    <!-- END: Page JS-->

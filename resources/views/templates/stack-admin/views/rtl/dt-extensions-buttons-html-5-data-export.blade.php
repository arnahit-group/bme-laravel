                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="dt-extensions-buttons-html-5-data-export.html#">DataTables</a>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">The copyHtml5 and csvHtml5 buttons have the option to specify the character (or more generally a full string) that
                                            separates the values between fields. By default this is a tab character for the copy button, but the Comma Separated Values button uses
                                            a comma.
                                        </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">All of the data export buttons have a exportOptions option which can be used to specify information about what data
                                            should be exported and how. The options given for this parameter are passed directly to the buttons.exportData() method to obtain the
                                            required data.
                                        </p>
                                        <p>
                                            One of the most commonly used is the columns option which defines the columns that should be used as part of the export. This is given
                                            as a column-selector, making it simple to tell it if you want only visible columns, or a mix of the columns available.
                                        </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">The Excel export button saves to an XLSX file and the data can be customized before exporting the file using the
                                            customize method of the excelHtml5 button type.
                                        </p>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">It can often be useful to include description text in the print view to provide summary information about the table
                                            that will be included in the generated PDF. The message option of the pdfHtml5 button type provides this ability.
                                        </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">The page size and orientation of the pdfHtml5 button type can be set using the orientation and pageSize options. By
                                            default these values are portrait and A4, but are easily customized as shown in this example which uses a landscape layout and US legal
                                            paper size.
                                        </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">The PDFs created through the pdfHtml5 button type are generated through the PDFMake library which uses a declarative
                                            document structure to describe the PDF to be make in a simple to understand Javascript object.
                                        </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">Buttons uses the excellent FileSaver.js by Eli Grey in order to be able to create and download files on the client-side
                                            (i.e. for the CSV and Excel button types). Buttons' built in FileSaver.js is exposed via $.fn.dataTable.fileSave() when the HTML5 button
                                            types file is loaded, and it can be used to easily create your own custom files.
                                        </p>
...
@section('footer')
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/js/scripts/tables/datatables-extensions/datatable-button/datatable-html5.min.js')}}"></script>
    <!-- END: Page JS-->

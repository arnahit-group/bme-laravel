...
@section('header')
    @if(in_array(App::getLocale(),config('base.rtl_locales')))
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css-rtl/pages/invoice.min.css')}}">
        <!-- END: Page CSS-->
    ...
    @else
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css/pages/invoice.min.css')}}">
        <!-- END: Page CSS-->
                    ...
                    <div id="invoice-template" class="card-body">
                        ...
                        <div id="invoice-company-details" class="row">
                            <div class="col-md-6 col-sm-12 text-center text-md-left">
                                <div class="media">
                                    <img src="{{asset('admin-assets/images/logo/stack-80x80.png')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-12">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <img src="{{asset('admin-assets/images/pages/signature-scan.png')}}"
                        ...
                        <div id="invoice-footer">
                            <div class="row">
                                <div class="col-md-7 col-sm-12">
                                    ...
                                    <p>You know, being a test pilot isn't always the healthiest business in the world. We predict too much for the next year and yet far too little
                                        for the next 10.</p>
                                </div>

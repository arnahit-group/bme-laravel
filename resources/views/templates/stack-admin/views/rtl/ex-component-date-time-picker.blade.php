...
@section('vendor-css')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/vendors/css/pickers/datetime/bootstrap-datetimepicker.css')}}">
...
@section('header')
    @if(in_array(App::getLocale(),config('base.rtl_locales')))
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css-rtl/plugins/pickers/daterange/daterange.min.css')}}">
        <!-- END: Page CSS-->
    ...
    @else
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/css/plugins/pickers/daterange/daterange.min.css')}}">
        <!-- END: Page CSS-->
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="ex-component-date-time-picker.html#">Pickers</a>
                                </li>
                ...
                <section id="datetime">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form action="ex-component-date-time-picker.html#">
                                    <div class="row">
                                    ...
                                    <div class="row">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar-o"></span>
                                                ...
                                                <small class="text-muted">Disable certain days of the week, such as all Saturdays (7th day of week) and Sundays (1st day of week),
                                                    by passing an integer between 1 and 7
                                                </small>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="row">
										...
										<span class="input-group-text">
											<span class="ft-clock"></span>
                                                ...
                                                <small class="text-muted">Use <code>.pickatime-format</code> class to change time display formats.</small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="ft-clock"></span>
                                                ...
                                                <small class="text-muted">Enable only a specific or arbitrary set of times by setting true as the first item in the collection
                                                </small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="ft-clock"></span>
                                                ...
                                                <small class="text-muted">The onSet event is the only callback that is passed a context argument that provides details as to which
                                    ...
                                    <div class="row">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">The Date Range Picker is attached to a text input. It will use the current value of the input to
                                                    initialize, and update the input if new dates are chosen.
                                                </small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">The Date Range Picker can also be used to select times. Hour, minute and (optional) second dropdowns are
                                                    added below the calendars. An option exists to set the increment count of the minutes dropdown to e.g. offer only 15-minute or
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Use 24-hour instead of 12-hour times, removing the AM/PM selection. Show seconds in the timePicker</small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">The Date Range Picker can be turned into a single date picker widget with only one calendar. In this
                                                    example, dropdowns to select a month and year have also been enabled at the top of the calendar to quickly jump to different
                                                    months.
                                                </small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted"> Hide the apply and cancel buttons, and automatically apply a new date range as soon as two dates or a
                                                    predefined range is selected
                                                </small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">When enabled, the two calendars displayed will always be for two sequential months (i.e. January and
                                                    February), and both will be advanced when clicking the left or right arrows above the calendars. When disabled, the two
                                                    calendars can be individually advanced and display any month/year.
                                                </small>
                                            </div>
                                            <div class="form-group">
                                                <label>Not Linked Calendars</label>
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Show year and month select boxes above calendars to jump to a specific month and year</small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Show localized week numbers at the start of each week on the calendars</small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Set predefined date ranges the user can select from. Each key is the label for the range, and its value an
                                                    array with two dates representing the bounds of the range
                                                </small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Normally, if you use the ranges option to specify pre-defined date ranges, calendars for choosing a custom
                                                    date range are not shown until the user clicks "Custom Range". When this option is set to true, the calendars for choosing a
                                                    custom date range are always shown instead.
                                                </small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Allows you to provide localized strings for buttons and labels, customize the date display format, and
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Whether the picker appears aligned to the left, to the right, or centered under the HTML element it's
                                                    attached to.
                                                </small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">Whether the picker appears below (default) or above the HTML element it's attached to.</small>
                                            </div>
                                            <div class="form-group">
										...
										<span class="input-group-text">
											<span class="fa fa-calendar"></span>
                                                ...
                                                <small class="text-muted">CSS class names that will be added to all buttons in the picker.</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('vendor-js')
    ...
    <script src="{{asset('admin-assets/vendors/js/pickers/dateTime/moment-with-locales.min.js')}}"></script>
    <script src="{{asset('admin-assets/vendors/js/pickers/dateTime/bootstrap-datetimepicker.min.js')}}"></script>
...
@section('footer')
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/js/scripts/pickers/dateTime/bootstrap-datetime.min.js')}}"></script>

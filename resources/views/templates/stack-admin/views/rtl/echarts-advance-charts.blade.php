        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Echarts - Advance Charts</h3>
...
@section('footer')
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/tornado.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/timeline.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/timeline-options.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/time-data.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/candlestick-multi-level-control.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/dynamic-data.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/event-river.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/eventRiver2-data.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/multiple-series-rainbow.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/treemap.min.js')}}"></script>
    <script src="{{asset('admin-assets/js/scripts/charts/echarts/advance/word-cloud.min.js')}}"></script>
    <!-- END: Page JS-->

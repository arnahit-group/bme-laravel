                        ...
                        <div class="card">
                            ...
                            <div class="card-content px-1">
                                <div id="recent-buyers" class="media-list height-300 position-relative">
                                    <a href="dashboard-ecommerce.html#" class="media border-0">
                            ...
                            <i></i>
                                    ...
                                    <a href="dashboard-ecommerce.html#" class="media border-0">
                                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online"><img class="media-object rounded-circle" src="{{asset('admin-assets/images/portrait/small/avatar-s-10.png')}}"
                                                                              alt="Generic placeholder image">
                            <i></i>
                            </span>
                                        </div>
                                    ...
                                    <a href="dashboard-ecommerce.html#" class="media border-0">
                                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online"><img class="media-object rounded-circle" src="{{asset('admin-assets/images/portrait/small/avatar-s-11.png')}}"
                                                                              alt="Generic placeholder image">
                            <i></i>
                            </span>
                                        </div>
                                    ...
                                    <a href="dashboard-ecommerce.html#" class="media border-0">
                                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-away"><img class="media-object rounded-circle" src="{{asset('admin-assets/images/portrait/small/avatar-s-12.png')}}"
                                                                            alt="Generic placeholder image">
                            <i></i>
                            </span>
                                        </div>
                ...
                <div class="row match-height">
                    <div class="col-xl-8 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p>Total paid invoices 240, unpaid 150. <span class="float-right"><a href="project-summary.html" target="_blank">Invoice Summary <i
                                    ...
                                    <table id="recent-orders" class="table table-hover mb-0 ps-container ps-theme-default">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate"><a href="dashboard-ecommerce.html#">INV-01112</a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate"><a href="dashboard-ecommerce.html#">INV-001012</a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate"><a href="dashboard-ecommerce.html#">INV-001401</a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate"><a href="dashboard-ecommerce.html#">INV-008101</a></td>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="chart-stats text-center">
                                    <a href="dashboard-ecommerce.html#" class="btn btn-sm btn-primary mr-1">Statistics <i class="ft-bar-chart"></i></a> <span class="text-muted">for the last year.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row match-height">
                                        ...
                                        <section class="cd-horizontal-timeline">
                                            <div class="timeline">
                                                <div class="events-wrapper">
                                                    <div class="events">
                                                        <ol>
                                                            <li><a href="dashboard-ecommerce.html#0" data-date="16/01/2015" class="selected">16 Jan</a></li>
                                                            <li><a href="dashboard-ecommerce.html#0" data-date="28/02/2015">28 Feb</a></li>
                                                            <li><a href="dashboard-ecommerce.html#0" data-date="20/04/2015">20 Mar</a></li>
                                                            <li><a href="dashboard-ecommerce.html#0" data-date="20/05/2015">20 May</a></li>
                                                            <li><a href="dashboard-ecommerce.html#0" data-date="09/07/2015">09 Jul</a></li>
                                                            <li><a href="dashboard-ecommerce.html#0" data-date="30/08/2015">30 Aug</a></li>
                                                            <li><a href="dashboard-ecommerce.html#0" data-date="15/09/2015">15 Sep</a></li>
                                                        </ol>
                                                ...
                                                <ul class="cd-timeline-navigation">
                                                    <li><a href="dashboard-ecommerce.html#0" class="prev inactive">Prev</a></li>
                                                    <li><a href="dashboard-ecommerce.html#0" class="next">Next</a></li>
                                                </ul>
                                            ...
                                            <div class="events-content">
                                                <ol>
                                                    <li class="selected" data-date="16/01/2015">
                                                        ...
                                                        <p class="lead mt-2">
                                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum praesentium officia, fugit recusandae ipsa, quia velit
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <img class="img-fluid" src="{{asset('admin-assets/images/carousel/06.jpg')}}" 
                                     alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <a href="dashboard-ecommerce.html#" class="card-link">Card link</a>
                                    <a href="dashboard-ecommerce.html#" class="card-link">Another link</a>
                                </div>
                            </div>
                            <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                                <span class="float-left">3 hours ago</span>
                                <span class="float-right">
                    <a href="dashboard-ecommerce.html#" class="card-link">Read More <i class="fa fa-angle-right"></i></a>
                  </span>
                            </div>
                        </div>
                    </div>

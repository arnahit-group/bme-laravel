                                ...
                                <div class="card-content">
                                    <div class="text-center">
                                        ...
                                        <img alt="bg-img" class="img-responsive block width-300 mx-auto" src="{{asset('admin-assets/images/logo/stack-logo-light-big.png')}}"
                                             width="300">
                                        <div class="card-text getting-started mt-3 white d-sm-flex justify-content-center d-inline-block" id="clockImage"></div>
                                        <div class="col-12 pt-1">
                                            <p class="card-text lead white">Our website is under construction.</p>
                                        </div>
                                        <div class="col-12 text-center pt-2">
                                            <p class="socialIcon card-text">
                                                <a href="coming-soon-bg-image.html#"><i class="fa fa-facebook-square white"></i></a>
                                                <a href="coming-soon-bg-image.html#"><i class="fa fa-twitter-square white"></i></a>
                                                <a href="coming-soon-bg-image.html#"><i class="fa fa-google-plus-square white"></i></a>
                                                <a href="coming-soon-bg-image.html#"><i class="fa fa-linkedin-square white"></i></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>

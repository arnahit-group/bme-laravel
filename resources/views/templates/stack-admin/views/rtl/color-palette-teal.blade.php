        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Teal Color Page</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="color-palette-teal.html#">Color System</a>
                                </li>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right">
                                            <p class="card-title">
                                                <small class="float-right">#009688</small>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 1</strong>
                                            <small class="text-muted float-right">#26A69A</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 2</strong>
                                            <small class="text-muted float-right">#4DB6AC</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 3</strong>
                                            <small class="text-muted float-right">#80CBC4</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 4</strong>
                                            <small class="text-muted float-right">#B2DFDB</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 1</strong>
                                            <small class="text-muted float-right">#00897B</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 2</strong>
                                            <small class="text-muted float-right">#00796B</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 3</strong>
                                            <small class="text-muted float-right">#00695C</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 4</strong>
                                            <small class="text-muted float-right">#004D40</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 1</strong>
                                            <small class="text-muted float-right">#A7FFEB</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 2</strong>
                                            <small class="text-muted float-right">#64FFDA</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 3</strong>
                                            <small class="text-muted float-right">#1DE9B6</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    ...
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 4</strong>
                                            <small class="text-muted float-right">#00BFA5</small>
                                        </p>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <p>Teal color palette contains 13 colors: 1 main teal color and 4 lighten colors, 4 darken colors and 4 Accent colors. All colors works
                                            ...
                                            configurable.</p>
                                        <p class="mt-1"><strong>Please note:</strong> You can use .bg-teal and .btn-teal as main colors, but if you want to use lighten, darken or
                                                ...
                                                <table class="table table-bordeteal">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>For <code>lighten</code> teal background color, this two classes needed. Here *: 1,2,3,4 lighten teal color options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.bg-teal</code><br><code>.bg-darken-*</code></td>
                                                            <td>For <code>darken</code> teal background color, this two classes needed. Here *: 1,2,3,4 darken teal color options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.bg-teal</code><br><code>.bg-accent-*</code></td>
                                                            <td>For <code>accent</code> teal background color, this two classes needed. Here *: 1,2,3,4 accent teal color options.
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 1</strong>
                                            <small class="text-muted float-right teal">#26A69A</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 2</strong>
                                            <small class="text-muted float-right teal lighten-2">#4DB6AC</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 3</strong>
                                            <small class="text-muted float-right teal lighten-3">#80CBC4</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Lighten 4</strong>
                                            <small class="text-muted float-right teal lighten-4">#B2DFDB</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 1</strong>
                                            <small class="text-muted float-right teal darken-1">#00897B</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 2</strong>
                                            <small class="text-muted float-right teal darken-2">#00796B</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 3</strong>
                                            <small class="text-muted float-right teal darken-3">#00695C</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Darken 4</strong>
                                            <small class="text-muted float-right teal darken-4">#004D40</small>
                                        </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 1</strong>
                                            <small class="text-muted float-right teal accent-1">#A7FFEB</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 2</strong>
                                            <small class="text-muted float-right teal accent-2">#64FFDA</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 3</strong>
                                            <small class="text-muted float-right teal accent-3">#1DE9B6</small>
                                        </p>
                            ...
                            <div class="card mb-1">
                                <div class="card-content">
                                    <div class="p-1">
                                        <p class="mb-0"><strong>Teal Accent 4</strong>
                                            <small class="text-muted float-right teal accent-4">#00BFA5</small>
                                        </p>
                                                ...
                                                <table class="table table-bordeteal">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>For <code>lighten</code> teal text color, this two classes needed. Here *: 1,2,3,4 for lighten teal color options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.teal</code><br><code>.darken-*</code></td>
                                                            <td>For <code>darken</code> teal text color, this two classes needed. Here *: 1,2,3,4 for darken teal color options.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><code>.teal</code><br><code>.accent-*</code></td>
                                                            <td>For <code>accent</code> teal text color, this two classes needed. Here *: 1,2,3,4 for accent teal color options.
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>

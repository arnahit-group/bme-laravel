            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.1s">
                <div class="hotel_container">
                    ...
                    <div class="hotel_title">
                        ...
                        <div class="wishlist">
                            <a class="tooltip_flip tooltip-effect-1" href="index_11.html#">+<span class="tooltip-content-flip"><span
        ...
        <div class="container margin_60">
            ...
            <div class="row add_bottom_45">
                <div class="col-md-4 other_tours">
                    <ul>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-3"></i>تور شهر بازی<span class="other_tours_price">۵۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-30"></i>تور خرید<span class="other_tours_price">۳۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-44"></i>تور مکان های تاریخی<span class="other_tours_price">۶۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-3"></i>تور سرگرمی<span class="other_tours_price">۶۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-44"></i>تور تخت جمشید<span class="other_tours_price">۹۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-3"></i>تور جنگل حرا<span class="other_tours_price">۴۵.۰۰۰ تومان</span></a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 other_tours">
                    <ul>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-1"></i>تور بازدید از مکان های مذهبی<span class="other_tours_price">۴۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-4"></i>تور تاریخی<span class="other_tours_price">۲۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-30"></i>تلکابین رامسر<span class="other_tours_price">۱۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-3"></i>تور اتوبوس گردی<span class="other_tours_price">۳۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-30"></i>تور کیش گردی<span class="other_tours_price">۶۸۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-3"></i>تور قشم گردی<span class="other_tours_price">۵۸۰.۰۰۰ تومان</span></a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 other_tours">
                    <ul>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-37"></i>تور اصفهان گردی<span class="other_tours_price">۳۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-1"></i>تور مشهد<span class="other_tours_price">۴۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-50"></i>تور مراکز خرید<span class="other_tours_price">۹۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-44"></i>تور غار گردی<span class="other_tours_price">۱۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-50"></i>تور خرید از قشم<span class="other_tours_price">۵۵۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="index_11.html#"><i class="icon_set_1_icon-44"></i>تور اثار تاریخی ایران<span class="other_tours_price">۱.۵۰۰.۰۰۰ تومان</span></a>
                        </li>
                    </ul>
                </div>
            </div><!-- End row -->
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="index_11.html#"><img src="img/bus.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="index_11.html#"><img src="img/transfer.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="index_11.html#"><img src="img/guide.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="index_11.html#"><img src="img/hotel.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
...
@section('footer')
    ...
    <!-- Pop up script  -->
    <script type="text/javascript" src="{{asset('alibaba/js/pop_up.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('alibaba/js/pop_up_func.js')}}"></script>

...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="blog_post.html#">صفحه اصلی</a></li>
                <li><a href="blog_post.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End position -->
        ...
        <div class="row">
            <aside class="col-md-3 add_bottom_30">
                ...
                <div class="widget" id="cat_blog">
                    <h4>دسته بندی ها</h4>
                    <ul>
                        <li><a href="blog_post.html#">مکان های دیدنی</a></li>
                        <li><a href="blog_post.html#">تورهای برتر</a></li>
                        <li><a href="blog_post.html#">نکاتی برای مسافران</a></li>
                        <li><a href="blog_post.html#">مناسبت ها</a></li>
                    </ul>
                </div><!-- End widget -->
                ...
                <div class="widget">
                    ...
                    <ul class="recent_post">
                        <li>
                            ...
                            <div><a href="blog_post.html#">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </a></div>
                        </li>
                        <li>
                            <i class="icon-calendar-empty"></i> ۲ اردیبهشت ۱۳۹۶
                            <div><a href="blog_post.html#">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </a></div>
                ...
                <div class="widget tags">
                    <h4>برچسب ها</h4>
                    <a href="blog_post.html#">لورم اپیسوم</a>
                    <a href="blog_post.html#">سفرنامه</a>
                    <a href="blog_post.html#">سفر</a>
                    <a href="blog_post.html#">مسافرت</a>
                    <a href="blog_post.html#">کلمات لاتین</a>
                    <a href="blog_post.html#">مسافرت های خارجه</a>
                </div><!-- End widget -->
            ...
            <div class="col-md-9">
                <div class="box_style_1">
                    <div class="post nopadding">
                        ...
                        <div class="post_info clearfix">
                            <div class="post-left">
                                <ul>
                                    ...
                                    <li><i class="icon-inbox-alt"></i>که در <a href="blog_post.html#">تور های برتر</a></li>
                                    <li><i class="icon-tags"></i>پرچسب ها <a href="blog_post.html#">دنیا</a> <a href="blog_post.html#">سفرنامه ها</a></li>
                                </ul>
                            </div>
                            <div class="post-right"><i class="icon-comment"></i><a href="blog_post.html#">۲۵ </a>نظرات</div>
                        </div>
                        ...
                        <blockquote class="styled">
                            ...
                            <small>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم <cite title="">بیستر ...</></small>
                        </blockquote>
                    </div><!-- end post -->
                </div><!-- end box_style_1 -->
                ...
                <div id="comments">
                    <ol>
                        <li>
                            <div class="avatar"><a href="blog_post.html#"><img src="img/avatar1.jpg" alt=""></a></div>
                            <div class="comment_right clearfix">
                                <div class="comment_info">
                                    ارسال شده توسط <a href="blog_post.html#">علی خارا</a><span>|</span> ۲ اردیبهشت ۱۳۹۶ <span>|</span><a href="blog_post.html#">پاسخ</a>
                                </div>
                                <p>
                            ...
                            <ul>
                                <li>
                                    <div class="avatar"><a href="blog_post.html#"><img src="img/avatar2.jpg" alt=""></a></div>

                                    <div class="comment_right clearfix">
                                        <div class="comment_info">
                                            ارسال شده توسط <a href="blog_post.html#">حجت شهبازی</a><span>|</span> ۲ اردیبهشت ۱۳۹۶ <span>|</span><a
                                                    href="blog_post.html#">پاسخ</a></div>
                                        <p>
                        ...
                        <li>
                            <div class="avatar"><a href="blog_post.html#"><img src="img/avatar3.jpg" alt=""></a></div>

                            <div class="comment_right clearfix">
                                <div class="comment_info">
                                    ارسال شده توسط <a href="blog_post.html#">مهدی حامدی</a><span>|</span> ۲ اردیبهشت ۱۳۹۶ <span>|</span><a href="blog_post.html#">پاسخ</a></div>
                            </div>
                            <p>
            ...
            <h4>پیام بگذارید</h4>
            <form action="blog_post.html#" method="post">

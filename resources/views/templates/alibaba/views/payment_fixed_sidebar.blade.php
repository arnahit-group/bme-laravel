...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="payment_fixed_sidebar.html#">صفحه اصلی</a></li>
                <li><a href="payment_fixed_sidebar.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End position -->
        ...
        <div class="row">
            <div class="col-md-8 add_bottom_15">
                ...
                <div id="policy">
                    ...
                    <a href="confirmation_fixed_sidebar.html" class="btn_1 green medium">ثبت</a>
                </div>
            </div>
            ...
            <aside class="col-md-4" id="sidebar">
                <div class="theiaStickySidebar">
                    <div class="box_style_1" id="booking_box">
                        ...
                        <a class="btn_full" href="confirmation_fixed_sidebar.html">ثبت سفارش</a>
                        <a class="btn_full_outline" href="payment_fixed_sidebar.html#"><i class="icon-right"></i> ادامه خرید</a>
                    </div>
                </div><!--End sticky -->
            </aside>

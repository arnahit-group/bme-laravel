...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="payment_restaurant.html#">صفحه اصلی</a></li>
                <li><a href="payment_restaurant.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End position -->
    ...
    <div class="container margin_60">
        <div class="row">
            <div class="col-md-8 add_bottom_15">
                ...
                <div class="form_title">
                    <h3><strong>۲</strong>کارت اعتباری برای رزرو</h3>
                    <p>
                        کارت خود را برای رزرو وارد کنید
                    </p>
                </div>
                <div class="step">
                    <div class="form-group">
                ...
                <div id="policy">
                    ...
                    <a href="confirmation_restaurant.html" class="btn_1 green medium">اکنون ثبت کن</a>
                </div>
            </div>
            ...
            <aside class="col-md-4">
                <div class="box_style_1">
                    ...
                    <a class="btn_full" href="confirmation_restaurant.html">ثبت سفارش</a>
                    <a class="btn_full_outline" href="payment_restaurant.html#"><i class="icon-right"></i> ادامه خرید</a>
                </div>

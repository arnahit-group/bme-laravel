...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="single_hotel_datepicker_adv.html#">صفحه اصلی</a></li>
                <li><a href="single_hotel_datepicker_adv.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End Position -->
    ...
    <div class="container margin_60">
        <div class="row">
            <div class="col-md-8" id="single_tour_desc">
                ...
                <p class="visible-sm visible-xs"><a class="btn_map" data-toggle="collapse" href="single_hotel_datepicker_adv.html#collapseMap" aria-expanded="false"
                ...
                <div class="row">
                    <div class="col-md-3">
                        <h3>بررسی</h3>
                        <a href="single_hotel_datepicker_adv.html#" class="btn_1 add_bottom_30" data-toggle="modal" data-target="#myReview">بررسی پیشرفته</a>
                    </div>
                    <div class="col-md-9">
            ...
            <aside class="col-md-4">
                <p class="hidden-sm hidden-xs">
                    <a class="btn_map" data-toggle="collapse" href="single_hotel_datepicker_adv.html#collapseMap" aria-expanded="false" aria-controls="collapseMap">نمایش بر روی
                        نقشه</a>
                </p>
                <div class="box_style_1 expose">
                    ...
                    <a class="btn_full_outline" href="single_hotel_datepicker_adv.html#"><i class=" icon-heart"></i> علاقه مند شدم</a>
                </div><!--/box_style_1 -->
...
@section('footer')
    ...
    <script src="{{asset('alibaba/js/datepicker_advanced.js')}}"></script>

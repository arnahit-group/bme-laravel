...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="all_transfer_grid.html#">صفحه اصلی</a></li>
                <li><a href="all_transfer_grid.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- Position -->
    ...
    <div class="container margin_60">
        <div class="row">
            <aside class="col-lg-3 col-md-3">
                ...
                <div id="filters_col">
                    <a data-toggle="collapse" href="all_transfer_grid.html#collapseFilters" aria-expanded="false" aria-controls="collapseFilters" id="filters_col_bt"><i
                    ...
                    <div class="collapse" id="collapseFilters">
                        ...
                        <div class="filter_type">
                            <h6>امکان</h6>
                            <ul>
                                <li><label><input type="checkbox">باغ وحش ها</label></li>
                                <li><label><input type="checkbox">اماکن تاریخی</label></li>
                                <li><label><input type="checkbox">رستوران ها</label></li>
                                <li><label><input type="checkbox">پارک ها</label></li>
                            </ul>
                        </div>
                    </div><!--End collapse -->
                </div><!--End filters col-->
            ...
            <div class="col-lg-9 col-md-8">
                        ...
                        <div class="transfer_container">
                            <div class="img_container">
                                <a href="single_transfer.html">
                                    <img src="img/transfer_2.jpg" width="800" height="533" class="img-responsive" alt="">
                                    <div class="ribbon top_rated"></div>
                                    <div class="short_info">
                                        روزانه / شبانه<span class="price"><sup>۲۰.۰۰۰ تومان</sup></span>
                                    </div>
                                </a>
                            </div>
                            <div class="transfer_title">
                                <h3><strong>بازدید</strong> شهری</h3>
                                <div class="rating">
                                    <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i
                                            class="icon-smile"></i>
                                </div><!-- end rating -->
                                <div class="wishlist">
                                    <a class="tooltip_flip tooltip-effect-1" href="all_transfer_grid.html#">+<span class="tooltip-content-flip"><span class="tooltip-back">علاقمند شدم</span></span></a>
                                </div><!-- End wish list-->
                            </div>
                        </div><!-- End box tour -->
                    </div><!-- End col-md-6 -->
                        ...
                        <div class="transfer_container">
                            <div class="img_container">
                                <a href="single_transfer.html">
                                    ...
                                    <div class="ribbon top_rated"></div>
                                    <div class="short_info">
                                        روزانه<span class="price"><sup>۴۰.۰۰۰ تومان</sup></span>
                                    </div>
                                </a>
                            </div>
                            <div class="transfer_title">
                                <h3><strong>بازدید از </strong> باغ وحش</h3>
                                <div class="rating">
                                    <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i
                                            class="icon-smile"></i>
                                </div><!-- end rating -->
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                        <div class="transfer_container">
                            <div class="img_container">
                                <a href="single_transfer.html">
                                    <img src="img/transfer_3.jpg" width="800" height="533" class="img-responsive" alt="">
                                    <div class="ribbon top_rated"></div>
                                    <div class="short_info">
                                        شبانه<span class="price"><sup>۸۰.۰۰۰ تومان</sup></span>
                                    </div>
                                </a>
                            </div>
                            <div class="transfer_title">
                    ...
                    <div class="col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                        <div class="transfer_container">
                            <div class="img_container">
                                <a href="single_transfer.html">
                                    <img src="img/transfer_4.jpg" width="800" height="533" class="img-responsive" alt="">
                            ...
                            <div class="transfer_title">
                                <h3><strong>جاذبه های</strong> شهری</h3>
                                <div class="rating">
                                    <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i
                                            class="icon-smile"></i>
                                </div><!-- end rating -->
                ...
                <div class="text-center">
                    <ul class="pagination">
                        <li><a href="all_transfer_grid.html#">قبلی</a></li>
                        <li class="active"><a href="all_transfer_grid.html#">۱</a></li>
                        <li><a href="all_transfer_grid.html#">۲</a></li>
                        <li><a href="all_transfer_grid.html#">۳</a></li>
                        <li><a href="all_transfer_grid.html#">۴</a></li>
                        <li><a href="all_transfer_grid.html#">۵</a></li>
                        <li><a href="all_transfer_grid.html#">بعدی</a></li>
                    </ul>
                </div><!-- end pagination-->

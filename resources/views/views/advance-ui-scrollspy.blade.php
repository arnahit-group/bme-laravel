...
@section('main')
    ...
    <div id="main">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Scrollspy</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="advance-ui-scrollspy.html#">Advance UI</a>
                                </li>
                                <li class="breadcrumb-item active">Scrollspy
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="advance-ui-scrollspy.html#!"><i
                            ...
                            <div class="col m9 l10 s12">
                                <div class="card">
                                    <div class="card-content">
                                        <p class="caption mb-0">Scrollspy is a jQuery plugin that tracks certain
                                            elements and which element the
                                            user's screen is currently centered on. Our main demo of this is our
                                            table of contents on every
                                            documentation page to the right. Clicking on these links will also
                                            scroll the page to that element.</p>
                                    </div>
                                </div>
                                <!-- Table of Contents Structure -->
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="card card card-default scrollspy" id="structure">
                                            <div class="card-content">
      ...
      &lt;/div&gt;
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="card card card-default scrollspy" id="initialization">
                                            <div class="card-content">
      ...
      $(document).ready(function(){
        $('.scrollspy').scrollSpy();
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="card card card-default scrollspy" id="option">
                                            <div class="card-content">
                                                ...
                                                <table class="highlight responsive-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>scrollOffset</td>
                                                            <td>Offset for centering element when scrolled to.
                                                                Default: 200
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>activeClass</td>
                                                            <td>Class name to be added to the active link. Default:
                                                                active
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                Function that returns a selector to add <code
                                                                        class=" inline language-markup">activeClass</code>
                                    ...
                                    <div class="col s12 m12 l12">
                                        <div class="card card card-default scrollspy" id="methods">
                                            <div class="card-content">
                                                ...
                                                <p class="m-0">Because jQuery is no longer a dependency, all the
  ...
  */
                            ...
                            <div class="col hide-on-small-only m3 l2">
                                <div class="toc-wrapper">
                                    ...
                                    <br>
                                    <ul class="section table-of-contents">
                                        <li><a href="advance-ui-scrollspy.html#structure">Structure</a></li>
                                        <li><a href="advance-ui-scrollspy.html#initialization">Intialization</a>
                                        </li>
                                        <li><a href="advance-ui-scrollspy.html#option">Option</a></li>
                                        <li><a href="advance-ui-scrollspy.html#methods">Methods</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="advance-ui-scrollspy.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="advance-ui-scrollspy.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-scrollspy.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-scrollspy.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="advance-ui-scrollspy.html#!"><i
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/advance-ui-scrollspy.js')}}" type="text/javascript"></script>

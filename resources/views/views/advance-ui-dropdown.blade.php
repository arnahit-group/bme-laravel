...
@section('main')
        ...
        <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Dropdown</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="advance-ui-dropdown.html#">Advance UI</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="advance-ui-dropdown.html#!"><i
            ...
            <div class="col s12">
                <div class="container">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <p class="caption">Add a dropdown list to any button. Make sure that the <code
                                    ...
                                    attribute matches the id in the <code class=" language-markup"><span
                                                class="token tag"><span class="token tag"><span
                                                        class="token punctuation">&lt;</span>ul</span><span
                                                    class="token punctuation">&gt;</span></span></code>
                                    tag. You can add a divider with the <code class=" language-markup"><span
                                                class="token tag"><span class="token tag"><span
                                                        class="token punctuation">&lt;</span>li</span> <span
                                                    class="token attr-name">class</span><span class="token attr-value"><span
                                                        class="token punctuation">=</span><span
                                                        class="token punctuation">"</span>divider<span
                                                        class="token punctuation">"</span></span><span
                                                    class="token punctuation">&gt;</span></span><span
                                                class="token tag"><span class="token tag"><span
                                                        class="token punctuation">&lt;/</span>li</span><span
                                                    class="token punctuation">&gt;</span></span></code> tag. You can also
                                    add icons. Just add the icon
                                    inside
                    ...
                    <div class="row">
                        <div class="col s12">
                            <div class="card card-tabs position-none" id="drop-me">
                                <div class="card-content">
                                            ...
                                            <div class="col s12 m6 l2">
                                                <ul class="tabs">
                                                    <li class="tab col s6 p-0"><a class="active p-0"
                                                                                  href="advance-ui-dropdown.html#view-drop-me">View</a>
                                                    </li>
                                                    <li class="tab col s6 p-0"><a class="p-0"
                                                                                  href="advance-ui-dropdown.html#html-drop-me">Html</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                ...
                                                <a class='dropdown-trigger btn' data-target='dropdown1'
                                                   href='advance-ui-dropdown.html#'>Drop Me!</a>

                                                <!-- Dropdown Structure -->
                                                <ul class='dropdown-content' id='dropdown1'>
                                                    <li><a href="advance-ui-dropdown.html#!">one</a></li>
                                                    <li><a href="advance-ui-dropdown.html#!">two</a></li>
                                                    <li class="divider" tabindex="-1"></li>
                                                    <li><a href="advance-ui-dropdown.html#!">three</a></li>
                                                    <li><a href="advance-ui-dropdown.html#!"><i
                                                                    class="material-icons">view_module</i>four</a></li>
                                                    <li><a href="advance-ui-dropdown.html#!"><i
                                                                    class="material-icons">cloud</i>five</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <table class="striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>inDuration</td>
                                                <td>The duration of the transition enter in milliseconds. Default:
                                                    300
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>outDuration</td>
                                                <td>The duration of the transition out in milliseconds. Default:
                                                    225
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>constrainWidth</td>
                                                <td>If true, constrainWidth to the size of the dropdown activator.
                                                    Default: true
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>coverTrigger</td>
                                                <td>If true, the dropdown will show below the activator. Default:
                                                    false
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>If true, stops the event propagating from the dropdown origin
                                                    click handler. Default: false
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <p>To use these inline you have to add them as data attributes. If you want more
                                        dynamic control, you can
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card card card-default scrollspy" id="initialization">
                                <div class="card-content">
                                    ...
                                    <p>Initialization for dropdowns is only necessary if you create them
                                        dynamically.</p>
  ...
  stopPropagation: false // Stops event propagation
                    ...
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <div class="card card card-default scrollspy" id="init">
                                <div class="card-content">
                                    <p>You can also open dropdowns programatically, the below code will make your
  ...
  $('.dropdown-trigger').dropdown('open');
                    ...
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <div class="card card card-default scrollspy" id="init-programatically">
                                <div class="card-content">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="advance-ui-dropdown.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="advance-ui-dropdown.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-dropdown.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-dropdown.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="advance-ui-dropdown.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

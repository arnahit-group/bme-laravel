...
@section('header')
    ...
    <link href="{{asset('app-assets/css/pages/page-contact.css')}}" rel="stylesheet" type="text/css">
    ...
    <div id="main">
        <div class="row">
                                ...
                                <div class="row contact-us">
                                    <div class="col s12 m12 l4 sidebar-title">
                                        ...
                                        <span class="social-icons hide-on-med-and-down"><i
                                                    class="fab fa-behance"></i> <i class="fab fa-dribbble ml-5"></i>
            <i class="fab fa-facebook-f ml-5"></i> <i class="fab fa-instagram ml-5"></i></span>
                            ...
                            <!-- Contact Sidenav -->
                            <div class="row contact-sidenav" id="sidebar-list">
                                    ...
                                    <div class="sidebar-left sidebar-fixed">
                                        <div class="sidebar">
                                            <div class="sidebar-content">
                                                <div class="sidebar-menu list-group position-relative">
                                                    <div class="sidebar-list-padding app-sidebar contact-app-sidebar"
                                                        ...
                                                        <ul class="contact-list display-grid">
                                                            ...
                                                            <li>
                                                                <h6 class="mt-5 line-height">You are one step closer
                                                                    to build your perfect product</h6>
                                                            </li>
                                                            <li>
                                                                <hr class="mt-5">
                                                            </li>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col s12 place mt-4 p-0">
                                                                ...
                                                                <div class="col s10 m10 l10">
                                                                    <p class="m-0">360 King street, <br>
                                                                        Feasterville Trevose, PA 19053</p>
                                                                </div>
                                                            </div>
                                                            <!-- Phone -->
                                                ...
                                                <a class="sidenav-trigger" data-target="contact-sidenav"
                                                   href="page-contact.html#"><i class="material-icons">menu</i></a>
                                    ...
                                    <div class="row">
                                        <form class="col s12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col m6 s12">
                                                    <input class="validate" id="budget" type="text">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="page-contact.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="page-contact.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-contact.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-contact.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="page-contact.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/page-contact.js')}}" type="text/javascript"></script>

                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Feature Discovery</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="advance-ui-feature-discovery.html#">Advance
                                        UI</a>
                                </li>
                                <li class="breadcrumb-item active">Feature Discovery
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="advance-ui-feature-discovery.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption">Provide value and encourage return visits by introducing users to
                                    new features and
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="tap-target">
                                    <div class="card-content">
                                                ...
                                                <div class="col s12 m6 l6">
                                                    <ul class="tabs">
                                                        <li class="tab col s4 p-0"><a class="active p-0"
                                                                                      href="advance-ui-feature-discovery.html#view-tap-target">View</a>
                                                        </li>
                                                        <li class="tab col s4 p-0"><a class="p-0"
                                                                                      href="advance-ui-feature-discovery.html#html-tap-target">Html</a>
                                                        </li>
                                                        <li class="tab col s4 p-0"><a class="p-0"
                                                                                      href="advance-ui-feature-discovery.html#js-tap-target">JS</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-tap-target">
                                            <div class="row">
                                                <div class="col s12">
                                                    <p>Feature discovery prompts have more impact when they are
                                                        presented to the right users at
                                                        contextually relevant moments. When presented to the wrong
                                                        user at the wrong time, they can be
                                                        intrusive and annoying.</p>
                                                </div>
                                                <div class="col s12">
                                                    <a class="waves-effect waves-light btn mt-2"
                                                       onclick="$('.tap-target').tapTarget('open')">Open tap
                                                        target</a>
                                                    &nbsp;
                                                    <a class="waves-effect waves-light btn mt-2"
                                                       onclick="$('.tap-target').tapTarget('close')">Close tap
                                                        target</a>
                                                </div>
                                                <div class="col s12">
                                                    <div class="fixed-action-btn"
                                                         style="bottom: 45px; right: 24px;">
                                                        <a class="btn btn-floating btn-large cyan" id="menu">
                                                    ...
                                                    <div class="tap-target cyan" data-target="menu">
                                                        <div class="tap-target-content white-text">
                                                            ...
                                                            <p class="white-text">Provide value and encourage return
                                                                visits by introducing users to new
                                                                features and functionality at contextually relevant
                                                                moments.</p>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="advance-ui-feature-discovery.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active"
                                                           href="advance-ui-feature-discovery.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-feature-discovery.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-feature-discovery.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="advance-ui-feature-discovery.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/advance-ui-feature-discovery.js')}}" type="text/javascript"></script>

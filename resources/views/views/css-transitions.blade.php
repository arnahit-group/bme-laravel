                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Transitions</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="css-transitions.html#">CSS</a>
                                </li>
                                <li class="breadcrumb-item active">Transitions
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="css-transitions.html#!"><i
            ...
            <div class="col s12">
                <div class="container">
                    <div class="section">
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="scale">
                                    <div class="card-content">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-transitions.html#view-animations">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-transitions.html#html-animations">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-animations">
                                            <div class="row">
                                                <div class="col s12">
                                                    <p>Use this scale in and out elements. Make sure to add the base
                                                        transition class <a>scale-transition.</a>
                                                        Then add the class <a>scale-out</a> to scale the element
                                                        down until it is hidden. To start something
                                                        as hidden, add the class <a>scale-out</a> first, and then
                                                        add the class scale-in to scale the element
                                                        up until it is shown.</p>
                                                    <!-- Scaled in -->
                                                    <a class="btn-floating btn-large scale-transition mt-2" href="css-transitions.html#!"
                                                       id="scale-demo">
                                                        <i class="material-icons">add</i>
                                                    </a>
                                                    <!-- Scaled out -->
                                                    <a class="btn-floating btn-large scale-transition scale-out mt-2" href="css-transitions.html#!"
                                                       id="scale-demo-out">
                                                        <i class="material-icons">add</i>
                                                    </a>
                                                    <a class="btn right mt-2" href="css-transitions.html#!"
                                                       id="scale-demo-trigger">Toggle Scale</a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="css-transitions.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="css-transitions.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-transitions.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-transitions.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="css-transitions.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/css-transition.js')}}" type="text/javascript"></script>

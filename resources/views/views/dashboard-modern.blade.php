...
@section('vendor-css')
    <link href="{{asset('app-assets/vendors/animate-css/animate.css')}}" rel="stylesheet" type="text/css">
...
@section('header')
    ...
    <link href="{{asset('app-assets/css/pages/dashboard-modern.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('app-assets/css/pages/dashboard-modern-rtl.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('app-assets/css/pages/intro.css')}}" rel="stylesheet" type="text/css">
                ...
                <div class="container">
                            ...
                            <div class="card animate fadeLeft">
                                <div class="card-content">
                                    <h4 class="card-title mb-0">Current Balance <i
                                                class="material-icons icon-float-direction">more_vert</i></h4>
                                    <p class="medium-small">This billing cycle</p>
                                    <div class="current-balance-container">
                                        <div class="current-balance-shadow" id="current-balance-donut-chart"></div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="total-transaction-container">
                                        <div class="total-transaction-shadow"
                                             id="total-transaction-line-chart"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card user-statistics-card animate fadeLeft">
                                <div class="card-content">
                                    ...
                                    <div class="user-statistics-container">
                                        <div class="user-statistics-shadow" id="user-statistics-bar-chart"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 l4">
                            ...
                            <div class="card recent-buyers-card animate fadeUp">
                                <div class="card-content">
                                    <h4 class="card-title mb-0">Recent Buyers <i class="material-icons icon-float-direction">more_vert</i>
                                    </h4>
                                    ...
                                    <ul class="collection mb-0">
                                        <li class="collection-item avatar">
                                            ...
                                            <a class="secondary-content" href="dashboard-modern.html#!"><i
                            ...
                            <div class="card animate fadeRight">
                                <div class="card-content">
                                    ...
                                    <div class="conversion-ration-container mt-8">
                                        <div class="conversion-ration-shadow"
                                             id="conversion-ration-bar-chart"></div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            ...
                            <div class="card pt-0 pb-0 animate fadeLeft" id="chartjs">
                                ...
                                <table class="subscription-table responsive-table highlight">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$ 1000.00</td>
                                            <td class="center-align"><a href="dashboard-modern.html#"><i
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="dashboard-modern.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="dashboard-modern.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="dashboard-modern.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="dashboard-modern.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="dashboard-modern.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
                    ...
                    <div id="intro">
                        <div class="row">
                            <div class="col s12">
                                ...
                                <div class="modal white" id="img-modal">
                                    <div class="modal-content">
                                        ...
                                        <div class="carousel carousel-slider center intro-carousel">
                                            ...
                                            <div class="carousel-item slide-1">
                                                <img alt=""
                                                     class="responsive-img animated fadeInUp slide-1-img" src="{{asset('app-assets/images/gallery/intro-slide-1.png')}}">
                                            ...
                                            <div class="carousel-item slide-2">
                                                <img alt=""
                                                     class="responsive-img slide-2-img" src="{{asset('app-assets/images/gallery/intro-features.png')}}">
                                                <h5 class="intro-step-title mt-7 center">Example Request
                                                    Information</h5>
                                                <p class="intro-step-text mt-5">Lorem ipsum dolor sit amet
                                                    consectetur,
                                                    adipisicing elit.
                                                ...
                                                <div class="row">
                                                    <div class="col s6">
                                                        <div class="input-field">
                                                            ...
                                                            <input class="validate" id="first_name" placeholder="Name"
                                                                   type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col s6">
                                                        <div class="input-field">
                                                            <select>
                                                                <option disabled selected value="">Choose your
                                                                    option
                                                                </option>
                                            ...
                                            <div class="carousel-item slide-3">
                                                <img alt="" class="responsive-img slide-1-img"
                                                     src="{{asset('app-assets/images/gallery/intro-app.png')}}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 center">
                                                            <button class="get-started btn waves-effect waves-light gradient-45deg-purple-deep-orange mt-3 modal-close">
                                                                Get
                                                                Started
                                                            </button>
                                                        </div>

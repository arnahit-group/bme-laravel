                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Breadcrumbs</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="ui-breadcrumbs.html#">Basic UI</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="ui-breadcrumbs.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0">Breadcrumbs are a good way to display your current location.
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-default" id="left-aligned">
                                    <div class="card-content">
                                        <div class="row">
                                            <div class="col s12">
                                            ...
                                            <div class="col s12">
                                                <nav>
                                                    <div class="nav-wrapper">
                                                        <div class="col s12">
                                                            <a class="breadcrumb"
                                                               href="ui-breadcrumbs.html#!">First</a>
                                                            <a class="breadcrumb" href="ui-breadcrumbs.html#!">Second</a>
                                                            <a class="breadcrumb"
                                                               href="ui-breadcrumbs.html#!">Third</a>
                                                        </div>
                                                    </div>
                                                </nav>
                                            </div>
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-breadcrumbs.html#view-right-aligned">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-breadcrumbs.html#html-right-aligned">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <nav>
                                                        <div class="nav-wrapper">
                                                            <div class="col s12 right-align">
                                                                <a class="breadcrumb" href="ui-breadcrumbs.html#!">First</a>
                                                                <a class="breadcrumb" href="ui-breadcrumbs.html#!">Second</a>
                                                                <a class="breadcrumb" href="ui-breadcrumbs.html#!">Third</a>
                                                            </div>
                                                        </div>
                                                    </nav>
                                                </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="ui-breadcrumbs.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="ui-breadcrumbs.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-breadcrumbs.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-breadcrumbs.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="ui-breadcrumbs.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Alerts</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="ui-alerts.html#">Basic UI</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="ui-alerts.html#!"><i
                    ...
                    <div class="seaction">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption"><a href="ui-alerts.html" target="_blank">Alerts</a> are simple
                                    materialize cars that provide
                                    contextual feedback messages for typical user actions with the handful of
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card-default" id="ui-alert">
                                    <div class="card-content">
                                        <div class="row">
                                            <!--SIMPLE-->
                                            <div class="col s12 m4 l4">
                                                ...
                                                <div class="card-alert card cyan lighten-5">
                                                    ...
                                                    <button aria-label="Close" class="close cyan-text"
                                                ...
                                                <div class="card-alert card green lighten-5">
                                                    ...
                                                    <button aria-label="Close" class="close green-text"
                                                            data-dismiss="alert" type="button">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                                <div class="card-alert card red lighten-5">
                                                    ...
                                                    <button aria-label="Close" class="close red-text"
                                                            data-dismiss="alert" type="button">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                                <div class="card-alert card orange lighten-5">
                                                    ...
                                                    <button aria-label="Close" class="close orange-text"
                                                            data-dismiss="alert" type="button">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="col s12 m4 l4">
                                                ...
                                                <div class="card-alert card cyan">
                                                    ...
                                                    <button aria-label="Close" class="close white-text"
                                                            data-dismiss="alert" type="button">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="col s12 m4 l4">
                                                ...
                                                <div class="card-alert card gradient-45deg-purple-deep-orange">
                                                    <div class="card-content white-text">
                                                        <p>
                                                            <i class="material-icons">notifications</i> NEWS : You
                                                            have done 5 actions.</p>
                                                    </div>
                                                </div>
                                                <div class="card-alert card gradient-45deg-light-blue-cyan">
                                                    <div class="card-content white-text">
                                                        <p>
                                                            <i class="material-icons">info_outline</i> INFO : You
                                                            have 18 messages</p>
                                                    </div>
                                                    <button aria-label="Close" class="close white-text"
                                                            data-dismiss="alert" type="button">
                                                ...
                                                <div class="card-alert card gradient-45deg-green-teal">
                                                    <div class="card-content white-text">
                                                        <p>
                                                            <i class="material-icons">check</i> SUCCESS : The page
                                                            has been added.</p>
                                                    </div>
                                                    <button aria-label="Close" class="close white-text"
                                                            data-dismiss="alert" type="button">
                                                ...
                                                <div class="card-alert card gradient-45deg-red-pink">
                                                    <div class="card-content white-text">
                                                        <p>
                                                            <i class="material-icons">error</i> DANGER : The daily
                                                            report has failed</p>
                                                    </div>
                                                    <button aria-label="Close" class="close white-text"
                                                            data-dismiss="alert" type="button">
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card-default" id="ui-alert-title">
                                    <div class="card-content">
                                        <div class="row">
                                            <!--DARK-->
                                            <div class="col s12 m4 l4">
                                                ...
                                                <div class="card-alert card cyan lighten-5">
                                                    <div class="card-content cyan-text darken-1">
                                                        ...
                                                        <p>Lorem ipsum Minim ad pariatur eiusmod ea ut nulla aliqua
                                                            est quis id dolore minim voluptate.</p>
                                                    </div>
                                                    <button aria-label="Close" class="close cyan-text"
                                                            data-dismiss="alert" type="button">
                                                        <span aria-hidden="true">×</span>
                                            ...
                                            <div class="col s12 m4 l4">
                                                ...
                                                <div class="card-alert card pink lighten-5">
                                                    ...
                                                    <div class="card-action pink lighten-4">
                                                        <a class="pink-text" href="ui-alerts.html#">Ok</a>
                                                        <a class="pink-text" href="ui-alerts.html#">Cancel</a>
                                                    </div>
                                                    <button aria-label="Close" class="close pink-text"
                                                            data-dismiss="alert" type="button">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="col s12 m4 l4">
                                                ...
                                                <div class="card-alert card cyan">
                                                    ...
                                                    <div class="card-action cyan darken-1">
                                                        <a class="white-text" href="ui-alerts.html#">Ok</a>
                                                        <a class="white-text" href="ui-alerts.html#">Cancel</a>
                                                    </div>
                                                    <button aria-label="Close" class="close white-text"
                                                            data-dismiss="alert" type="button">
                                                        <span aria-hidden="true">×</span>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="ui-alerts.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="ui-alerts.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-alerts.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-alerts.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="ui-alerts.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

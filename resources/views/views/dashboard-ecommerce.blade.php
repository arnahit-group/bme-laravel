                    ...
                    <div id="sales-chart">
                        <div class="row">
                            <div class="col s12 m8 l8">
                                <div class="card animate fadeUp" id="revenue-chart">
                     ...
                     <i class="material-icons">keyboard_arrow_up</i> 15.58 %</span>
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <div class="yearly-revenue-chart">
                                                    <canvas class="firstShadow" height="350"
                                                            id="thisYearRevenue"></canvas>
                                                    <canvas height="350" id="lastYearRevenue"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col s12 m4 l4">
                                <div class="card animate fadeUp" id="weekly-earning">
                                    <div class="card-content">
                                        ...
                                        <canvas class="" height="150" id="monthlyEarning"></canvas>
                            ...
                            <div class="col s12 m4">
                                <div class="card animate fadeUp">
                                    <div class="card-content">
                                        ...
                                        <img alt="" class="responsive-img"
                                             src="{{asset('app-assets/images/cards/headphones-2.png')}}"/>
                                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card gradient-shadow gradient-45deg-light-blue-cyan border-radius-3 animate fadeUp">
                                        <div class="card-content center">
                                            <img alt=""
                                                 ...
                                                 class="responsive-img" src="{{asset('app-assets/images/icon/apple-watch.png')}}"/>
                                ...
                                <div class="col s12 m3">
                                    <div class="card gradient-shadow gradient-45deg-red-pink border-radius-3 animate fadeUp">
                                        <div class="card-content center">
                                            <img alt=""
                                                 class="width-40 border-round z-depth-5" class="responsive-img"
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="dashboard-ecommerce.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="dashboard-ecommerce.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="dashboard-ecommerce.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="dashboard-ecommerce.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="dashboard-ecommerce.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

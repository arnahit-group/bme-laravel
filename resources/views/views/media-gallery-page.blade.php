                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Media Gallery Page</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="media-gallery-page.html#">Pages</a>
                                </li>
                                <li class="breadcrumb-item active">Media Gallery Page
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="media-gallery-page.html#!"><i
                        ...
                        <div class="section">
                            <div class="card">
                                <div class="card-content">
                                    <p class="caption">Masonry with Magnific Popup is a responsive lightbox & dialog
                                        script with focus on
                                ...
                                <div class="popup-gallery">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/1.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                        ...
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/2.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                        ...
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/3.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                        ...
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/4.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                        ...
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/5.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                        ...
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/6.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/6.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/7.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/7.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/8.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/8.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/9.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/9.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/10.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/10.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/11.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/11.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/12.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/12.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/13.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/13.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/14.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/14.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/15.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/15.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/16.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/16.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/17.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/17.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/18.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/18.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/19.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                        ...
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/20.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/20.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/21.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                        ...
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/22.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/22.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/23.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/23.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col s12 m6 l4 xl2">
                                            <div>
                                                <a href="{{asset('app-assets/images/gallery/24.png')}}"
                                                   title="The Cleaner">
                                                    <img alt=""
                                                         class="responsive-img mb-10"
                                                         src="{{asset('app-assets/images/gallery/24.png')}}">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="media-gallery-page.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="media-gallery-page.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="media-gallery-page.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="media-gallery-page.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="media-gallery-page.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/media-gallery-page.js')}}" type="text/javascript"></script>

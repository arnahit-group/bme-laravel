                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="table-basic.html#">CSS</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="table-basic.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0">Tables are a nice way to organize a lot of data. We provide
                                    a few utility classes to help
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="borderless-table">
                                    <div class="card-content">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="table-basic.html#view-borderless-table">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="table-basic.html#html-borderless-table">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
  ...
  &lt;/table>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="bordered-table">
                                    <div class="card-content">
                                        <h4 class="card-title">Bordered Table</h4>
                                        <p class="mb-2">Add <code class=" language-markup">class="bordered"</code>
                                            to the table tag for a
                                            bordered table</p>
                                        <div class="row">
                                            <div class="col s12">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="striped-table">
                                    <div class="card-content">
                                        <h4 class="card-title">Striped Table</h4>
                                        <p class="mb-2">Add <code class=" language-markup">class="striped"</code> to
                                            the table tag for a striped
                                            table</p>
                                        <div class="row">
                                            <div class="col s12">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="highlight-table">
                                    <div class="card-content">
                                        <h4 class="card-title">Highlight Table</h4>
                                        <p class="mb-2">Add <code class=" language-markup">class="Highlight"</code>
                                            to the table tag for a highlight
                                            table</p>
                                        <div class="row">
                                            <div class="col s12">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="centered-table">
                                    <div class="card-content">
                                        <h4 class="card-title">Centered Table</h4>
                                        <p class="mb-2">Add <code class=" language-markup">class="centered"</code>
                                            to the table tag to center align
                                            all the
                                            text in the table</p>
                                        <div class="row">
                                            <div class="col s12">
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="responsive-table">
                                    <div class="card-content">
                                        <h4 class="card-title">Responsive Table</h4>
                                        <p class="mb-2">Add <code
                                                    class=" language-markup">class="responsive-table"</code> to the
                                            table tag to make
                                            the table
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="table-basic.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="table-basic.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="table-basic.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="table-basic.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="table-basic.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

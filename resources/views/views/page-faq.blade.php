                                ...
                                <div class="card mt-2">
                                    <div class="card-content">
                                        ...
                                        <div class="category-list">
                                            <p class="mt-4"><i class="material-icons vertical-text-sub amber-text">
                                                    panorama_fish_eye </i> Applications</p>
                                            <p class="mt-4"><i class="material-icons vertical-text-sub teal-text">
                                                    panorama_fish_eye </i> UI Elements</p>
                                            <p class="mt-4"><i class="material-icons vertical-text-sub purple-text">
                                                    panorama_fish_eye </i> Components</p>
                                            <p class="mt-4"><i class="material-icons vertical-text-sub cyan-text">
                                                    panorama_fish_eye </i> Build process</p>
                                        </div>
                                        <span class="card-title mt-10">Supporters</span>
                                        <div class="row">
                                            <div class="col s3 m4 l3 xl3 pr-0">
                                                <img alt="avatar"
                                                     class="responsive-img"
                                                     src="{{asset('app-assets/images/avatar/avatar-1.png')}}">
                                            </div>
                                            <div class="col s9 m8 l9 xl9 pl-0">
                                                <a href="page-faq.html#">Mike</a>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col s9 m8 l9 xl9 pl-0">
                                                <a href="page-faq.html#">Howard Morgan</a>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col s9 m8 l9 xl9 pl-0">
                                                <a href="page-faq.html#">Kenneth Pierce</a>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col s9 m8 l9 xl9 pl-0">
                                                <a href="page-faq.html#">Steven Owens</a>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="page-faq.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="page-faq.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-faq.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-faq.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="page-faq.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

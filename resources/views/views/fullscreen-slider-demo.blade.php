        ...
        <div class="col s12">
            <div class="container">
                <div class="slider fullscreen">
                    <ul class="slides">
                        <li>
                            <img class="responsive-img" src="{{asset('app-assets/images/gallery/46.jpg')}}">
                            <!-- random image -->
                        ...
                        <li>
                            <img class="responsive-img" src="{{asset('app-assets/images/gallery/47.jpg')}}">
                            <!-- random image -->
                        ...
                        <li>
                            <img class="responsive-img" src="{{asset('app-assets/images/gallery/48.jpg')}}">
                            <!-- random image -->
                ...
                <aside id="right-sidebar-nav">
                                    ...
                                    <div class="row">
                                        <div class="col s2 pr-0 center">
                                            <i class="material-icons vertical-text-middle"><a
                                                        class="sidenav-close"
                                                        href="fullscreen-slider-demo.html#">clear</a></i>
                                        </div>
                                        <div class="col s10 pl-0">
                                            <ul class="tabs">
                                                <li class="tab col s4 p-0">
                                                    <a class="active" href="fullscreen-slider-demo.html#messages">
                                                        <span>Messages</span>
                                                    </a>
                                                </li>
                                                <li class="tab col s4 p-0">
                                                    <a href="fullscreen-slider-demo.html#settings">
                                                        <span>Settings</span>
                                                    </a>
                                                </li>
                                                <li class="tab col s4 p-0">
                                                    <a href="fullscreen-slider-demo.html#activity">
                                                        <span>Activity</span>
                                                    </a>
                                                </li>
                                            </ul>
                    ...
                    <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                        <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                            <a href="fullscreen-slider-demo.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                Elliott</a>
                        </li>
                        <li class="chat-body">
                            <ul class="collection">
...
@section('footer')
    ...
    <script src="{{asset('app-assets/js/scripts/fullscreen-slider.js')}}" type="text/javascript"></script>

...
@section('main')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Typography</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="css-typography.html#">CSS</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="css-typography.html#!"><i
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default" id="change-font">
                                    <div class="card-content">
                                        <h4 class="card-title">Want to Change Font ?</h4>
                                        <p>In case you don't want to use Roboto on your webpage, fear not. Simply
                                            change the font stack by
                                            modifying the code below to your liking and add it to your custom
                                            css.</p>
                                        <p>Inside sass/themes/default/_typography.scss you can change the font as
                                            per your requirements. As
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-typography.html#view-headers">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-typography.html#html-headers">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
    ...
    &lt;h6> Heading h6 &lt;/h6>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default" id="flow-text">
                                    <div class="card-content">
                                        <h4 class="card-title">Flow Text</h4>
                                        <div class="row">
                                            <div class="col s12">
                                                <p>To use flow-text on a body of text, simply just add the class
                                                    <code class="language-markup">flow-text</code>
                                                    to a tag</p>
                                                <a class="btn waves-effect waves-light mt-2" id="flow-toggle">Toggle
                                                    flow-text</a>
                                            </div>
                                            <div class="col s12 mt-2">
                                                <div id="flow-text-demo">
                                                    <p class="flow-text">To see Flow Text in action, slowly resize
                                                        your browser and watch
                                                        the size of this text body change! Use the button above to
                                                        toggle off/on flow-text
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="blockquotes">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-typography.html#view-blockquotes">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-typography.html#html-blockquotes">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-blockquotes">
                                            <div class="row">
                                                <div class="col s12">
                                                    <p>Blockquotes are mainly used to give emphasis to a quote or
                                                        citation. You can also
                                                        use these for some extra text hierarchy and emphasis.</p>
                                                </div>
                                                <div class="col s12">
                                                    <blockquote>The people who are crazy enough to think they can
                                                        change the world
    ...
    &lt;/blockquote>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default" id="paragraph">
                                    <div class="card-content">
                                        ...
                                        <p>This is a paragraph. Paragraphs are preset with a font size, line height
                                            ...
                                            the overall vertical rhythm. To show what a paragraph looks like this
                                            needs a little more
                                            content so, did you know that there are storms occurring on Jupiter that
                                            are larger than the
                                            Earth? Pretty cool. Wrap strong around type to make it bold!. You can
                                            also use em to<em>italicize</em>
                                            your words.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="css-typography.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="css-typography.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-typography.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-typography.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="css-typography.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/css-typography.js')}}" type="text/javascript"></script>

...
@section('header')
    ...
    <link href="{{asset('app-assets/css/pages/page-faq.css')}}" rel="stylesheet" type="text/css">
            ...
            <div class="col s12">
                <div class="container">
                    <div class="section" id="faq-detail">
                        <div class="row">
                            <div class="col s12">
                                <div class="card z-depth-0 faq-search-image center-align p-35" id="faq-search">
                                    <div class="card-content">
                                        <h5>Frequently asked questions.</h5>
                                        <p class="mb-3">Search our help center for quick answers</p>
                                        <input class="search-box validate white search-circle search-shadow" id="search" placeholder="Srart typing your search..."
                                               type="text">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <ul class="collapsible categories-collapsible">
                                    <li class="active">
                                        <div class="collapsible-header">Q: Do memberships include the original PSD
                                            files? <i class="material-icons"> keyboard_arrow_right </i></div>
                                    ...
                                    <li>
                                        <div class="collapsible-header">Q: How can I purchase a single theme? <i
                                    ...
                                    <li>
                                        <div class="collapsible-header">Q: How to I modify the Footer copyright <i
                                                    class="material-icons"> keyboard_arrow_right </i></div>
                                        <div class="collapsible-body">
                                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure
                                                there isn't anything embarrassing hidden in the middle of text. All
                                    ...
                                    <li>
                                        <div class="collapsible-header">Q: How do I create a child theme? <i
                                                    class="material-icons"> keyboard_arrow_right </i></div>
                                        <div class="collapsible-body">
                                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure
                                                there isn't anything embarrassing hidden in the middle of text. All
                                    ...
                                    <li>
                                        <div class="collapsible-header">Q: Where do i post support query? <i
                                                    class="material-icons"> keyboard_arrow_right </i></div>
                                        <div class="collapsible-body">
                                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure
                                                there isn't anything embarrassing hidden in the middle of text. All
                                    ...
                                    <li>
                                        <div class="collapsible-header">Q: New to the WordPress? Lets get started?
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="page-faq-detail.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="page-faq-detail.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-faq-detail.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-faq-detail.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="page-faq-detail.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

...
@section('main')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Collections</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="ui-collections.html#">Basic UI</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="ui-collections.html#!"><i
            ...
            <div class="col s12">
                <div class="container">
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="basic">
                                    <div class="card-content">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-collections.html#view-basic">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-collections.html#html-basic">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
  ...
  &lt;/ul>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="links">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-collections.html#view-links">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-collections.html#html-links">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col s12">
                                                    <div class="collection">
                                                        <a class="collection-item"
                                                           href="ui-collections.html#!">Alvin</a>
  ...
  &lt;/div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="headers">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-collections.html#view-headers">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-collections.html#html-headers">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
  ...
  &lt;/ul>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="secondary-content">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-collections.html#view-content">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-collections.html#html-content">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
  ...
  &lt;/ul>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="avatar-content">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-collections.html#view-avatar">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-collections.html#html-avatar">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
  ...
  &lt;/ul>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="dismissable">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-collections.html#view-dismissable">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-collections.html#html-dismissable">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-dismissable">
                                            <div class="row">
                                                <div class="col s12">
                                                    <p>You can just add the class <code class="language-markup">dismissable</code>
                                                        to enable each
                                                        collection item to be swiped away. This is only for touch
                                                        enabled devices.</p>
                                                </div>
                                                <div class="col s12">
                                                    <ul class="collection">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="ui-collections.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="ui-collections.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-collections.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-collections.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="ui-collections.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

...
@section('vendor-css')
    ...
    <link href="{{asset('app-assets/vendors/dropify/css/dropify.min.css')}}" rel="stylesheet" type="text/css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Form File Uploads</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="form-file-uploads.html#">Form</a>
                                </li>
                                <li class="breadcrumb-item active">Form File Uploads
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="form-file-uploads.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption"><a href="../../../../github.com/JeremyFagis/dropify.htm"
                                                      target="_blank">Dropify</a> Override your
                        ...
                        <div class="section" id="file-upload">
                            ...
                            <div class="row section">
                                ...
                                <div class="col s12 m8 l9">
                                    <input class="dropify" data-default-file="" id="input-file-now" type="file"/>
                                </div>
                            </div>
                            <!--Default value-->
                            <div class="divider"></div>
                            <div class="row section">
                                ...
                                <div class="col s12 m8 l9">
                                    <input class="dropify" data-default-file="{{asset('app-assets/images/gallery/1.png')}}" disabled="disabled"
                            ...
                            <div class="row section">
                                ...
                                <div class="col s12 m8 l9">
                                    <input class="dropify" data-height="500" id="input-file-now-custom-2"
                                           type="file"/>
                                </div>
                            </div>
                            ...
                            <div class="row section">
                                ...
                                <div class="col s12 m8 l9">
                                    <input class="dropify" disabled="disabled" id="input-file-now-disabled-1"
                                           type="file"/>
                                </div>
                            </div>
                            <!--Max file size-->
                            ...
                            <div class="row section">
                                ...
                                <div class="col s12 m8 l9">
                                    ...
                                    <input class="dropify" data-max-file-size="2M" id="input-file-max-fs"
                                           type="file"/>
                                </div>
                            </div>
                            <!--remove button-->
                            ...
                            <div class="row section">
                                ...
                                <div class="col s12 m8 l9">
                                    <input class="dropify" data-disable-remove="true" id="input-file-disable-remove"
                                           type="file"/>
                                </div>
                            </div>
                            <!--use events-->
                            ...
                            <div class="row section">
                                ...
                                <div class="col s12 m8 l9">
                                    <input class="dropify-event" data-default-file="{{asset('app-assets/images/gallery/1.png')}}" id="input-file-events"
                                           type="file"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="form-file-uploads.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="form-file-uploads.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-file-uploads.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-file-uploads.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="form-file-uploads.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

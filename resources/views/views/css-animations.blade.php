                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Animations</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="css-animations.html#">CSS</a>
                                </li>
                                <li class="breadcrumb-item active">Animations
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="css-animations.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <p><a href="../../../../daneden.github.io/animate.css/animate.css.html"
                                      target="_blank">Animate.css</a> Just-add-water CSS
                                    animations.</p>
                            </div>
                        </div>
                        <!--animations-->
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-animations.html#view-animations">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-animations.html#html-animations">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col s12">
                                                <div class="row">
                                                    ...
                                                    <div class="col s12 m6 l6 center-align mt-3 mb-3">
                                                        <div class="animation-example animation-hover"
                                                             ...
                                                             id="animationSandbox">
                                                            <button class="btn waves-effect waves-light red accent-3"
                                                                    type="button">
                                                                Look At ME!
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m12 l12 pb-2">
                                                        <p>Use a classes <code>.animation-{name}</code> to quickly
                                                            add a animation.</p>
                                                        <p>Add the class <code>animated</code> to the element you
                                                            want to animate. You may also want to
                                                            include the class <code>infinite</code> for an infinite
                                                            loop.</p>
                                                        <p>Example:</p>
                                                        <button class="btn waves-effect waves-light light-blue accent-3 animated infinite rubberBand mt-2 mb-2"
                                                                type="button">
                                                            Infinite
                                                            rubberBand
                                                        </button>
                                                        <p>You can do a whole bunch of other stuff with animate.css
                                                            when you combine it with jQuery or add
                                                            your own CSS rules. Dynamically add animations using
                                                            jQuery with ease:</p>
                                                        <p><a href="https://www.youtube.com/watch?v=CBQGl6zokMs">View
                                                                a video tutorial</a> on how to use
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="css-animations.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="css-animations.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-animations.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-animations.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="css-animations.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

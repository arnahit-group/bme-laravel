...
@section('main')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Helpers</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="css-helpers.html#">CSS</a>
                                </li>
                                <li class="breadcrumb-item active">Helpers
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="css-helpers.html#!"><i
            ...
            <div class="col s12">
                <div class="container">
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="vertical-align">
                                    <div class="card-content">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-helpers.html#view-vertical-align">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-helpers.html#html-vertical-align">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
    ...
    &lt;/div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="text-align">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-helpers.html#view-text-align">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-helpers.html#html-text-align">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-text-align">
                                            <p>These classes are for horizontally aligning content: <code
                                                        class="language-markup">.left-align</code>,
                                                <code class="language-markup">.center-align</code> and <code
                                                        class="language-markup">.right-align</code>.</p>
            ...
            <pre><code class="language-markup">
              ...
              &lt;h6 class=&quot;center-align&quot;&gt;This should be center aligned&lt;/h6&gt;
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="quick-floats">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-helpers.html#view-quick-floats">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-helpers.html#html-quick-floats">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-quick-floats">
                                            <p>Quickly float things by adding the class <code
                                                        class="language-markup">left</code> or <code
                                                        class="language-markup">right</code>
                                                to the element. <code class="language-markup">!important</code> is
                                                used to avoid specificity issues.</p>
  ...
  &lt;h6 class="right">Right Floating Text&lt;/h6>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="hiding-showing">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-helpers.html#view-hiding-showing">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-helpers.html#html-hiding-showing">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-hiding-showing">
                                            <p>We provide easy to use classes to hide/show content on specific
                                                screen sizes. </p>
                                            <table class="striped">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code
                                                                    class="language-markup"><strong>.hide</strong></code>
                                                        </td>
                                                        <td>Hidden for all Devices</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code class="language-markup"><strong>.hide-on-small-only</strong></code>
                                                        </td>
                                                        <td>Hidden for Mobile Only</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code
                                                                    class="language-markup"><strong>.hide-on-med-only</strong></code>
                                                        </td>
                                                        <td>Hidden for Tablet Only</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code class="language-markup"><strong>.hide-on-med-and-down</strong></code>
                                                        </td>
                                                        <td>Hidden for Tablet and Below</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code class="language-markup"><strong>.hide-on-med-and-up</strong></code>
                                                        </td>
                                                        <td>Hidden for Tablet and Above</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code class="language-markup"><strong>.hide-on-large-only</strong></code>
                                                        </td>
                                                        <td>Hidden for Desktop Only</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code
                                                                    class="language-markup"><strong>.show-on-small</strong></code>
                                                        </td>
                                                        <td>Show for Mobile Only</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code
                                                                    class="language-markup"><strong>.show-on-medium</strong></code>
                                                        </td>
                                                        <td>Show for Tablet Only</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code
                                                                    class="language-markup"><strong>.show-on-large</strong></code>
                                                        </td>
                                                        <td>Show for Desktop Only</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code class="language-markup"><strong>.show-on-medium-and-up</strong></code>
                                                        </td>
                                                        <td>Show for Tablet and Above</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code class="language-markup"><strong>.show-on-medium-and-down</strong></code>
                                                        </td>
  ...
  &lt;div class="hide-on-small-only">&lt;/div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="formatting">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-helpers.html#view-formatting">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-helpers.html#html-formatting">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-formatting">
                                            ...
                                            <p>To truncate long lines of text in an ellipsis, add the class <code
                                                ...
                                                to the tag which contains the text. See an example below of a header
                                                being truncated inside a card.</p>
                                            <div class="row">
                                                <div class="col s6 offset-s3 m6 offset-m3">
                                                    <div class="card-panel">
                                                        <h4 class="truncate">This is an extremely long title that
                                                            will be truncated</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
  ...
  &lt;h4 class="truncate">This is an extremely long title that will be truncated&lt;/h4>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="hover">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="css-helpers.html#view-hover">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="css-helpers.html#html-hover">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-hover">
                                            <p>The <code class="language-markup">hoverable</code> is a hover class
                                                that adds an animation for box
                                                shadow as seen below. It can be used on most elements, but meant for
                                                use on cards.</p>
                                            <div class="card hoverable small">
                                                <div class="card-image">
                                                    <img alt="" src="{{asset('app-assets/images/gallery/33.png')}}">
                                                    <span class="card-title">Card Title</span>
                                                </div>
                                                <div class="card-content">
                                                    <p>I am a very simple card. I am good at containing small bits
                                                        of information. I am convenient because
                                                        I require little markup to use effectively.</p>
                                                </div>
                                                <div class="card-action">
                                                    <a href="css-helpers.html#">This is a link</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="html-hover">
  ...
  &lt;div class="card-panel hoverable"> Hoverable Card Panel&lt;/div>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="browser-default">
                                    <div class="card-content">
                                        <h4 class="card-title">Browser Defaults</h4>
                                        <p>Because we override many of the default browser styles and elements, we
                                            provide the <code class="language-markup">.browser-default</code>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="css-helpers.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="css-helpers.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-helpers.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-helpers.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="css-helpers.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

...
@section('vendor-css')
    <link href="{{asset('app-assets/vendors/chartist-js/chartist.css')}}" rel="stylesheet" type="text/css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Charts Chartist</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="charts-chartist.html#">Charts</a>
                                </li>
                                <li class="breadcrumb-item active">Charts Chartist
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="charts-chartist.html#!"><i
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <div class="seaction" id="materialize-chartist">
                        ...
                        <!--Simple Line Chart-->
                        <div class="ct-chart card" id="ct1-chart">
                            <div class="card-content">
                                <h4 class="card-title">Simple Line Chart</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> An example of a simple line chart with three
                                    series. You can edit this example in realtime.
                                </p>
                            </div>
                        </div>

                        <!--Holes In Data-->
                        <div class="ct-chart card" id="ct2-chart">
                            <div class="card-content">
                                <h4 class="card-title">Holes In Data</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> Chartist does not freak out if you have holes
                                    in your data. Instead it will render the lines in segments and handles these
                                    holes gracefully. This also allows you to introduce a line at a later point or
                                    to terminate the series before others.
                                </p>
                            </div>
                        </div>

                        <!--Line Scatter Diagram With Responsive Settings-->
                        <div class="ct-chart card" id="ct3-chart">
                            <div class="card-content">
                                <h4 class="card-title">Line Scatter Diagram With Responsive Settings</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> This advanced example uses a line chart to
                                    draw a scatter diagram. The data object is created with a functional style
                                    random mechanism. There is a mobile first responsive configuration using the
                                    responsive options to show less labels on small screens.
                                </p>
                            </div>
                        </div>

                        <!--Line Chart With Area-->
                        <div class="ct-chart card" id="ct4-chart">
                            <div class="card-content">
                                <h4 class="card-title">Line Chart With Area</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> This chart uses the showArea option to draw
                                    line, dots but also an area shape. Use the low option to specify a fixed lower
                                    bound that will make the area expand. You can also use the areaBase property to
                                    specify a data value that will be used to determine the area shape base position
                        ...
                        <div class="ct-chart card" id="ct5-chart">
                            <div class="card-content">
                                <h4 class="card-title">Bi-polar Line Chart With Area Only</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> You can also only draw the area shapes of the
                                    line chart. Area shapes will always be constructed around their areaBase (that
                                    can be configured in the options) which also allows you to draw nice bi-polar
                                    areas.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="ct-chart card" id="ct6-chart">
                            <div class="card-content">
                                <h4 class="card-title">Using Events To Replace Graphics</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> Chartist has fixed graphical representations
                                    that are chosen because of their flexibility and to provide a high level of
                                    separation of the concerns. However, sometimes you probably would like to use
                                    different shapes or even images for your charts. One way to achieve this is by
                                    using the draw events and replace or add custom SVG shapes.
                                </p>
                            </div>
                        </div>

                        <!--Bi-Polar Bar Chart-->
                        <div class="ct-chart card" id="ct7-chart">
                            <div class="card-content">
                                <h4 class="card-title">Bi-Polar Bar Chart</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> A bi-polar bar chart with a range limit set
                                    with low and high. There is also an interpolation function used to skip every
                                    odd grid line / label.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="ct-chart card" id="ct8-chart">
                            <div class="card-content">
                                <h4 class="card-title">Overlapping Bars On Mobile</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> This example makes use of label interpolation
                                    and the seriesBarDistance property that allows you to make bars overlap over
                                    each other. This then can be used to use the available space on mobile better.
                        ...
                        <!--Simple Pie Chart-->
                        <div class="ct-chart card" id="ct9-chart">
                            <div class="card-content">
                                <h4 class="card-title">Simple Pie Chart</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> A very simple pie chart with label
                                    interpolation to show percentage instead of the actual data series value.
                                </p>
                            </div>
                        </div>

                        <!--Animating A Donut With Svg.animate-->
                        <div class="ct-chart card" id="ct10-chart">
                            <div class="card-content">
                                <h4 class="card-title">Animating A Donut With Svg.animate</h4>
                                <p class="caption">
                                    <a href="../../../../gionkunz.github.io/chartist-js/getting-started.html"
                                       target="_blank">Chartist-js</a> Although it'd be also possible to achieve
                                    this animation with CSS, with some minor suboptimal things, here's an example of
                                    how to animate donut charts using Chartist.Svg.animate and SMIL.
                                </p>
                            </div>
                        </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="charts-chartist.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="charts-chartist.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="charts-chartist.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="charts-chartist.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="charts-chartist.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/charts-chartist.js')}}" type="text/javascript"></script>

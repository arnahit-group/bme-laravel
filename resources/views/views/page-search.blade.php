...
@section('header')
    ...
    <link href="{{asset('app-assets/css/pages/page-search.css')}}" rel="stylesheet" type="text/css">
...
@section('main')
    ...
    <div id="main">
        <div class="row">
            ...
            <div class="col s12">
                <div class="container">
                    <div class="section" id="search-page">
                        <div class="row">
                            <div class="col s12">
                                <div class="search card z-depth-0 pb-5 center-align" id="search">
                                    <div class="card-content">
                                        <div class="input-field col s12">
                                            <h5 class="mb-2">Website search results</h5>
                                            <input class="search-box validate white search-circle" id="first_name" placeholder="Search"
                                                   type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col m8 s12">
                                        <ul class="tabs tabs-style">
                                            <li class="tab tab-style col s4"><a class="active"
                                                                                href="page-search.html#test1">
                                                    Website</a></li>
                                            <li class="tab tab-style col s4"><a href="page-search.html#test2">
                                                    Images</a></li>
                                            <li class="tab tab-style col s4"><a href="page-search.html#test3">
                                                    Video</a></li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div class="row">
                                                    <div class="col l8 m12">
                                                        <div class="result">
                                                            <h6><a href="page-search.html#">Materialize - Material
                                                                    Design Admin Template by PIXINVENT</a></h6>
                                                            ...
                                                            <p>Mar 15, 2018 - Buy Materialize - Material Design
                                                                Admin Template by PIXINVENT on ThemeForest.
                                                                Materialize is a Material Design Admin Template</p>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col l6 m12">
                                                                <p>Layout‎: ‎<span class="teal-text lighten-2">Responsive</span>
                                                                </p>
                                                                <p>ThemeForest Files Included‎: ‎<span
                                                                            class="teal-text lighten-2">HTML Files‎, ‎CSS</span>
                                                                </p>
                                                                <p>Author:PIXINVENT</p>
                                                            </div>
                                                            <div class="col l6 m12">
                                                                <p>Created‎: ‎<span class="teal-text lighten-2">20 May 15</span>
                                                                </p>
                                                                <p>Documentation‎: <span
                                                                            class="teal-text lighten-2">‎Well Documented</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="col s12">
                                                                        <div class="card z-depth-0 grey lighten-4 border-radius-6">
                                                                            <div class="card-image">
                                                                                <img alt=""
                                                                                     class="responsive-img" src="{{asset('app-assets/images/gallery/18.png')}}">
                                                                            </div>
                                                                            <div class="card-content">
                                                                                Materialize is a Material Design
                                                                                Admin Template.
                                                                ...
                                                                <div class="row">
                                                                    <div class="col s12">
                                                                        <div class="card z-depth-0 grey lighten-4 border-radius-6">
                                                                            <div class="card-image">
                                                                                <img alt=""
                                                                                     class="responsive-img" src="{{asset('app-assets/images/gallery/19.png')}}">
                                                                            </div>
                                                                            <div class="card-content">
                                                                                Materialize admin is super flexible,
                                                                                powerful, clean.
                                                                                <p class="teal-text lighten-2 truncate">
                                                                                    www.youtube.com</p>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col s12">
                                                                        <div class="card z-depth-0 grey lighten-4 border-radius-6">
                                                                            <div class="card-image">
                                                                                <img alt=""
                                                                                     class="responsive-img" src="{{asset('app-assets/images/gallery/20.png')}}">
                                                                            </div>
                                                                            <div class="card-content">
                                                                                Materialize admin includes 8
                                                                                pre-built templates.
                                                                                <p class="teal-text lighten-2 truncate">
                                                                                    www.youtube.com</p>
                                                                            </div>
                                                        ...
                                                        <div class="result mt-5">
                                                            <h6><a href="page-search.html#">Materialize - Material
                                                                    Design Admin Template - Pixinvent</a></h6>
                                                            <p class="teal-text lighten-2">
                                                                https://themeforest.net/item/materialize-material-design-admin-template</p>
                                                            <p>Materialize. #1 Selling & Most Popular Material
                                                                Design Admin Template of All Time. Join The
                                                                2,500+ Satisfied Customers Today.</p>
                                                        </div>
                                                        <div class="result mt-5">
                                                            <h6><a href="page-search.html#">Showcase -
                                                                    Materialize</a></h6>
                                                            <p class="teal-text lighten-2">
                                                                https://materializecss.com/showcase.html</p>
                                                            <p>Material Admin Template Universal Dashboard Capture
                                                                and archive website.</p>
                                                        </div>
                                                        <div class="result mt-5">
                                                            <h6><a href="page-search.html#">Materialize Admin
                                                                    Template - PIXINVENT</a></h6>
                                                            <p class="teal-text lighten-2">
                                                                pixinvent.com/materialize-v1.0/layout-fullscreen.html</p>
                                                            <p>My Task. March 26, 2015. Create Mobile App UI. Today
                                                                Mobile App.</p>
                                                        </div>
                                                        <div class="result mt-5">
                                                            <div class="row">
                                                                <div class="col s12 m3 l3">
                                                                    <img alt=""
                                                                         class="responsive-img mt-4 p-3 border-radius-6"
                                                                         src="{{asset('app-assets/images/gallery/37.png')}}">
                                                                </div>
                                                                <div class="col s12 m9 l9">
                                                                    <h6><a href="page-search.html#">Materialize
                                                                            Admin Template - PIXINVENT</a></h6>
                                                                    <p class="teal-text lighten-2">
                                                                        pixinvent.com/materialize-v1.0/layout-fullscreen.html</p>
                                                                    <p>Materialize is a Material Design Admin
                                                                        Template is the excellent responsive google
                                                                        material
                                                                        design inspired multipurpose admin
                                                                        template.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="result mt-5">
                                                            <h6><a href="page-search.html#">RockOn Materialize css
                                                                    Admin Template Dashboard</a></h6>
                                                            <p class="teal-text lighten-2">
                                                                pixinvent.com/materialize-v1.0/layout-fullscreen.html</p>
                                                            <p>Materialize css, Material Design Admin Template is
                                                                the excellent responsive.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col l4 m12 right-content border-radius-6">
                                                        ...
                                                        <img alt=""
                                                             class="responsive-img mt-4 p-3 border-radius-6"
                                                             src="{{asset('app-assets/images/gallery/34.png')}}">
                                                        <p class="mt-2 mb-2">Materialize is a Material Design Admin
                                                            Template is the excellent responsive
                                                            google material design inspired multipurpose admin
                                                            template.</p>
                                                        <hr>
                                                        <p class="mt-2"><b class="blue-grey-text text-darken-4">Files
                                                                Included:</b> HTML Files, CSS Files</p>
                                                        <p class="mt-2"><b class="blue-grey-text text-darken-4">Layout:</b>
                                                            Responsive</p>
                                                        <p class="mt-2"><b class="blue-grey-text text-darken-4">Created:</b>
                                                            20 May 15</p>
                                                        <p class="mt-2">Materialize - Material Design Admin Template
                                                            by PIXINVENT</p>
                                                        <p class="mt-5"><a href="page-search.html#">Themeforest -
                                                                $24</a></p>
                                                    </div>
                                                </div>
                                                <ul class="pagination mt-5">
                                                    <li class="disabled"><a href="page-search.html#!"><i
                                                                    class="material-icons">chevron_left</i></a></li>
                                                    <li class="active waves-effect border-radius-5"><a
                                                                href="page-search.html#!">1</a></li>
                                                    <li class="waves-effect"><a href="page-search.html#!">2</a></li>
                                                    <li class="waves-effect"><a href="page-search.html#!">3</a></li>
                                                    <li class="waves-effect"><a href="page-search.html#!">4</a></li>
                                                    <li class="waves-effect"><a href="page-search.html#!">5</a></li>
                                                    <li class="waves-effect"><a href="page-search.html#!"><i
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="page-search.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="page-search.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-search.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-search.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="page-search.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

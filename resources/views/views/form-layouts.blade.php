                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="form-layouts.html#">Form</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="form-layouts.html#!"><i
                    ...
                    <div class="seaction">
                        ...
                        <div class="row">
                            <div class="col s12 m6 l6">
                                <div class="card card card-default scrollspy" id="basic-form">
                                    <div class="card-content">
                            ...
                            <div class="col s12 m6 l6">
                                <div class="card card card-default scrollspy" id="placeholder">
                                    <div class="card-content">
                                        <h4 class="card-title">Form with placeholder</h4>
                                        <form class="col s12">
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <input id="name2" placeholder="John Doe" type="text">
                                                    <label for="name2">Name</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <input id="email2" placeholder="john@domainname.com"
                                                           type="email">
                                                    <label for="email">Email</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <input id="password2" placeholder="YourPassword"
                                                           type="password">
                                                    <label for="password">Password</label>
                                                </div>
                                            </div>
                                        ...
                                        <form class="col s12">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    ...
                                                    <textarea class="materialize-textarea" id="message3"></textarea>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <form class="col s12">
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <i class="material-icons prefix">account_circle</i>
                                                    <input class="validate" id="name4" type="text">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <i class="material-icons prefix">lock_outline</i>
                                                    <input class="validate" id="password5" type="password">
                            ...
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="inline-form">
                                    <div class="card-content">
                                        ...
                                        <form class="col s12">
                                            <div class="row">
                                                <div class="input-field col m4 s6">
                                                    <i class="material-icons prefix">account_circle</i>
                                                    <input class="validate" id="icon_prefix1" type="text">
                            ...
                            <!-- Form with validation -->
                            <div class="col s12 m12 l12">
                                <div class="card card card-default scrollspy" id="form-with-validation">
                                    <div class="card-content">
                                        ...
                                        <form class="col s12">
                                            <div class="row">
                                                <div class="input-field col m4 s6">
                                                    <i class="material-icons prefix">account_circle</i>
                                                    <input class="validate" id="icon_prefix2" placeholder="John Doe"
                                                           type="text">
                                                    <label for="icon_prefix2">First Name</label>
                                                </div>
                                                <div class="input-field col m4 s6">
                                                    <i class="material-icons prefix">email</i>
                                                    <input class="validate" id="icon_email"
                                                           placeholder="john@mydomain.com" type="email">
                                ...
                                <div class="card card card-default scrollspy" id="Form-advance">
                                    <div class="card-content">
                                        ...
                                        <form class="col s12">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <textarea class="materialize-textarea" id="message5"></textarea>
                                                    <label for="message">Message</label>
                                                </div>
                                                <div class="row">
                                                    <div class="input-field col s12">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="form-layouts.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="form-layouts.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-layouts.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-layouts.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="form-layouts.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

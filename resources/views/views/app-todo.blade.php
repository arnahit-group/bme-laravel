...
@section('header')
    ...
    <link href="{{asset('app-assets/css/pages/app-todo.css')}}" rel="stylesheet" type="text/css">
        ...
        <div class="row">
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <div class="sidebar-left sidebar-fixed">
                        <div class="sidebar">
                            <div class="sidebar-content">
                                <div class="sidebar-header">
                                    <div class="sidebar-details">
                                        <h5 class="m-0 sidebar-title"><i
                                                    class="material-icons app-header-icon text-top">check_box</i> To-Do
                                        </h5>
                                ...
                                <div class="sidebar-menu list-group position-relative  animate fadeLeft"
                                    ...
                                    <div class="sidebar-list-padding app-sidebar sidenav" id="todo-sidenav">
                                        <ul class="todo-list display-grid">
                                            <li class="active"><a class="text-sub" href="app-todo.html#!"><i
                                                            class="material-icons mr-2"> mail_outline </i> All</a>
                                            </li>
                                            <li class="sidebar-title">Filters</li>
                                            <li><a class="text-sub" href="app-todo.html#!"><i
                                                            class="material-icons mr-2"> star_border </i> Starred</a></li>
                                            <li><a class="text-sub" href="app-todo.html#!"><i
                                                            class="material-icons mr-2"> info_outline </i> Priority</a></li>
                                            <li><a class="text-sub" href="app-todo.html#!"><i
                                                            class="material-icons mr-2"> watch_later </i> Scheduled</a></li>
                                            <li><a class="text-sub" href="app-todo.html#!"><i
                                                            class="material-icons mr-2"> date_range </i> Today</a></li>
                                            <li><a class="text-sub" href="app-todo.html#!"><i
                                                            class="material-icons mr-2"> check </i> Done</a></li>
                                            <li><a class="text-sub" href="app-todo.html#!"><i
                                                            class="material-icons mr-2"> delete </i> Delete</a></li>
                                ...
                                <a class="sidenav-trigger hide-on-large-only" data-target="todo-sidenav"
                    ...
                    <div class="app-todo">
                        <div class="content-area content-right">
                            <div class="app-wrapper">
                                <div class="app-search">
                                    ...
                                    <input class="app-filter" id="todo_filter" placeholder="Search Contact"
                                           type="text">
                                </div>
                                        ...
                                        <div class="todo-header">
                                            ...
                                            <div class="todo-action">
                                                <div class="select-action">
                                                    <!-- Dropdown Trigger -->
                                                    <a class='dropdown-trigger btn btn-small' data-target='dropdown1'
                                                       href='app-todo.html#'>
                                                        Start Date
                                                    ...
                                                    <ul class='dropdown-content' id='dropdown1'>
                                                        <li><a href="app-todo.html#!">one</a></li>
                                                        <li><a href="app-todo.html#!">two</a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="app-todo.html#!">three</a></li>
                                                        <li><a href="app-todo.html#!"><i class="material-icons">view_module</i>four</a>
                                                        </li>
                                                        <li><a href="app-todo.html#!"><i class="material-icons">cloud</i>five</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <li class="collection-item">
                                                ...
                                                <div class="list-content">
                                                    <div class="list-title-area">
                                                        ...
                                                        <span class="badge grey lighten-2"><i
                                                                    class="purple-text material-icons small-icons mr-2">
                      fiber_manual_record </i>API</span>
                                                ...
                                                <div class="list-right">
                                                    ...
                                                    <div class="delete-task"><i class="material-icons">delete</i>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="collection-item">
                                                ...
                                                <div class="list-content">
                                                    <div class="list-title-area">
                                                        <div class="list-title">Cupcake tootsie roll icing biscuit
                                                        </div>
                                                        <span class="badge grey lighten-2"><i
                                                                    class="amber-text material-icons small-icons mr-2">
                      fiber_manual_record </i>Paypal</span>
                                                    </div>
                                                    <div class="list-desc">Chocolate cake biscuit candy canes carrot
                                                        cake. Bear claw wafer jujubes bear
                                                        claw candy biscuit. Jelly-o pudding topping. Muffin soufflé
                                                        cotton candy topping candy muffin
                                                        biscuit. Lemon drops lemon drops powder gingerbread pastry
                                                        cake.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                      ...
                      fiber_manual_record </i>API</span>
                                                    ...
                                                    <div class="list-desc">Pudding ice cream macaroon caramels oat
                                                        cake gummies jelly-o wafer macaroon.
                                                        Gingerbread cheesecake pudding donut halvah pastry
                                                        cheesecake. Tootsie roll lemon drops brownie ice
                                                        cream jelly jelly fruitcake. Muffin tiramisu cake ice cream.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                                                    <div class="list-date"> 23 Apr</div>
                                            ...
                                            <li class="collection-item">
                                                ...
                                                <div class="list-content">
                                                    <div class="list-title-area">
                                                        <div class="list-title">Cupcake danish icing cupcake
                                                            cupcake
                                                        </div>
                                                        <span class="badge grey lighten-2"><i
                                                                    class="light-green-text material-icons small-icons mr-2">
                      fiber_manual_record </i>Invoice</span>
                                                    ...
                                                    <div class="list-desc">Pie soufflé gummies danish cake pudding
                                                        tart lollipop. Donut apple pie marzipan.
                                                        Cupcake pastry gingerbread chocolate cake ice cream icing
                                                        muffin. Lemon drops cotton candy liquorice
                                                        candy icing ice cream bear claw. Candy gummies gummies
                                                        macaroon jujubes biscuit lemon drops.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                                                    <div class="list-date"> 23 Apr</div>
                      ...
                      fiber_manual_record </i>Paypal</span>
                                                    ...
                                                    <div class="list-desc">Apple pie icing powder cheesecake sweet
                                                        roll halvah pudding sugar plum toffee.
                                                        Cotton candy tart apple pie.Tart bonbon halvah cake. Carrot
                                                        cake sugar plum tootsie roll macaroon
                                                        jujubes.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                      ...
                      fiber_manual_record </i>Paypal</span>
                                                    ...
                                                    <div class="list-desc">Candy sesame snaps tiramisu bear claw ice
                                                        cream chocolate fruitcake powder
                                                        biscuit. Pudding oat cake cotton candy. Candy canes sweet
                                                        fruitcake. Macaroon pie bear claw sweet oat
                                                        cake candy.Marzipan soufflé sugar plum caramels oat cake
                                                        cake.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                      ...
                      fiber_manual_record </i>API</span>
                                                    ...
                                                    <div class="list-desc">Bear claw macaroon cheesecake cotton
                                                        candy bear claw sweet roll sweet roll sugar
                                                        plum. Oat cake sweet jelly beans cheesecake soufflé sweet
                                                        macaroon. Pudding gingerbread bear claw
                                                        chupa chups lollipop carrot cake. Cotton candy icing sweet
                                                        roll.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                      ...
                      fiber_manual_record </i>Invoice</span>
                                                    ...
                                                    <div class="list-desc">Marzipan icing liquorice tiramisu bonbon
                                                        sweet roll toffee sweet cupcake. Candy
                                                        canes candy canes pudding pie tiramisu tiramisu powder
                                                        macaroon. Cotton candy candy powder cheesecake
                                                        dessert. Sweet halvah marshmallow croissant tootsie roll.
                                                        Marzipan pudding apple pie caramels sweet
                                                        roll.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                      ...
                      fiber_manual_record </i>Invoice</span>
                                                    ...
                                                    <div class="list-desc">Cupcake bear claw pudding. Liquorice cake
                                                        jujubes candy canes topping pudding.
                                                        Oat cake liquorice jujubes donut. Powder tiramisu pudding
                                                        bear claw caramels sweet roll jelly-o.
                                                        Candy canes gummies muffin wafer oat cake chupa chups.
                                                        Jujubes tootsie roll pie.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                                                    <div class="list-date"> 23 Apr</div>
                                            ...
                                            <li class="collection-item">
                                                ...
                                                <div class="list-content">
                                                    <div class="list-title-area">
                                                        <div class="list-title">Powder lollipop lollipop pie
                                                            tiramisu
                                                        </div>
                                                        <span class="badge grey lighten-2"><i
                                                                    class="purple-text material-icons small-icons mr-2">
                      fiber_manual_record </i>API</span>
                                                    ...
                                                    <div class="list-desc">Wafer donut candy. Gummies tootsie roll
                                                        marshmallow. Sweet roll tootsie roll
                                                        tart. Chocolate bar marzipan gummies jelly dessert macaroon
                                                        lollipop topping gingerbread. Donut sugar
                                                        plum halvah gummies muffin pudding.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                                                    <div class="list-date"> 23 Apr</div>
                      ...
                      fiber_manual_record </i>Invoice</span>
                                                    ...
                                                    <div class="list-desc">Topping jelly-o muffin pie. Apple pie
                                                        dessert oat cake liquorice marshmallow
                                                        danish gummies tart. Fruitcake toffee tiramisu. Candy canes
                                                        candy canes biscuit gummies jujubes
                                                        soufflé caramels. Lollipop bonbon danish gingerbread sesame
                                                        snaps dragée.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                      ...
                      fiber_manual_record </i>Paypal</span>
                                                    ...
                                                    <div class="list-desc"> Cotton candy cheesecake sweet roll.
                                                        Gummi bears tiramisu jelly powder. Dessert
                                                        pie apple pie chocolate bar carrot cake donut chupa chups.
                                                        Cookie marzipan sweet roll chocolate
                                                        topping candy canes. Carrot cake croissant jujubes chupa
                                                        chups cupcake apple pie caramels cake icing.
                                                    </div>
                                                </div>
                                                <div class="list-right">
                                                    <div class="list-date"> 23 Apr</div>
                    ...
                    <!-- Modal Structure -->
                    <div class="modal border-radius-6 add-task-modal" id="modal1">
                                ...
                                <form class="col s12">
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12">
                                            ...
                                            <input class="validate datepicker" id="start-date" type="text">
                                            <label for="start-date">Start Date</label>
                                        </div>
                                        <div class="input-field col s12">
                                            <i class="material-icons prefix"> date_range </i>
                                            <input class="validate datepicker" id="end-date" type="text">
                                            <label for="end-date">End Date</label>
                                        </div>
                                        <div class="input-field col s12">
                                            <i class="material-icons prefix"> note </i>
                                            <textarea class="materialize-textarea validate" id="notes"></textarea>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="app-todo.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="app-todo.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="app-todo.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/app-todo.js')}}" type="text/javascript"></script>

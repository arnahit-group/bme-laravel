...
@section('main')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Sass</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="css-sass.html#">CSS</a>
                                </li>
                                <li class="breadcrumb-item active">Sass
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="css-sass.html#!"><i
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card-default" id="sass-variables">
                                    <div class="card-content">
                                        <h4 class="card-title">Variables</h4>
                                        <div class="row">
                                            <div class="col s12">
                                                <p>When using Sass, you can change the color scheme of your site
                                                    extremely quickly. Below is a very small
                                                    sample of what you can change through sass in <code
                                                            class=" language-scss">_variables.scss</code>.</p>
                                            </div>
                                            <div class="col s12">
  ...
  @if not $primary-color-light {
                      ...
                      /*** More variables not shown here.. ***/
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card-default" id="media-queries">
                                    <div class="card-content">
                                        <div class="section">
                                            <h4 class="card-title">Media Queries</h4>
                                            <p class="caption">We have 3 media queries for the 3 standard screen
                                                sizes you can use in your custom Sass
                                                files. This also includes media query variables that will define the
                                                range.</p>
                                            <div class="row">
                                                <div class="col s12">
                                                    ...
                                                    <p>
                                                        ...
                                                        <br> Medium screens are defined as having a max-width of
                                                        992px
  ...
  */
  ...
  // styles for extra large screens and up
                                        ...
                                        <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
                                            ...
                                            <ul>
                                                <li>
                                                    <a class="btn-floating blue" href="css-helpers.html">
                                                        <i class="material-icons">help_outline</i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="btn-floating green" href="cards-extended.html">
                                                        <i class="material-icons">widgets</i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="btn-floating amber" href="app-calendar.html">
                                                        <i class="material-icons">today</i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="btn-floating red" href="app-email.html">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="css-sass.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="css-sass.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-sass.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="css-sass.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="css-sass.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

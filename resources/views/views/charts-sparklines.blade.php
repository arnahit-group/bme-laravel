...
@section('header')
    <link href="{{asset('app-assets/css/pages/charts-sparkline.css')}}" rel="stylesheet" type="text/css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Charts Sparklines</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="charts-sparklines.html#">Charts</a>
                                </li>
                                <li class="breadcrumb-item active">Charts Sparklines
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="charts-sparklines.html#!"><i
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <div class="col s12 display-flex">
                                                ...
                                                <p class="mt-4 pink-text accent-2"><i
                            ...
                            <div class="col s12 m6 l4">
                                <div class="ct-chart card z-depth-2 border-radius-6">
                                    <div class="card-content">
                                        ...
                                        <div class="center" id="invoice-line"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12 m6 l4">
                                <div class="ct-chart card z-depth-2 border-radius-6">
                                    <div class="card-content">
                                        ...
                                        <div class="center" id="clients-bar"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="ct-chart card z-depth-2 border-radius-6">
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <div class="col s12">
                                                <div class="center" id="pie-chart-sample"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col s12 m12 l4">
                                <div class="ct-chart card z-depth-2 border-radius-6">
                                    <div class="card-content">
                                        ...
                                        <div class="center" id="profit-tristate"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12 m12 l4">
                                <div class="ct-chart card z-depth-2 border-radius-6">
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <div class="col s12">
                                                <div class="center" id="bar-chart-sample"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col s12 m12 l4">
                                <div class="ct-chart card z-depth-2 border-radius-6">
                                    <div class="card-content">
                                        ...
                                        <div class="center" id="sales-compositebar"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="charts-sparklines.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="charts-sparklines.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="charts-sparklines.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="charts-sparklines.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="charts-sparklines.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@endsection
@section('vendor-js')
    <script src="{{asset('app-assets/vendors/sparkline/jquery.sparkline.min.js')}}" type="text/javascript"></script>

@endsection

@section('footer')
    <script src="{{asset('app-assets/js/scripts/charts-sparklines.js')}}" type="text/javascript"></script>

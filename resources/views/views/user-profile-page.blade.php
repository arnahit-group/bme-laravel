...
@section('header')
    ...
    <link href="{{asset('app-assets/css/pages/user-profile-page.css')}}" rel="stylesheet" type="text/css">
                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="user-profile-page.html#">User</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="user-profile-page.html#!"><i
                            ...
                            <div class="col s12 m4 l3 user-section-negative-margin">
                                <div class="row">
                                    <div class="col s12 center-align">
                                        <img alt="" class="responsive-img circle z-depth-5"
                                             src="{{asset('app-assets/images/user/12.jpg')}}" width="200">
                                        <br>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <p class="m-0"><a href="user-profile-page.html#">56</a> and <a
                                                    href="user-profile-page.html#">42</a> reviews</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row user-projects">
                                    ...
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/35.png')}}">
                                    </div>
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/36.png')}}">
                                    </div>
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/37.png')}}">
                                    </div>
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/38.png')}}">
                                    </div>
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                    ...
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/40.png')}}">
                                    </div>
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/41.png')}}">
                                    </div>
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/42.png')}}">
                                    </div>
                                    <div class="col s4">
                                        <img alt="" class="responsive-img photo-border mt-10"
                                             src="{{asset('app-assets/images/gallery/43.png')}}">
                                    </div>
                                </div>
                                <hr class="mt-5">
                                <div class="row">
                                ...
                                <div class="row mt-2">
                                    <div class="col s2 mt-2 pr-0 circle">
                                        <a href="user-profile-page.html#"><img alt=""
                                                                               class="responsive-img circle"
                                                                               src="{{asset('app-assets/images/user/1.jpg')}}"></a>
                                    </div>
                                    <div class="col s9">
                                ...
                                <div class="row mt-2">
                                    <div class="col s2 mt-2 pr-0 circle">
                                        <a href="user-profile-page.html#"><img alt=""
                                                                               class="responsive-img circle"
                                                                               src="{{asset('app-assets/images/user/11.jpg')}}"></a>
                                    </div>
                                    <div class="col s9">
                                        <a href="user-profile-page.html#">
                                ...
                                <div class="row mt-2">
                                    <div class="col s2 mt-2 pr-0 circle">
                                        <a href="user-profile-page.html#"><img alt=""
                                                                               class="responsive-img circle"
                                                                               src="{{asset('app-assets/images/user/5.jpg')}}"></a>
                                    </div>
                                    <div class="col s9">
                                        <a href="user-profile-page.html#">
                                ...
                                <div class="row mt-2">
                                    <div class="col s2 mt-2 pr-0 circle pb-2">
                                        <a href="user-profile-page.html#"><img alt=""
                                                                               class="responsive-img circle"
                                                                               src="{{asset('app-assets/images/user/8.jpg')}}"></a>
                                    </div>
                                    <div class="col s9">
                                        <a href="user-profile-page.html#">
                    ...
                    <span class="material-icons star-width vertical-align-middle">star_rate</span> <span
                                            ...
                                            <div class="row mt-5">
                                                <div class="col s1 pr-0 circle">
                                                    <a href="user-profile-page.html#"><img
                                                                alt=""
                                                                class="responsive-img circle" src="{{asset('app-assets/images/user/12.jpg')}}"></a>
                                                </div>
                                                <div class="col s11">
                                                    <a href="user-profile-page.html#">
                                                        <p class="m-0">Suzanne Martin <span><i
                                                                        class="material-icons vertical-align-bottom">access_time</i> 1
                      days</span></p>
                                                    </a>
                                                    <div class="row">
                                                        <div class="col s12">
                                                            <div class="card card-border z-depth-2">
                                                                <div class="card-image">
                                                                    <img alt=""
                                                                         src="{{asset('app-assets/images/gallery/post-1.png')}}">
                                                                </div>
                                                                <div class="card-content">
                                                                    <h6 class="font-weight-900 text-uppercase"><a
                                                                                href="user-profile-page.html#">Designing
                                                                            Services</a></h6>
                                                            ...
                                                            <div class="social-icon">
                                                                ...
                                                                15 <span><i
                                                                            class="material-icons vertical-align-bottom ml-3 mr-1">redo</i> 6</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col s11">
                                                    <a href="user-profile-page.html#">
                                                        <p class="m-0">Suzanne Martin <span><i
                                                                        class="material-icons vertical-align-bottom">access_time</i> 5
                      days</span></p>
                                                    </a>
                                                    <div class="row">
                                                        <div class="col s12">
                                                            <div class="card card-border z-depth-2">
                                                                <div class="card-image">
                                                                    <img alt=""
                                                                         src="{{asset('app-assets/images/gallery/post-2.png')}}">
                                                                </div>
                                                                <div class="card-content">
                                                                    <h6 class="font-weight-900 text-uppercase"><a
                                                                                href="user-profile-page.html#">Australia
                                                                            office hours</a></h6>
                                                                    <p>Working so hard</p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row mt-5">
                                                <div class="col s1 pr-0 circle">
                                                    <a href="user-profile-page.html#"><img
                                                                alt=""
                                                                class="responsive-img circle" src="{{asset('app-assets/images/user/7.jpg')}}"></a>
                                                </div>
                                                <div class="col s11">
                                                    <a href="user-profile-page.html#">
                                                        <p class="m-0">Luiza Ales <span><i
                                                                        class="material-icons vertical-align-bottom">access_time</i> 10
                      days</span></p>
                                                    </a>
                                                    <div class="row">
                                                        <div class="col s12">
                                                            <div class="card card-border z-depth-2">
                                                                <div class="card-content">
                                                                    ...
                                                                    <hr>
                                                                    <h6 class="font-weight-900 text-uppercase"><a
                                                                                href="user-profile-page.html#">Senior
                                                                            Developer</a></h6>
                                                                    <p>When I hear “Senior Developer” I think of
                                                                        someone who has mastered ... When looking at
                            ...
                            <div class="col s12 m12 l3 hide-on-med-and-down">
                                <div class="row mt-5">
                                    <div class="col s12">
                                        ...
                                        <img alt=""
                                             class="responsive-img card-border z-depth-2 mt-2"
                                             src="{{asset('app-assets/images/gallery/post-3.png')}}">
                                        <p><a href="user-profile-page.html#">Meeting with clients</a></p>
                                        <p>Crediting isn’t required, but is appreciated and allows photographers to
                                            gain exposure. Copy the text
                                ...
                                <div class="row mt-2">
                                    <div class="col s2 mt-2 pr-0 circle">
                                        <a href="user-profile-page.html#"><img alt=""
                                                                               class="responsive-img circle"
                                                                               src="{{asset('app-assets/images/user/2.jpg')}}"></a>
                                    </div>
                                    <div class="col s9">
                                        <a href="user-profile-page.html#">
                                ...
                                <div class="row mt-2">
                                    <div class="col s2 mt-2 pr-0 circle">
                                        <a href="user-profile-page.html#"><img alt=""
                                                                               class="responsive-img circle"
                                                                               src="{{asset('app-assets/images/user/7.jpg')}}"></a>
                                    </div>
                                    <div class="col s9">
                                        <a href="user-profile-page.html#">
                                ...
                                <div class="row mt-2">
                                    <div class="col s2 mt-2 pr-0 circle">
                                        <a href="user-profile-page.html#"><img alt=""
                                                                               class="responsive-img circle"
                                                                               src="{{asset('app-assets/images/user/4.jpg')}}"></a>
                                    </div>
                                    <div class="col s9">
                                        <a href="user-profile-page.html#">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <p class="latest-update">Make Metronic<span class="right"> <a
                                                        href="user-profile-page.html#">+480</a> </span></p>
                                        <p class="latest-update">Programming Language <span class="right"> <a
                                                        href="user-profile-page.html#">+12</a> </span></p>
                                        <p class="latest-update">Project completed <span class="right"> <a
                                                        href="user-profile-page.html#">+570</a> </span></p>
                                        <p class="latest-update">New Customer <span class="right"><a
                                                        href="user-profile-page.html#">+120</a> </span></p>
                                        <p class="latest-update">Annual Companies<span class="right"> <a
                                                        href="user-profile-page.html#">+890</a> </span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="user-profile-page.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="user-profile-page.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="user-profile-page.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

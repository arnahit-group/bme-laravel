                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="form-validation.html#">Form</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="form-validation.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <p><a href="http://jqueryvalidation.org/" target="_blank">jQuery Validation</a> This
                                    jQuery plugin makes simple
                                    clientside form validation easy, whilst still offering plenty of customization
                                    options.</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="html-validations">
                                    <div class="card-content">
                                            ...
                                            <form class="formValidate0" id="formValidate0" method="get">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input aria-required="true" class="validate" id="uname0"
                                                               name="uname0" required type="text">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="cemail0">E-Mail *</label>
                                                        <input aria-required="true" class="validate" id="cemail0"
                                                               name="cemail0" required type="email">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="password0">Password *</label>
                                                        <input aria-required="true" class="validate" id="password0"
                                                               name="password0" required type="password">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="cpassword0">Confirm Password *</label>
                                                        <input aria-required="true" class="validate" id="cpassword0"
                                                               name="cpassword0" required type="password">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="curl0">URL *</label>
                                                        <input aria-required="true" class="validate" id="curl0"
                                                               name="curl0" required type="url">
                                                    </div>
                                                    <div class="col s12">
                                                        <label for="role">Role</label>
                                                        <select aria-required="true" class="error validate" id="role"
                                                                name="role" required>
                                                    ...
                                                    <div class="input-field col s12">
                  <textarea aria-required="true" class="materialize-textarea validate" id="ccomment0" name="ccomment0"
                            required></textarea>
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <p>
                                                            <label>
                                                                <input aria-required="true" checked
                                                                       class="validate" name="gender0"
                                                                       required type="radio"/>
                                                                <span>Male</span>
                                                            </label>
                                                        </p>
                                                        ...
                                                        <label>
                                                            <input aria-required="true" class="validate" name="gender0"
                                                                   required type="radio"/>
                                                            <span>Female</span>
                                                        </label>
                                                        <div class="input-field">
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <p>
                                                            <label>
                                                                <input aria-required="true" class="validate"
                                                                       id="tnc_select1" required
                                                                       type="checkbox"/>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="validations">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="form-validation.html#view-validations">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="form-validation.html#js-validations">JS</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <form class="formValidate" id="formValidate" method="get">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input data-error=".errorTxt1" id="uname" name="uname"
                                                               type="text">
                                                        <div class="errorTxt1"></div>
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="cemail">E-Mail *</label>
                                                        <input data-error=".errorTxt2" id="cemail" name="cemail"
                                                               type="email">
                                                        <div class="errorTxt2"></div>
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="password">Password *</label>
                                                        <input data-error=".errorTxt3" id="password" name="password"
                                                               type="password">
                                                        <div class="errorTxt3"></div>
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="cpassword">Confirm Password *</label>
                                                        <input data-error=".errorTxt4" id="cpassword" name="cpassword"
                                                               type="password">
                                                        <div class="errorTxt4"></div>
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label for="curl">URL *</label>
                                                        <input data-error=".errorTxt5" id="curl" name="curl"
                                                               type="url">
                                                        <div class="errorTxt5"></div>
                                                    </div>
                                                    <div class="col s12">
                                                        <label for="crole">Role *</label>
                                                        <select class="error browser-default" data-error=".errorTxt6"
                                                                id="crole" name="crole">
                                                            <option disabled selected value="">Choose your profile
                                                            </option>
                                                            <option value="1">Manager</option>
                                                    ...
                                                    <div class="input-field col s12">
                                                            <textarea class="materialize-textarea validate" data-error=".errorTxt7"
                                                                      id="ccomment"
                                                                      name="ccomment"></textarea>
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <p>
                                                            <label>
                                                                <input id="tnc_select" type="checkbox"/>
                                                                <span>Please agree to our policies</span>
                                                            </label>
                                                        </p>
                                                        <div class="input-field">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="form-validation.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="form-validation.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-validation.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-validation.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="form-validation.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

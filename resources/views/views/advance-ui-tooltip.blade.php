...
@section('main')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Tooltip</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="advance-ui-tooltip.html#">Advance UI</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="advance-ui-tooltip.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption">Tooltips are small, interactive, textual hints for mainly
                                    graphical elements. When using icons
                                    for actions you can use a tooltip to give people clarification on its
                                    function.</p>
                            </div>
                        </div>
                        <!--Tooltips-->
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="tooltips">
                                    <div class="card-content">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s4 p-0"><a class="active p-0"
                                                                                      href="advance-ui-tooltip.html#view-tooltip">View</a>
                                                        </li>
                                                        <li class="tab col s4 p-0"><a class="p-0"
                                                                                      href="advance-ui-tooltip.html#html-tooltip">Html</a>
                                                        </li>
                                                        <li class="tab col s4 p-0"><a class="p-0"
                                                                                      href="advance-ui-tooltip.html#js-tooltip">JS</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-tooltip">
                                            <div class="row">
                                                <div class="col s12">
                                                    <p>Add the Tooltipped class to your element and add either top,
                                                        bottom, left, right on data-tooltip to
                                                        control the position.</p>
                                                </div>
                                                <div class="col s12">
                                                    <a class="btn tooltipped col s6 m2 mr-1 mt-2"
                                                       data-position="bottom" data-tooltip="I am tooltip">
                                                        Bottom</a>
                                                    <a class="btn tooltipped col s6 m2 mr-1 mt-2"
                                                       data-position="top" data-tooltip="I am tooltip">
                                                        Top</a>
                                                    <a class="btn tooltipped col s6 m2 mr-1 mt-2"
                                                       data-position="left" data-tooltip="I am tooltip">
                                                        Left</a>
                                                    <a class="btn tooltipped col s6 m2 mt-2" data-position="right"
                                                ...
                                                <div class="col s12 mt-2">
                                                    <p>Add the Tooltipped class to your element and add either <a
                                                                class="tooltipped" data-delay="50"
                                                                data-position="top" data-tooltip="I am top tooltip">top</a>,
                                                        <a class="tooltipped" data-delay="50"
                                                           data-position="bottom"
                                                           data-tooltip="I am bottom tooltip">bottom</a>, <a
                                                                class="tooltipped" data-delay="50"
                                                                data-position="left" data-tooltip="I am left tooltip">left</a>,
                                                        <a class="tooltipped" data-delay="50"
                                                           data-position="right"
                                                           data-tooltip="I am right tooltip">right</a> on
                                                        data-tooltip to control the
                                                        position.</p>
                                                </div>
                                            </div>
                                        </div>
  ...
  &lt;a class="btn tooltipped" data-position="bottom" data-tooltip="I am a tooltip">Hover me!&lt;/a>
                                        ...
                                        <div id="js-tooltip">
                                            <p>Tooltips are initialized automatically, but if you have dynamically
                                                added tooltips, you will need to
                                                initialize them.</p>
            ...
            $('.tooltipped').tooltip();
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card-default" id="jquery-plugin">
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            <table class="highlight">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>tooltip</td>
                                                        <td>Tooltip text. Can use custom HTML if you set the html
                                                            option.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>position</td>
                                                        <td>Set the direction of the tooltip. 'top', 'right',
                                                            'bottom', 'left'. (Default: 'bottom')
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>html</td>
                                                        <td>Allow custom html inside the tooltip. (Default: false)
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="card card-default" id="removal">
                                    <div class="card-content">
                                        <h4 class="card-title">Removal</h4>
                                        <div class="row">
                                            <div class="col s12">
                                                <p>To close the tooltip from the button, pass in <code
                                                            class="language-javascript">'close'</code> as
                                                    instance</p>
                                                <pre><code class="language-javascript">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="advance-ui-tooltip.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="advance-ui-tooltip.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-tooltip.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="advance-ui-tooltip.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="advance-ui-tooltip.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

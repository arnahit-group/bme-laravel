    ...
    <div id="main">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Form Masks</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="form-masks.html#">Form</a>
                                </li>
                                <li class="breadcrumb-item active">Form Masks
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="form-masks.html#!"><i
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0"><a href="https://github.com/firstopinion/formatter.js"
                                                           target="_blank">Formatter</a>
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="form-masks.html#view-basic-demo">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="form-masks.html#js-basic-demo">js</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <form class="col s12">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="date-demo1"
                                                                   placeholder="2019-01-01" type="text">
                                                            <label for="date-demo1">Date</label>
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="date-demo2"
                                                                   placeholder="2019/01/01" type="text">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="time-demo" placeholder="00:00"
                                                                   type="text">
                                                            <label for="time-demo">Time</label>
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="date-time"
                                                                   placeholder="2019/01/01 00:00" type="text">
                                                            <label for="date-time">Date & Time</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="time-demo2" placeholder="00:00"
                                                                   type="text">
                                                            <label for="time-demo2">Time</label>
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <input class=""
                                                                   id="characters-demo" placeholder="asdfghjkl (max10)" type="text">
                                                            <label for="characters-demo">Characters (Only)</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="phone-input"
                                                                   placeholder="Placeholder" type="text">
                                                            <label for="phone-input">Phone Number</label>
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="credit-input"
                                                                   placeholder="Placeholder" type="text">
      ...
      $('#phone-input').formatter({
        ...
        'persistent': true
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="extended">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="form-masks.html#view-extended">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="form-masks.html#js-extended">js</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div id="view-extended">
                                            <div class="row">
                                                <form class="col s12">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="phone-demo" type="text">
                                                            <label for="phone-demo">Phone</label>
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="phone-code" type="text">
                                                            <label for="phone-code">Phone Code</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="currency-demo" type="text">
                                                            <label for="currency-demo">Currency</label>
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="credit-demo" type="text">
                                                            <label for="credit-demo">Credit Card</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="product-key" type="text">
                                                            <label for="product-key">Product Key</label>
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <input class="" id="purchase-code" type="text">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="form-masks.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="form-masks.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-masks.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-masks.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="form-masks.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    <script src="{{asset('app-assets/js/scripts/form-masks.js')}}" type="text/javascript"></script>

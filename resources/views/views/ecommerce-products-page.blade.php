...
@section('header')
    ...
    <link href="{{asset('app-assets/css/pages/eCommerce-products-page.css')}}" rel="stylesheet" type="text/css">
                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="eCommerce-products-page.html#">Apps</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="eCommerce-products-page.html#!"><i
                            ...
                            <div class="col s12 m12 l9">
                                <div class="col s12 m4 l4">
                                    <div class="card animate fadeLeft">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <img alt=""
                                                 class="responsive-img" src="{{asset('app-assets/images/cards/watch-2.png')}}">
                                            <div class="row">
                                                ...
                                                <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger"
                                                   href="eCommerce-products-page.html#modal1">View</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Modal Structure -->
                                ...
                                <div class="col s12 m4 l4">
                                    <div class="card animate fadeUp">
                                        <div class="card-content">
                                            ...
                                            <img alt=""
                                                 class="responsive-img" src="{{asset('app-assets/images/cards/headphone.png')}}">
                                            <div class="row">
                                                <h5 class="col s12 m12 l8 mt-3">$249.00</h5>
                                                <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger"
                                                   href="eCommerce-products-page.html#modal2">View</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="row" id="product-two">
                                                ...
                                                <div class="col m6">
                                                    ...
                                                    <h5>$249.00 <span class="prise-text-style ml-2">$559.00</span>
                                                    </h5>
                                                    <a class="waves-effect waves-light btn gradient-45deg-deep-purple-blue mt-2">ADD
                                                        TO CART</a>
                                                    <a class="waves-effect waves-light btn gradient-45deg-purple-deep-orange mt-2">BUY
                                ...
                                <div class="col s12 m4 l4">
                                    <div class="card animate fadeRight">
                                        <div class="card-content">
                                            ...
                                            <img alt=""
                                                 class="responsive-img" src="{{asset('app-assets/images/cards/iphone-x.png')}}">
                                            <div class="row">
                                                ...
                                                <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4 z-depth-4 z-depth-4 z-depth-4"
                                                   href="eCommerce-products-page.html#modal3">View</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Modal Structure -->
                                    ...
                                    <div class="card animate fadeUp">
                                        ...
                                        <div class="card-content">
                                            <div class="row" id="product-four">
                                                <div class="col m6">
                                                    <img alt=""
                                                         class="responsive-img" src="{{asset('app-assets/images/cards/remote.png')}}">
                                                </div>
                                                <div class="col m6">
                                                    <p>Powerbank</p>
                                                    <h5>Game Remote</h5>
                                    ...
                                    <div class="col s12 m4 l4">
                                        <div class="card animate fadeLeft">
                                            <div class="card-content">
                                                ...
                                                <img alt=""
                                                     class="responsive-img" src="{{asset('app-assets/images/cards/powerbank.png')}}">
                                                <div class="row">
                                                    ...
                                                    <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4 z-depth-4 z-depth-4"
                                                       href="eCommerce-products-page.html#modal4">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Modal Structure -->
                                    ...
                                    <div class="col s12 m4 l4">
                                        <div class="card animate fadeUp">
                                            ...
                                            <div class="card-content">
                                                ...
                                                <img alt=""
                                                     class="responsive-img" src="{{asset('app-assets/images/cards/speakers.png')}}">
                                                <div class="row">
                                                    ...
                                                    <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4 z-depth-4"
                                                       href="eCommerce-products-page.html#modal5">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Modal Structure -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="row" id="product-six">
                                                    ...
                                                    <div class="col m6">
                                                        ...
                                                        <span class="new badge left ml-0 mr-2"
                                                              data-badge-caption="">4.2 Star</span>
                                                        <p>Availability: <span class="red-text">Out of stock</span>
                                                        </p>
                                                        <hr class="mb-5">
                                                        <span class="vertical-align-top mr-4"><i
                                                                    class="material-icons mr-3">favorite_border</i>Wishlist</span>
                                    ...
                                    <div class="col s12 m4 l4">
                                        <div class="card animate fadeRight">
                                            <div class="card-content">
                                                ...
                                                <img alt=""
                                                     class="responsive-img" src="{{asset('app-assets/images/cards/cameras.png')}}">
                                                <div class="row">
                                                    ...
                                                    <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4"
                                                       href="eCommerce-products-page.html#modal6">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Modal Structure -->
                                    ...
                                    <div class="col s12 m4 l4">
                                        <div class="card animate fadeLeft">
                                            <div class="card-content">
                                                ...
                                                <img alt=""
                                                     class="responsive-img" src="{{asset('app-assets/images/cards/oneplus-6t.png')}}">
                                                <div class="row">
                                                    <h5 class="col s12 m12 l8 mt-3">$499.00</h5>
                                                    <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4"
                                                       href="eCommerce-products-page.html#modal7">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Modal Structure -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="row" id="product-eight">
                                                    ...
                                                    <div class="col m6">
                                                        ...
                                                        <h5>OnePlus 6T</h5>
                                                        <span class="new badge left ml-0 mr-2"
                                                              data-badge-caption="">5 Star</span>
                                                        <p>Availability: <span class="green-text">Available</span>
                                                        </p>
                                                        <hr class="mb-5">
                                                        <span class="vertical-align-top mr-4"><i
                                    ...
                                    <div class="col s12 m4 l4">
                                        <div class="card animate fadeUp">
                                            <div class="card-content">
                                                ...
                                                <img alt=""
                                                     class="responsive-img" src="{{asset('app-assets/images/cards/smartspeakers.png')}}">
                                                <div class="row">
                                                    <h5 class="col s12 m12 l8 mt-3">$799.00</h5>
                                                    <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4"
                                                       href="eCommerce-products-page.html#modal8">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Modal Structure -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="row" id="product-nine">
                                                    ...
                                                    <div class="col m6">
                                                        ...
                                                        <h5>Amazon Alexa</h5>
                                                        <span class="new badge left ml-0 mr-2"
                                                              data-badge-caption="">4.9 Star</span>
                                                        <p>Availability: <span class="green-text">Available</span>
                                                        </p>
                                                        <hr class="mb-5">
                                                        <span class="vertical-align-top mr-4"><i
                                    ...
                                    <div class="col s12 m4 l4">
                                        <div class="card animate fadeRight">
                                            <div class="card-content">
                                                ...
                                                <img alt=""
                                                     class="responsive-img" src="{{asset('app-assets/images/cards/magic-mouse.png')}}">
                                                <div class="row">
                                                    <h5 class="col s12 m12 l8 mt-3">$359.00</h5>
                                                    <a class="col s12 m12 l4 mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4"
                                                       href="eCommerce-products-page.html#modal9">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Modal Structure -->
                                ...
                                <div class="col s12 center">
                                    <ul class="pagination">
                                        ...
                                        <li class="active"><a href="eCommerce-products-page.html#!">1</a>
                                        </li>
                                        <li class="waves-effect"><a href="eCommerce-products-page.html#!">2</a>
                                        </li>
                                        <li class="waves-effect"><a href="eCommerce-products-page.html#!">3</a>
                                        </li>
                                        <li class="waves-effect"><a href="eCommerce-products-page.html#!">4</a>
                                        </li>
                                        <li class="waves-effect"><a href="eCommerce-products-page.html#!">5</a>
                                        </li>
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="eCommerce-products-page.html#">clear</a></i>
                                            </div>

...
@section('vendor-css')
    <link href="{{asset('app-assets/vendors/jquery-jvectormap/jquery-jvectormap.css')}}" rel="stylesheet"
@endsection

@section('header')

    <link href="{{asset('app-assets/css/pages/dashboard.css')}}" rel="stylesheet" type="text/css">
                                    ...
                                    <div class="card-content red accent-2 white-text">
                                        ...
                                        <p class="card-stats-compare">
                                            <i class="material-icons">keyboard_arrow_up</i> 70% <span
                                                    class="red-text text-lighten-5">last month</span>
                                        </p>
                                    </div>
                    ...
                    <div id="work-collections">
                        <div class="row">
                            <div class="col s12 m12 l6">
                                <ul class="collection z-depth-1 animate fadeLeft" id="projects-collection">
                            ...
                            <div class="col s12 m12 l6">
                                <ul class="collection z-depth-1 animate fadeRight" id="issues-collection">
                                    <li class="collection-item avatar">
                    ...
                    <div id="card-widgets">
                        <div class="row">
                            <div class="col s12 m6 l4">
                                <ul class="collection with-header animate fadeLeft" id="task-card">
                                    ...
                                    <li class="collection-item dismissable">
                                        <label for="task1">
                                            ...
                                            <a class="secondary-content" href="dashboard-analytics.html#"><span
                            ...
                            <div class="col s12 m6 l4">
                                <div class="card animate fadeUp" id="flight-card">
                            ...
                            <div class="col s12 m12 l4">
                                <div class="card animate fadeRight" id="profile-card">
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="dashboard-analytics.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="dashboard-analytics.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="dashboard-analytics.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="dashboard-analytics.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="dashboard-analytics.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('vendor-js')
    ...
    <script src="{{asset('app-assets/vendors/jquery-jvectormap/jquery-jvectormap.min.js')}}"></script>
    <script src="{{asset('app-assets/vendors/jquery-jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>

@endsection

@section('footer')
    <script src="{{asset('app-assets/js/scripts/dashboard-analytics.js')}}" type="text/javascript"></script>
    <script src="{{asset('app-assets/js/scripts/vectormap-script.js')}}" type="text/javascript"></script>

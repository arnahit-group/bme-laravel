                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Knowledge Licensing Page Detail</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                            href="page-knowledge-licensing-detail.html#">Pages</a>
                                </li>
                                <li class="breadcrumb-item"><a href="page-knowledge.html">Knowledge</a>
                                </li>
                                <li class="breadcrumb-item"><a href="page-knowledge-licensing.html">Knowledge
                                        Licensing</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="page-knowledge-licensing-detail.html#!"><i
                    ...
                    <div class="section" id="knowledge-licensing-detail">
                        <div class="row knowledge-content">
                            ...
                            <div class="col s12 m3 l3 licenses-link mt-1 sidebar-title">
                                <h6><b class="white-text">Related articles</b></h6>
                            ...
                            <div class="col s12 m9 l9 licenses">
                                <div class="card">
                                    <div class="card-content">
                                        <h5 class="mb-2">How do licenses work for any plugins that are bundled with
                                            the theme I bought?</h5>
                                        <p class="mb-2">Updated 1 year ago</p>
                                        <p>Many themes sold on ThemeForest come bundled with premium plugins from
                                            CodeCanyon.</p>
                                        <p class="mb-2">
                                            A plugin is an additional component that offers functionality and
                                            features beyond a typical theme
                                            installation. Theme authors (who sell the themes) may choose to include
                                            certain plugins (such as Visual
                                            Composer, Revolution Slider or other page builder plugins) within their
                                            item to add these special functions
                                            and features to the theme package. You don’t need a separate license to
                                            use a bundled plug-in as part of
                                            the theme it was bundled with.</p>
                                        <p class="mb-2">
                                            Bundled plugins offer the same core features and functionality as the
                                            standalone version of the item on
                                            CodeCanyon.</p>
                                        <p class="mb-2">
                                            Some plugins may ask for a purchase code for registration/activation
                                            once installed, however, you can
                                            simply ignore these messages as bundled plugins do not require
                                            activation or registration. The plugin will
                                            still work as intended with the theme once the theme has been
                                            activated/registered.</p>
                                        <p class="mb-2">
                                            When a plugin is updated, the theme author will include the latest
                                            version of the bundled plugin with their
                                            next theme update. So you can easily update the bundled plugin when you
                                            next update your theme. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="page-knowledge-licensing-detail.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active"
                                                           href="page-knowledge-licensing-detail.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-knowledge-licensing-detail.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="page-knowledge-licensing-detail.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="page-knowledge-licensing-detail.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
...
@section('footer')
    ...
    <script src="https://pixinvent.com/js/scripts/page-knowledge.js" type="text/javascript"></script>

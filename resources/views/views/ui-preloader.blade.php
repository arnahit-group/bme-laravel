...
@section('main')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Preloader</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="ui-preloader.html#">Basic UI</a>
                                </li>
                                <li class="breadcrumb-item active">Preloader
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="ui-preloader.html#!"><i
                    ...
                    <div class="seaction">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0">If you have content that will take a long time to load, you
                                    should give the user
                                    feedback. For this reason we provide a number activity + progress
                                    indicators.</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="linear">
                                    <div class="card-content">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-preloader.html#view-linear">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-preloader.html#html-linear">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
    ...
    &lt;/div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="indeterminate-linear">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-preloader.html#view-indeterminate-linear">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-preloader.html#html-indeterminate-linear">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
    ...
    &lt;/div>
                        ...
                        <p>There are 4 colors and 3 sizes of circular spinners. The spinner should be nested in a
                            <code class="language-markup">preloader-wrapper</code>
                            div. The default size is medium, but you can add the classes <code
                                    class="language-markup">big</code> or <code
                                    class="language-markup">small</code> to adjust the size accordingly. You can add
                            the classes <code class="language-markup">spinner-red-only</code>,
                            <code class="language-markup">spinner-blue-only</code>, <code class="language-markup">spinner-yellow-only</code>
                            and <code class="language-markup">spinner-green-only</code>. You can also leave this
                            class as just <code class="language-markup">spinner-layer</code>
                            and it will be set to the <code class="language-css">$spinner-default-color</code>
                            variable in our variables.scss
                            file.</p>

                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="simple-circular">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-preloader.html#view-simple-circular">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-preloader.html#html-simple-circular">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
  ...
  &lt;/div&gt;
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card card-tabs" id="circular-flashing">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col s12 m6 l10">
                                                ...
                                                <div class="col s12 m6 l2">
                                                    <ul class="tabs">
                                                        <li class="tab col s6 p-0"><a class="active p-0"
                                                                                      href="ui-preloader.html#view-circular-flashing">View</a>
                                                        </li>
                                                        <li class="tab col s6 p-0"><a class="p-0"
                                                                                      href="ui-preloader.html#html-circular-flashing">Html</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="ui-preloader.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="ui-preloader.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-preloader.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="ui-preloader.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="ui-preloader.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

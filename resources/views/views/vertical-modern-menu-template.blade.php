                                    ...
                                    <ul class="collection mb-0">
                                        <li class="collection-item avatar">
                                            ...
                                            <a class="secondary-content"
                                               href="vertical-modern-menu-template.html#!"><i
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="vertical-modern-menu-template.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active"
                                                           href="vertical-modern-menu-template.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="vertical-modern-menu-template.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="vertical-modern-menu-template.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="vertical-modern-menu-template.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">
                                        ...
                                        <div class="carousel carousel-slider center intro-carousel">
                                            ...
                                            <div class="carousel-item slide-1">
                                                <img alt=""
                                                     ...
                                                     src="{{asset('app-assets/images/gallery/intro-slide-1.png')}}">
                                            ...
                                            <div class="carousel-item slide-2">
                                                <img alt=""
                                                     ...
                                                     src="{{asset('app-assets/images/gallery/intro-features.png')}}">

...
@section('header')
    <link href="{{asset('app-assets/css/pages/pricing.css')}}" rel="stylesheet" type="text/css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">eCommerce Pricing</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="eCommerce-pricing.html#">eCommerce</a>
                                </li>
                                <li class="breadcrumb-item active">eCommerce Pricing
                                </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6"><a
                                    class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right"
                                    data-target="dropdown1" href="eCommerce-pricing.html#!"><i
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card card card-default scrollspy" id="basic-tabs">
                                <div class="card-content">
                                    ...
                                    <div class="col s12">
                                        <p>When you click on each tab, only the container with the corresponding tab
                                            id will become visible.</p>
                                    </div>
                                    <div class="col s12">
                                        <div class="row">
                                            <div class="col s12">
                                                ...
                                                <div class="col s12 m6 l4">
                                                    <div class="card hoverable animate fadeLeft">
                                                        ...
                                                        <div class="card-action center-align">
                                                            <button class="waves-effect waves-light gradient-45deg-indigo-purple gradient-shadow btn">
                                                                Select
                                                                Plan
                                                            </button>
                                                        </div>
                                            ...
                                            <div class="plans-container">
                                                <div class="col s12 m6 l4">
                                                    <div class="card hoverable animate fadeLeft">
                                                        ...
                                                        <div class="card-action center-align">
                                                            <button class="waves-effect waves-light  btn">Select
                                                                Plan
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="plans-container">
                                                <div class="col s12 m6 l4">
                                                    <div class="card z-depth-1 animate fadeLeft">
                                                        ...
                                                        <div class="card-action center-align">
                                                            <button class="waves-effect waves-light light-blue btn">
                                                                Select Plan
                                                            </button>
                                                        </div>
                                                    </div>
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close"
                                                            href="eCommerce-pricing.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="eCommerce-pricing.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="eCommerce-pricing.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="eCommerce-pricing.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="eCommerce-pricing.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

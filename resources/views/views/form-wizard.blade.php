...
@section('vendor-css')
    ...
    <link href="{{asset('app-assets/vendors/materialize-stepper/materialize-stepper.min.css')}}" rel="stylesheet"
          type="text/css">
@endsection

@section('header')

    <link href="{{asset('app-assets/css/pages/form-wizard.css')}}" rel="stylesheet" type="text/css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">Form Wizard</h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="form-wizard.html#">Form</a>
                                </li>
                        ...
                        <div class="col s2 m6 l6"><a
                                    ...
                                    data-target="dropdown1" href="form-wizard.html#!"><i
                        ...
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0">We use <a
                                            href="../../../../kinark.github.io/Materialize-stepper/Materialize-stepper.html#!">Stepper</a>
                                        ...
                                        <ul class="stepper horizontal" id="horizStepper">
                                                ...
                                                <div class="step-content">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input aria-required="true" class="validate" id="firstName"
                                                                   name="firstName"
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="lastName">Last Name: <span
                                                                        class="red-text">*</span></label>
                                                            <input aria-required="true" class="validate" id="lastName"
                                                                   name="lastName"
                                                                   required="" required type="text">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="contactNum">Contact Number: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="contactNum" name="contactNum"
                                                                   required=""
                                            ...
                                            <li class="step">
                                                ...
                                                <div class="step-content">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="proposal">Proposal Title: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="proposal" name="proposal"
                                                                   required="" required
                                                                   type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <label for="job">Job Title: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="job" name="job" required=""
                                                                   required type="text">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input class="validate" id="company" name="company"
                                                                   type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <label for="url">Video Url:</label>
                                                            <input class="validate" id="url" type="url">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="exp">Experience: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="exp" name="exp" type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <label for="desc">Short Description: <span
                                                                        class="red-text">*</span></label>
                                                            <textarea class="materialize-textarea" id="desc" name="dec"
                                                                      rows="4"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="step-actions">
                                            ...
                                            <li class="step">
                                                ...
                                                <div class="step-content">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="eventName">Event Name: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="eventName" name="eventName"
                                                                   required="" required
                                                                   type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <select>
                                                                <option disabled selected value="Select">Select
                                                                    Event Type
                                                                </option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <select>
                                                                <option disabled selected value="Select">Event
                                                                    Location
                                                                </option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="Budget">Event Budget: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="Budget" name="Budget"
                                                                   type="Number">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                        ...
                                        <ul class="stepper linear" id="linearStepper">
                                            <li class="step active">
                                                ...
                                                <div class="step-content">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="firstName1">First Name: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="firstName1" name="firstName1"
                                                                   required type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <label for="lastName1">Last Name: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="lastName1" name="lastName1"
                                                                   required type="text">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <li class="step">
                                                ...
                                                <div class="step-content">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="proposal1">Proposal Title: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="proposal1" name="proposal1"
                                                                   required type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <label for="job1">Job Title: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="job1" name="job1"
                                                                   required type="text">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input class="validate" id="company1" name="company1"
                                                                   type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <label for="url1">Video Url:</label>
                                                            <input class="validate" id="url1" type="url">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="exp1">Experience: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="exp1" name="exp1"
                                                                   type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <label for="desc1">Short Description: <span
                                                                        class="red-text">*</span></label>
                                                            <textarea class="materialize-textarea" id="desc1"
                                                                      name="desc"
                                                                      rows="4"></textarea>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="step">
                                                ...
                                                <div class="step-content">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="eventName1">Event Name: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="eventName1" name="eventName1"
                                                                   required type="text">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <select>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <label for="Budget1">Event Budget: <span
                                                                        class="red-text">*</span></label>
                                                            <input class="validate" id="Budget1" name="Budget1"
                                                                   type="Number">
                                                        </div>
                                                        <div class="input-field col m6 s12">
                                                            <p><label>Requirments</label></p>
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-header">
                                            ...
                                            <p>In the Non-Linear Stepper you can navigate freely between steps. You
                                                can also use the
                                                buttons for validation, but if the user wants to move arbitrarily
                                                around the steps, it's
                    ...
                    <aside id="right-sidebar-nav">
                                        ...
                                        <div class="row">
                                            <div class="col s2 pr-0 center">
                                                <i class="material-icons vertical-text-middle"><a
                                                            class="sidenav-close" href="form-wizard.html#">clear</a></i>
                                            </div>
                                            <div class="col s10 pl-0">
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a class="active" href="form-wizard.html#messages">
                                                            <span>Messages</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-wizard.html#settings">
                                                            <span>Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="tab col s4 p-0">
                                                        <a href="form-wizard.html#activity">
                                                            <span>Activity</span>
                                                        </a>
                                                    </li>
                                                </ul>
                        ...
                        <ul class="sidenav slide-out-right-sidenav-chat" id="slide-out-chat">
                            <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                                <a href="form-wizard.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth
                                    Elliott</a>
                            </li>
                            <li class="chat-body">
                                <ul class="collection">

<script>
    ...
    for (var i = 0; i < locs.length; i++) {
        ...
        if (loc.properties['base-location'].title == 1) {
            starts.push([loc.properties.lng.title, loc.properties.lat.title]);
        } else {
            ends.push([loc.properties.lng.title, loc.properties.lat.title]);
        }
        ...
        var j_loc = {
            ...
            geometry: {
                type: 'Point',
                coordinates: [loc.properties.lng.title, loc.properties.lat.title]
            },
            properties: {
                title: loc.properties.title.title,
                description: loc.properties.description.title
            }
        };
...
// add turn instructions here at the end
    ...
    map.on('load', function () {
        ...
        if (map_info['draw-directions'].title == 1) {

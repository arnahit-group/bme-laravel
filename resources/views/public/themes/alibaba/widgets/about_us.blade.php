<div class="container margin_60">
    ...
    <div class="main_title">
        <h2> چرا آژانس<span> علی بابا </span>را انتخاب کنیم؟</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-6 wow fadeIn" data-wow-delay="0.4s">
            <div class="feature">
                ...
                <h3><span>بیش از ۱۰ </span> مترجم زبان</h3>
                <p>
                    لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که
                    لازم است .
                </p>
    ...
    <div class="row">
        ...
        <div class="col-md-6 wow fadeIn" data-wow-delay="0.6s">
            <div class="feature">
                ...
                <h3><span>مجاز بودن</span> حیوانات خانگی</h3>
                <p>
                    لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که
                    لازم است .
                </p>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <h4>خدمات رفاهی علی بابا</h4>
            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. <a href="about.html#">لورم ایپسوم</a> لورم ایپسوم متن ساختگی با
                تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است </p>
            <div class="general_icons">
                <ul>
                    <li><i class="icon_set_1_icon-59"></i>صبحانه</li>
                    <li><i class="icon_set_1_icon-8"></i>شام</li>
                    <li><i class="icon_set_1_icon-32"></i>مجموعه عکس</li>
                    <li><i class="icon_set_1_icon-50"></i>مسئول خرید شخصی</li>
                </ul>
            </div>
        </div>
        <div class="col-md-6 col-sm-6">
            <h4>فروشگاه های بزرگ علی بابا</h4>
            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </strong> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت
                چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است </p>
            <div class="general_icons">
                <ul>
                    <li><i class="icon_set_1_icon-98"></i>راهنمای صوتی</li>
                    <li><i class="icon_set_1_icon-27"></i>پارکینگ</li>
                    <li><i class="icon_set_1_icon-36"></i>بورس</li>
                    <li><i class="icon_set_1_icon-63"></i>تلفن همراه</li>
                </ul>
            </div>
        </div>
    </div><!-- End row -->
        ...
        <div class="col-md-6 nopadding">
            <div class="features-content">
                ...
                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که
                    ...
                    ایجاد کرد. </p>
                <p><a href="about.html#" class=" btn_1 white">ادامه مطلب</a></p>
            </div>
        </div>
    </div>

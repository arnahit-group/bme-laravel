...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="payment_hotel.html#">صفحه اصلی</a></li>
                <li><a href="payment_hotel.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End position -->
        ...
        <div class="row">
            ...
            <aside class="col-md-4">
                <div class="box_style_1">
                    ...
                    <a class="btn_full" href="confirmation_hotel.html">ثبت سفارش</a>
                    <a class="btn_full_outline" href="single_hotel.html"><i class="icon-right"></i> اصلاح کردن سفارش</a>
                </div>

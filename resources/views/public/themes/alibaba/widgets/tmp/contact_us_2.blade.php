...
@endsection
@section('main')
    <div id="map_contact" class="contact_2"></div><!-- end map-->
    <div id="directions">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
					...
					<button class="btn" type="submit" value="Get directions" style="margin-left:0;">دریافت جهات</button>
					</span>
                        </div><!-- /input-group -->
                    </form>
                </div>
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="contact_us_2.html#">صفحه اصلی</a></li>
                <li><a href="contact_us_2.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End Position -->
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8">
                ...
                <div class="step">
                    ...
                    <form method="post" action="assets/contact.htm" id="contactform">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>پیام</label>
                                    <textarea rows="5" id="message_contact" name="message_contact" class="form-control" placeholder="پیام خود را بنویسید"
            ...
            <div class="col-md-4 col-sm-4">
                <div class="box_style_1">
                    ...
                    <p>
                        بلوار امام خمینی جنب شهرداری مرکزی
                    </p>
                    <hr>
                    ...
                    <ul id="contact-info">
                        <li>۰۷۶۳۲۲۲۹۱۲۷</li>
                        <li><a href="contact_us_2.html#">Info@digiao.ir</a></li>
                    </ul>
                </div>
...
@section('footer')
    ...
    <script src="{{asset('alibaba/js/map_contact.js')}}"></script>

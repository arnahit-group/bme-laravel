...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="cart.html#">صفحه اصلی</a></li>
                <li><a href="cart.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End position -->
        ...
        <div class="row">
                ...
                <table class="table table-striped cart-list add_bottom_30">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="options">
                                <a href="cart.html#"><i class=" icon-trash"></i></a><a href="cart.html#"><i class="icon-ccw-2"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <aside class="col-md-4">
                <div class="box_style_1">
                    ...
                    <a class="btn_full" href="payment.html">اتمام خرید</a>
                    <a class="btn_full_outline" href="cart.html#"><i class="icon-right"></i> ادامه خرید</a>
                </div>

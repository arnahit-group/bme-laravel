...
@section('main')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div id="price_single_main" class="hotel">
                            از / هر شب <span><sup>۹۰.۰۰۰ تومان</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="single_hotel.html#">صفحه اصلی</a></li>
                <li><a href="single_hotel.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End Position -->
    ...
    <div class="container margin_60">
        <div class="row">
            <div class="col-md-8" id="single_tour_desc">
                ...
                <p class="visible-sm visible-xs"><a class="btn_map" data-toggle="collapse" href="single_hotel.html#collapseMap" aria-expanded="false"
                                                    aria-controls="collapseMap">مشاهده نقشه</a></p><!-- Map button for tablets/mobiles -->
                ...
                <div class="row">
                    <div class="col-md-3">
                        <h3>بررسی</h3>
                        <a href="single_hotel.html#" class="btn_1 add_bottom_30" data-toggle="modal" data-target="#myReview">بررسی پیشرفته</a>
                    </div>
                    <div class="col-md-9">
            ...
            <aside class="col-md-4">
                <p class="hidden-sm hidden-xs">
                    <a class="btn_map" data-toggle="collapse" href="single_hotel.html#collapseMap" aria-expanded="false" aria-controls="collapseMap">نمایش بر روی نقشه</a>
                </p>
                <div class="box_style_1 expose">
                    <h3 class="inner">بررسی در دسترس بودن</h3>
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                <label><i class="icon-calendar-7"></i> از تاریخ</label>
                                <input class="date-pick form-control" data-date-format="Apr 24, Mon" type="text">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                <label><i class="icon-calendar-7"></i>تا تاریخ</label>
                                <input class="date-pick form-control" data-date-format="Apr 24, Mon" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <a class="btn_full" href="cart_hotel.html">هم اکنون بررسی کنید</a>
                    <a class="btn_full_outline" href="single_hotel.html#"><i class=" icon-heart"></i> علاقه مند شدم</a>
                </div><!--/box_style_1 -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="assets/review_hotel.htm" name="review_hotel" id="review_hotel">
                        <input name="hotel_name" id="hotel_name" type="hidden" value="Mariott Hotel Paris">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="name_review" id="name_review" type="text" placeholder="اسم شما" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="lastname_review" id="lastname_review" type="text" placeholder="نام خانوادگی شما" class="form-control">
                                </div>
                            </div>
                        </div>
                        <!-- End row -->
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="email_review" id="email_review" type="email" placeholder="ایمیل شما" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <select class="form-control" name="room_type_review" id="room_type_review">
                                        <option value="">نوع اتاق را انتخاب کنید</option>
                                        <option value="Single room">اتاق تک نفره</option>
                                        <option value="Double Room">اتاق دو تخته</option>
                                        <option value="King double room">دو اتاق ویژه</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="cleanliness_review" id="cleanliness_review">
                                        <option value="">لطفا انتخاب کیند</option>
                                        <option value="Low">کم</option>
                                        <option value="Sufficient">کافی</option>
                                        <option value="Good">خوب</option>
                                        <option value="Excellent">عالی</option>
                                        <option value="Superb">سوپر</option>
                                        <option value="Not rated">من نمی دانم</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <!-- End row -->
                        <div class="form-group">
                            <textarea name="review_text" id="review_text" class="form-control" style="height:100px" placeholder="متن خود را بنویسید"></textarea>
                        </div>
                        <div class="form-group">
                            <input type="text" id="verify_review" class=" form-control" placeholder="آیا شما انسان هستید ؟ ۱+۳ =">
                        </div>

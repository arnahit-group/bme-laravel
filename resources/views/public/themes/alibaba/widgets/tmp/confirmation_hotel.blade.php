...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="confirmation_hotel.html#">صفحه اصلی</a></li>
                <li><a href="confirmation_hotel.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End position -->
                ...
                <div class="step">
                    <table class="table confirm">
                        <tbody>
                            ...
                            <tr>
                                <td><strong>بررسی شده در تاریخ</strong></td>
                                <td>
                                    ۳ اردیبهشت ۱۳۹۶<br>
                                </td>
                            </tr>
                            <tr>
                                <td><strong>اتاق</strong></td>
                                <td>۱ اتاق دو نفره</td>
                            </tr>
                            <tr>
                                <td><strong>شب</strong></td>
                                <td>۲</td>
                            </tr>
                            <tr>

...
@section('main')
    ...
    <div id="position">
        <div class="container">
            <ul>
                <li><a href="payment.html#">صفحه اصلی</a></li>
                <li><a href="payment.html#">دسته بندی</a></li>
                <li>صفحه فعال</li>
            </ul>
        </div>
    </div><!-- End position -->
        ...
        <div class="row">
            ...
            <aside class="col-md-4">
                <div class="box_style_1">
                    ...
                    <a class="btn_full" href="confirmation.html">ثبت</a>
                    <a class="btn_full_outline" href="payment.html#"><i class="icon-right"></i> ادامه خرید</a>
                </div>

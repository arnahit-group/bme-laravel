...
@section('main')
        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('alibaba/img/slides_bg/dummy.png')}}" alt="slidebg1" data-lazyload="{{asset('alibaba/img/slides_bg/slide_1.jpg')}}" data-bgposition="center top" data-bgfit="cover"
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('alibaba/img/slides_bg/dummy.png')}}" alt="slidebg1" data-lazyload="{{asset('alibaba/img/slides_bg/slide_4.jpg')}}" data-bgposition="center top" data-bgfit="cover"
                         data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption white_heavy_40 customin customout text-center text-uppercase" data-x="center" data-y="center" data-hoffset="0" data-voffset="-20"
                         data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('alibaba/img/slides_bg/dummy.png')}}" alt="slidebg1" data-lazyload="{{asset('alibaba/img/slides_bg/slide_6.jpg')}}" data-bgposition="center top" data-bgfit="cover"
                         data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption white_heavy_40 customin customout text-center text-uppercase" data-x="center" data-y="center" data-hoffset="0" data-voffset="-20"
                         data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('alibaba/img/slides_bg/dummy.png')}}" alt="slidebg1" data-lazyload="{{asset('alibaba/img/slides_bg/slide_5.jpg')}}" data-bgposition="center top" data-bgfit="cover"
                         data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption white_heavy_40 customin customout text-center text-uppercase" data-x="center" data-y="center" data-hoffset="0" data-voffset="-20"
                         data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
    ...
    <div class="container margin_60">
        ...
        <div class="row">
                ...
                <div class="tour_container">
                    <div class="img_container">
                        <a href="single_tour.html">
                            <img src="{{asset('alibaba/img/tour_box_1.jpg')}}" class="img-responsive" alt="">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                <div class="tour_container">
                    <div class="img_container">
                        <a href="single_tour.html">
                            <img src="{{asset('alibaba/img/tour_box_2.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon top_rated"></div>
                            <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="tour_container">
                    <div class="img_container">
                        <a href="single_tour.html">
                            <img src="{{asset('alibaba/img/tour_box_3.jpg')}}" width="800" height="533" class="img-responsive" alt="">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                <div class="tour_container">
                    <div class="img_container">
                        <a href="single_tour.html">
                            <img src="{{asset('alibaba/img/tour_box_4.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon popular"></div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                <div class="tour_container">
                    <div class="img_container">
                        <a href="single_tour.html">
                            <img src="{{asset('alibaba/img/tour_box_14.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon popular"></div>
                            <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                <div class="tour_container">
                    <div class="img_container">
                        <a href="single_tour.html">
                            <img src="{{asset('alibaba/img/tour_box_5.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon top_rated"></div>
                            <div class="short_info">
        ...
        <p class="text-center add_bottom_30">
            <a href="all_tours_list.html" class="btn_1 medium"><i class="icon-eye-7"></i>مشاهده همه تور ها</a>
        </p>
        ...
        <div class="row">
                ...
                <div class="hotel_container">
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="{{asset('alibaba/img/hotel_1.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon top_rated"></div>
                    ...
                    <div class="hotel_title">
                        ...
                        <div class="wishlist">
                            <a class="tooltip_flip tooltip-effect-1" href="#">+<span class="tooltip-content-flip"><span class="tooltip-back">علاقمند شدم</span></span></a>
                        </div><!-- End wish list-->
                    </div>
                </div><!-- End box -->
            </div><!-- End col-md-4 -->
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                <div class="hotel_container">
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="{{asset('alibaba/img/hotel_2.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon top_rated"></div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="hotel_container">
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="{{asset('alibaba/img/hotel_3.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon top_rated"></div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                <div class="hotel_container">
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="{{asset('alibaba/img/hotel_4.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon popular"></div>
                            <div class="score"><span>۷.۵</span>خوب</div>
                            <div class="short_info hotel">
                                تور خارجه<span class="price"><sup>۸.۰۰۰.۰۰۰ تومان</sup></span>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                <div class="hotel_container">
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="{{asset('alibaba/img/hotel_5.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon top_rated"></div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                <div class="hotel_container">
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="{{asset('alibaba/img/hotel_6.jpg')}}" width="800" height="533" class="img-responsive" alt="">
                            <div class="ribbon popular"></div>
        ...
        <p class="text-center nopadding">
            <a href="all_hotels_list.html" class="btn_1 medium"><i class="icon-eye-7"></i>مشاهده همه هتل ها</a>
        </p>
    </div><!-- End container -->
        ...
        <div class="container margin_60">
            ...
            <div class="row add_bottom_45">
                <div class="col-md-4 other_tours">
                    <ul>
                        <li><a href="#"><i class="icon_set_1_icon-3"></i>تور شهر بازی<span class="other_tours_price">۵۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-30"></i>تور خرید<span class="other_tours_price">۳۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-44"></i>تور مکان های تاریخی<span class="other_tours_price">۶۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-3"></i>تور سرگرمی<span class="other_tours_price">۶۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-44"></i>تور تخت جمشید<span class="other_tours_price">۹۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-3"></i>تور جنگل حرا<span class="other_tours_price">۴۵.۰۰۰ تومان</span></a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 other_tours">
                    <ul>
                        <li><a href="#"><i class="icon_set_1_icon-1"></i>تور بازدید از مکان های مذهبی<span class="other_tours_price">۴۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-4"></i>تور تاریخی<span class="other_tours_price">۲۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-30"></i>تلکابین رامسر<span class="other_tours_price">۱۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-3"></i>تور اتوبوس گردی<span class="other_tours_price">۳۵.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-30"></i>تور کیش گردی<span class="other_tours_price">۶۸۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-3"></i>تور قشم گردی<span class="other_tours_price">۵۸۰.۰۰۰ تومان</span></a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 other_tours">
                    <ul>
                        <li><a href="#"><i class="icon_set_1_icon-37"></i>تور اصفهان گردی<span class="other_tours_price">۳۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-1"></i>تور مشهد<span class="other_tours_price">۴۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-50"></i>تور مراکز خرید<span class="other_tours_price">۹۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-44"></i>تور غار گردی<span class="other_tours_price">۱۰۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-50"></i>تور خرید از قشم<span class="other_tours_price">۵۵۰.۰۰۰ تومان</span></a>
                        </li>
                        <li><a href="#"><i class="icon_set_1_icon-44"></i>تور اثار تاریخی ایران<span class="other_tours_price">۱.۵۰۰.۰۰۰ تومان</span></a>
                        </li>
                    </ul>
                </div>
            </div><!-- End row -->
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{asset('alibaba/img/bus.jpg')}}" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{asset('alibaba/img/transfer.jpg')}}" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{asset('alibaba/img/guide.jpg')}}" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{asset('alibaba/img/hotel.jpg')}}" alt="Pic" class="img-responsive"></a>
                    </p>
    ...
    <div class="container margin_60">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 hidden-xs">
                <img src="{{asset('alibaba/img/laptop.png')}}" alt="Laptop" class="img-responsive laptop">
            </div>

            ...
            <div class="row">
                ...
                <div id="chatapp" class="col s12">
                    <div class="collection border-none">
                        ...
                        <a href="#!" class="collection-item avatar border-none">
                            <img src="{{asset('images/avatar/avatar-2.png')}}" alt=""
                        ...
                        <a href="#!" class="collection-item avatar border-none">
                            <img src="{{asset('images/avatar/avatar-3.png')}}" alt=""
                        ...
                        <a href="#!" class="collection-item avatar border-none">
                            <img src="{{asset('images/avatar/avatar-5.png')}}" alt=""
                        ...
                        <a href="#!" class="collection-item avatar border-none">
                            <img src="{{asset('images/avatar/avatar-6.png')}}" alt=""
                                 class="circle deep-orange accent-2">
                        ...
                        <a href="#!" class="collection-item avatar border-none">
                            <img src="{{asset('images/avatar/avatar-8.png')}}" alt=""
                                 class="circle red accent-2">
                        ...
                        <a href="#!" class="collection-item avatar border-none">
                            <img src="{{asset('images/avatar/avatar-9.png')}}" alt=""
                                 class="circle teal accent-4">

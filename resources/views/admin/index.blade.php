                    ...
                    <div class="card">
                        <div class="card-content cyan white-text">
                            ...
                            <p class="card-stats-compare">
                                ...
                                <span class="cyan text text-lighten-5">پیشرفت امروز</span>
                            </p>
                        </div>
                ...
                <div class="col s12 m6 l3">
                    ...
                    <div class="card">
                        <div class="card-content red accent-2 white-text">
                            ...
                            <h4 class="card-stats-number">945,211,000 </h4>
                            <p class="card-stats-compare">
                                <i class="material-icons">keyboard_arrow_up</i> 70%
                                <span class="red-text text-lighten-5">ماه جاری</span>
                            </p>
                        </div>
                        <div class="card-action red darken-1">
                            <div id="sales-compositebar" class="center-align" style="visibility: hidden;"></div>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l3">
                    <div class="card">
                        <div class="card-content teal accent-4 white-text">
                            ...
                            <h4 class="card-stats-number">20,200,000</h4>
                            <p class="card-stats-compare">
                                <i class="material-icons">keyboard_arrow_up</i> 80%
                                <span class="teal-text text-lighten-5">امروز</span>
                            </p>
                        </div>
                        <div class="card-action teal darken-1">
                            <div id="profit-tristate" class="center-align" style="visibility: hidden;"></div>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l3">
                            ...
                            <li class="collection-item">
                                <div class="row">
                                    <div class="col s6">
                                        ...
                                        @if(isset($room->properties['floor']))
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#waiting-reserves-list").on("click", ".button", function () {
                ...
                $.ajax({
                    url: "{{ url('/admin/ajax/service/get') }}",
                    method: 'post',
                    data: {
...
//                            alert(service.check_path);
            ...
            var refreshData = function () {
                ...
                $.ajax({
                    url: "{{ url('/admin/ajax/service/refresh') }}",
                    method: 'post',
                    data: {

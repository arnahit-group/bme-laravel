...
<html class="loading" lang="en" data-textdirection="rtl">
    ...
    <!-- END: Head-->
    <body dir="rtl" class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns app-page"
        ...
        <aside class="sidenav-main nav-expanded nav-lock nav-collapsible  sidenav-active-square">
            ...
            <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow"
                ...
                @if(isset($navigations))
                    ...
                    {{--                    <li class="navigation-header"><a class="navigation-header-text">--------------------</a><i--}}

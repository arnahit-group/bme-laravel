                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-2.png')}}"></span>
                                            </td>
                                            <td>Rodolfo</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-3.png')}}"></span>
                                            </td>
                                            <td>Marco</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-4.png')}}"></span>
                                            </td>
                                            <td>Joshua</td>
                                            <td>jos@domain.com</td>
                                            <td>202-555-0126</td>
                                            <td><span class="favorite"><i
                                                            class="material-icons amber-text"> star_border </i></span>
                                            </td>
                                            <td><i class="material-icons delete">delete_outline</i></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-5.png')}}"></span>
                                            </td>
                                            <td>Oscar</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-6.png')}}"></span>
                                            </td>
                                            <td>William</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-7.png')}}"></span>
                                            </td>
                                            <td>Dorian</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-8.png')}}"></span>
                                            </td>
                                            <td>Lester</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-9.png')}}"></span>
                                            </td>
                                            <td>Charles</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-1.png')}}"></span>
                                            </td>
                                            <td>William</td>
                                            <td>name@domain.com</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-11.png')}}"></span>
                                            </td>
                                            <td>John</td>
                                            <td>name@domain.com</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-12.png')}}"></span>
                                            </td>
                                            <td>John</td>
                                            <td>name@domain.com</td>
                                            <td>+1-202-555-0112</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-13.png')}}"></span>
                                            </td>
                                            <td>John</td>
                                            <td>name@domain.com</td>
                                            <td>+1-202-555-0112</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-14.png')}}"></span>
                                            </td>
                                            <td>Jake</td>
                                            <td>name@domain.com</td>
                                            <td>+1-202-555-0112</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-15.png')}}"></span>
                                            </td>
                                            <td>Jake</td>
                                            <td>name@domain.com</td>
                                            <td>+1-202-555-0112</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-16.png')}}"></span>
                                            </td>
                                            <td>Heather</td>
                                            <td>name@domain.com</td>
                                            <td>+1-202-555-0112</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-17.png')}}"></span>
                                            </td>
                                            <td>Joanna</td>
                                            <td>name@domain.com</td>
                                            <td>+1-202-555-0112</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="avatar-contact avatar-online"><img
                                                            alt="avatar"
                                                            src="{{asset('app-assets/images/avatar/avatar-10.png')}}"></span>
                                            </td>
                                            <td>Kathleen</td>
                                            <td>name@domain.com</td>
                                            <td>+1-202-555-0112</td>
